...
extends ModelBase {
    ...
    public Model7StarsTrue(float _scale) {
        ...
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 42, 48, -2.0f, -6.75f, -2.0f, 4, 4, 4, 0.0f));
        ...
        this.Line_r1.field_78804_l.add(new ModelBox(this.Line_r1, 56, 18, 0.0f, -5.0f, -1.0f, 0, 5, 5, 0.0f));
        ...
        this.Line_r2.field_78804_l.add(new ModelBox(this.Line_r2, 56, 8, 0.0f, -5.0f, -1.0f, 0, 5, 5, 0.0f));
        ...
        this.Tail2.field_78804_l.add(new ModelBox(this.Tail2, 0, 31, -2.0f, -4.0f, -3.0f, 6, 5, 6, 0.0f));
        ...
        this.Tail3.field_78804_l.add(new ModelBox(this.Tail3, 24, 39, -2.0f, -3.0f, -1.0f, 4, 5, 5, 0.0f));
        ...
        this.Tail4.field_78804_l.add(new ModelBox(this.Tail4, 48, 31, -0.5f, -3.0f, -3.0f, 3, 3, 5, 0.0f));
        ...
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 18, 49, -1.0f, -2.0f, -1.5f, 2, 10, 3, 0.0f));
        ...
        this.bipedLeftArm.field_78804_l.add(new ModelBox(this.bipedLeftArm, 28, 49, -1.0f, -2.0f, -1.5f, 2, 10, 3, 0.0f));
        ...
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 24, 31, -4.0f, 2.0f, -6.0f, 5, 1, 7, 0.0f));
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 0, 42, -3.5f, -2.0f, -4.0f, 4, 4, 5, 0.25f));
        ...
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 34, 0, -1.0f, 2.0f, -6.0f, 5, 1, 7, 0.0f));
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 42, 39, -0.5f, -2.0f, -4.0f, 4, 4, 5, 0.25f));
    }
