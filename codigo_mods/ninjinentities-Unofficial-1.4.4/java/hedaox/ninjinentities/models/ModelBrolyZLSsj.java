...
extends ModelBase {
    ...
    public ModelBrolyZLSsj(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        hair1.func_78793_a(-3.0f, -8.0f, 0.0f);
        this.setRotationAngle(hair1, -0.2618f, -1.0E-4f, -0.9599f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 45, 2, 0.0603f, -2.658f, -3.0f, 3, 6, 2, 0.0f));
        ...
        hair4.func_78793_a(3.0f, -8.0f, 0.0f);
        this.setRotationAngle(hair4, -0.2618f, 1.0E-4f, 0.9599f);
        this.Head.func_78792_a(hair4);
        hair4.field_78804_l.add(new ModelBox(hair4, 45, 2, -3.0603f, -2.658f, -3.0f, 3, 6, 2, 0.0f));
        ModelRenderer hair5 = new ModelRenderer((ModelBase)this);
        hair5.func_78793_a(-2.0f, -7.0f, 1.0f);
        this.setRotationAngle(hair5, 2.1816f, 0.4364f, -1.9199f);
        ...
        this.setRotationAngle(hair6, 2.0071f, -0.3491f, 2.0072f);
        ...
        hair7.field_78804_l.add(new ModelBox(hair7, 45, 2, 1.8099f, -3.4417f, -5.0982f, 3, 7, 3, 0.0f));
        ...
        this.setRotationAngle(hair9, 2.7925f, 0.0873f, 1.9199f);
        ...
        hair10.func_78793_a(-5.0f, -8.0f, 2.0f);
        this.setRotationAngle(hair10, 2.7925f, -0.0873f, -1.9199f);
        this.Head.func_78792_a(hair10);
        hair10.field_78804_l.add(new ModelBox(hair10, 45, 2, -3.3618f, -3.6765f, -2.7815f, 3, 7, 3, 0.0f));
        ModelRenderer hair11 = new ModelRenderer((ModelBase)this);
        hair11.func_78793_a(-3.0f, -5.0f, 1.0f);
        this.setRotationAngle(hair11, -1.2218f, -0.5236f, 0.0f);
        ...
        hair12.func_78793_a(3.0f, -5.0f, 1.0f);
        this.setRotationAngle(hair12, -1.2218f, 0.5236f, 0.0f);
        this.Head.func_78792_a(hair12);
        hair12.field_78804_l.add(new ModelBox(hair12, 38, 2, -3.9972f, -5.6289f, -4.1585f, 3, 8, 3, 0.0f));
        ModelRenderer hair13 = new ModelRenderer((ModelBase)this);
        hair13.func_78793_a(7.5f, -8.2f, 2.4f);
        this.setRotationAngle(hair13, -0.2618f, -0.2618f, 2.8798f);
        this.Head.func_78792_a(hair13);
        hair13.field_78804_l.add(new ModelBox(hair13, 38, 2, 1.9972f, -4.6289f, -4.1585f, 2, 7, 3, 0.0f));
        ModelRenderer hair14 = new ModelRenderer((ModelBase)this);
        hair14.func_78793_a(-7.5f, -8.2f, 2.4f);
        this.setRotationAngle(hair14, -0.2618f, 0.2618f, -2.8798f);
        this.Head.func_78792_a(hair14);
        hair14.field_78804_l.add(new ModelBox(hair14, 38, 2, -3.9972f, -4.6289f, -4.1585f, 2, 7, 3, 0.0f));
        ...
        hair15.field_78804_l.add(new ModelBox(hair15, 38, 2, -4.9972f, -6.6289f, -4.1585f, 3, 9, 3, 0.0f));
        ...
        hair16.field_78804_l.add(new ModelBox(hair16, 38, 2, -4.9972f, -6.6289f, -4.1585f, 3, 7, 3, 0.0f));
        ...
        hair17.field_78804_l.add(new ModelBox(hair17, 38, 2, 1.9972f, -6.6289f, -4.1585f, 3, 7, 3, 0.0f));
