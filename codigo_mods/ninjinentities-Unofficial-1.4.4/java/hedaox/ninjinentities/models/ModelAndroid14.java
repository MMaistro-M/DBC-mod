...
extends ModelBase {
    ...
    public ModelAndroid14(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        hair1.func_78793_a(0.0f, -3.0f, 3.0f);
        this.setRotationAngle(hair1, 0.1745f, 0.0f, 0.0f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 30, 12, -1.0f, -1.0f, 0.0f, 2, 12, 1, 0.0f));
        ...
        bb_main.field_78804_l.add(new ModelBox(bb_main, 34, 49, -4.5f, -15.6f, -2.4f, 9, 10, 5, 0.0f));
        ...
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 0, 22, 8.0f, -3.0f, -2.5f, 5, 3, 5, 0.0f));
