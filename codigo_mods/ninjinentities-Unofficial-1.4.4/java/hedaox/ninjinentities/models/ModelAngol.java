...
extends ModelBase {
    ...
    public ModelAngol(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        ModelRenderer nose = new ModelRenderer((ModelBase)this);
        nose.func_78793_a(1.0f, -1.3125f, -4.0f);
        this.setRotationAngle(nose, 0.6109f, 0.0f, 0.0f);
        this.Head.func_78792_a(nose);
        nose.field_78804_l.add(new ModelBox(nose, 47, 0, -2.0f, -2.0f, -2.0f, 2, 2, 4, 0.0f));
        ...
        skilt.field_78804_l.add(new ModelBox(skilt, 32, 1, -8.0f, -9.0f, 0.8f, 9, 7, 5, 0.0f));
