...
extends ModelBase {
    ...
    public ModelCacao(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        bone.func_78793_a(0.0f, 24.0f, -0.75f);
        this.Head.func_78792_a(bone);
        bone.field_78804_l.add(new ModelBox(bone, 1, 53, -4.0f, -32.0f, -3.0f, 8, 3, 7, 0.5f));
        ...
        rightarmshoulder.field_78804_l.add(new ModelBox(rightarmshoulder, 26, 10, -6.0f, -3.0f, -3.0f, 7, 4, 6, 0.0f));
        ...
        leftarmshoulder.field_78804_l.add(new ModelBox(leftarmshoulder, 24, 24, -1.0f, -3.0f, -2.4375f, 7, 4, 6, 0.0f));
        ...
        ModelRenderer scooter = new ModelRenderer((ModelBase)this);
        scooter.func_78793_a(4.5f, -4.5f, -0.5f);
        scooter.field_78804_l.add(new ModelBox(scooter, 43, 5, -0.5f, -1.5f, -1.5f, 1, 4, 3, 0.0f));
    }
