...
extends ModelBase {
    ...
    public ModelWings(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.Body.field_78804_l.add(new ModelBox(this.Body, 0, 0, -6.0f, 0.0f, -3.0f, 12, 12, 6, 0.0f));
        ModelRenderer leftWing = new ModelRenderer((ModelBase)this);
        leftWing.func_78793_a(2.3f, 2.2f, 0.8f);
        this.setRotationAngle(leftWing, 0.4098f, -0.0911f, -0.4098f);
        this.Body.func_78792_a(leftWing);
        leftWing.field_78804_l.add(new ModelBox(leftWing, 24, 24, 0.091f, 0.3968f, 0.9134f, 1, 16, 11, 0.0f));
        ModelRenderer rightWing = new ModelRenderer((ModelBase)this);
        rightWing.func_78793_a(-2.3f, 2.2f, 0.8f);
        this.setRotationAngle(rightWing, 0.4098f, 0.0911f, 0.4098f);
        this.Body.func_78792_a(rightWing);
        rightWing.field_78809_i = true;
        rightWing.field_78804_l.add(new ModelBox(rightWing, 24, 24, -1.091f, 0.3968f, 0.9134f, 1, 16, 11, 0.0f));
        this.RArm = new ModelRenderer((ModelBase)this);
        this.RArm.func_78793_a(-5.0f, 2.0f, 0.0f);
        this.setRotationAngle(this.RArm, -0.0086f, 0.0f, 0.0873f);
        this.Body.func_78792_a(this.RArm);
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 58, 32, -5.0f, -2.0f, -2.0f, 4, 11, 4, 0.0f));
        ...
        rightarmshoulder.field_78804_l.add(new ModelBox(rightarmshoulder, 0, 106, -6.0f, -3.0f, -2.0f, 7, 4, 6, 0.0f));
        this.LArm = new ModelRenderer((ModelBase)this);
        this.LArm.func_78793_a(5.0f, 2.0f, 0.0f);
        this.setRotationAngle(this.LArm, 0.0086f, 0.0f, -0.0873f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 22, 51, 1.0f, -2.0f, -2.0f, 4, 11, 4, 0.0f));
        ...
        leftarmshoulder.field_78804_l.add(new ModelBox(leftarmshoulder, 0, 95, -1.0f, -3.0f, -2.0f, 7, 4, 6, 0.0f));
        this.RLeg = new ModelRenderer((ModelBase)this);
        this.RLeg.func_78793_a(-1.9f, 12.0f, 0.0f);
        this.Body.func_78792_a(this.RLeg);
        this.RLeg.field_78804_l.add(new ModelBox(this.RLeg, 0, 45, -3.0f, 0.0f, -3.0f, 5, 12, 6, 0.0f));
        this.LLeg = new ModelRenderer((ModelBase)this);
        this.LLeg.func_78793_a(1.9f, 12.0f, 0.0f);
        this.Body.func_78792_a(this.LLeg);
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 42, 45, -1.9f, 0.0f, -3.0f, 5, 12, 6, 0.0f));
        this.Head = new ModelRenderer((ModelBase)this);
        this.Head.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Head.field_78804_l.add(new ModelBox(this.Head, 37, 16, -4.0f, -8.0f, -4.0f, 8, 8, 8, 0.5f));
        ...
        headChild_3.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(headChild_3, 0.0f, 0.5236f, 0.0f);
        this.Head.func_78792_a(headChild_3);
        headChild_3.field_78804_l.add(new ModelBox(headChild_3, 117, 49, 4.0f, -6.0f, -1.0f, 0, 4, 6, 0.0f));
        ...
        headChild_1.field_78804_l.add(new ModelBox(headChild_1, 117, 62, -4.0f, -6.0f, -1.0f, 0, 4, 6, 0.0f));
        ModelRenderer bone = new ModelRenderer((ModelBase)this);
        bone.func_78793_a(0.0f, 1.0f, -1.0f);
        this.setRotationAngle(bone, -0.1745f, 0.0f, 0.0f);
        this.Head.func_78792_a(bone);
        bone.field_78804_l.add(new ModelBox(bone, 0, 0, -4.0f, -8.0f, -6.0f, 1, 1, 2, 0.0f));
        bone.field_78804_l.add(new ModelBox(bone, 0, 0, 3.0f, -8.0f, -6.0f, 1, 1, 2, 0.0f));
    }
