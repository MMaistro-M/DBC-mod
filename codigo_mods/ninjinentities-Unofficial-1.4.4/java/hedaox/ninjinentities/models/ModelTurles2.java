...
extends ModelBase {
    ...
    public ModelTurles2(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        detector.field_78804_l.add(new ModelBox(detector, 49, 33, 4.0f, -5.0f, -2.0f, 1, 3, 3, 0.0f));
        detector.field_78804_l.add(new ModelBox(detector, 49, 36, 4.0f, -4.0f, -4.25f, 1, 1, 2, 0.0f));
        ...
        screen.field_78804_l.add(new ModelBox(screen, 45, 40, 0.0f, -5.0f, -5.0f, 4, 3, 0, 0.0f));
