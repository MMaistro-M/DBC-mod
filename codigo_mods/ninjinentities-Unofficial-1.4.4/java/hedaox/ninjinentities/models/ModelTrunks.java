...
extends ModelBase {
    ...
    public ModelTrunks(float _scale) {
        ...
        this.setRotationAngle(hair1, -0.0873f, 0.0f, -2.2689f);
        ...
        this.setRotationAngle(hair2, -0.0873f, 0.0f, 2.2689f);
        ...
        hair3.func_78793_a(3.4f, -9.0f, -1.6f);
        this.setRotationAngle(hair3, 0.5236f, -0.3491f, 2.1816f);
        this.Head.func_78792_a(hair3);
        hair3.field_78804_l.add(new ModelBox(hair3, 42, 2, -0.4867f, -4.474f, -2.0714f, 3, 6, 3, 0.0f));
        ModelRenderer hair4 = new ModelRenderer((ModelBase)this);
        hair4.func_78793_a(-3.4f, -9.0f, -1.6f);
        this.setRotationAngle(hair4, 0.5236f, 0.3491f, -2.1816f);
        this.Head.func_78792_a(hair4);
        hair4.field_78804_l.add(new ModelBox(hair4, 42, 2, -2.5133f, -4.474f, -2.0714f, 3, 6, 3, 0.0f));
        ModelRenderer hair5 = new ModelRenderer((ModelBase)this);
        hair5.func_78793_a(-2.8f, -9.0f, 2.9f);
        this.setRotationAngle(hair5, -0.0873f, 0.0f, -2.1816f);
        this.Head.func_78792_a(hair5);
        hair5.field_78804_l.add(new ModelBox(hair5, 42, 2, -2.5133f, -4.474f, -2.0714f, 3, 6, 3, 0.0f));
        ModelRenderer hair6 = new ModelRenderer((ModelBase)this);
        hair6.func_78793_a(2.8f, -9.0f, 2.9f);
        this.setRotationAngle(hair6, -0.0873f, 0.0f, 2.1816f);
        this.Head.func_78792_a(hair6);
        hair6.field_78804_l.add(new ModelBox(hair6, 42, 2, -0.4867f, -4.474f, -2.0714f, 3, 6, 3, 0.0f));
        ModelRenderer hair7 = new ModelRenderer((ModelBase)this);
        hair7.func_78793_a(2.8f, -9.0f, 2.9f);
        this.setRotationAngle(hair7, -0.7855f, -0.6981f, 3.0543f);
        this.Head.func_78792_a(hair7);
        hair7.field_78804_l.add(new ModelBox(hair7, 42, 2, -0.4867f, -4.474f, -2.0714f, 3, 6, 2, 0.0f));
        ModelRenderer hair8 = new ModelRenderer((ModelBase)this);
        hair8.func_78793_a(-2.8f, -9.0f, 2.9f);
        this.setRotationAngle(hair8, -0.7855f, 0.6981f, -3.0543f);
        this.Head.func_78792_a(hair8);
        hair8.field_78804_l.add(new ModelBox(hair8, 42, 2, -2.5133f, -4.474f, -2.0714f, 3, 6, 2, 0.0f));
