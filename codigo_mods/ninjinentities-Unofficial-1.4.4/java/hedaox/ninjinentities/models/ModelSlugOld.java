...
extends ModelBase {
    ...
    public ModelSlugOld(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        bodyChild_6.field_78804_l.add(new ModelBox(bodyChild_6, 0, 0, -7.0f, 1.0f, 2.0f, 14, 20, 0, 0.0f));
        ...
        rightarmshoulder.field_78804_l.add(new ModelBox(rightarmshoulder, 28, 0, -6.0f, -3.0f, -3.0f, 7, 4, 6, 0.0f));
        ...
        leftarmshoulder.field_78804_l.add(new ModelBox(leftarmshoulder, 18, 46, -1.0f, -3.0f, -3.0f, 7, 4, 6, 0.0f));
