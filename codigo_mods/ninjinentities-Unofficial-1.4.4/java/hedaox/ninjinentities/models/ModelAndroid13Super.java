...
public class ModelAndroid13Super
extends ModelBase {
    ...
    public ModelAndroid13Super(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        hair3.func_78793_a(2.0f, -7.0f, 0.0f);
        this.setRotationAngle(hair3, 0.0f, 0.0873f, 0.2618f);
        this.Head.func_78792_a(hair3);
        hair3.field_78804_l.add(new ModelBox(hair3, 56, 0, 1.0603f, -4.342f, -3.0f, 1, 7, 3, 0.0f));
        ModelRenderer hair5 = new ModelRenderer((ModelBase)this);
        hair5.func_78793_a(-5.0f, -7.0f, 4.0f);
        this.setRotationAngle(hair5, -0.3491f, 0.0f, -0.4363f);
        this.Head.func_78792_a(hair5);
        hair5.field_78804_l.add(new ModelBox(hair5, 52, 4, 1.8099f, -4.1257f, -3.2188f, 3, 7, 3, 0.0f));
        ModelRenderer hair9 = new ModelRenderer((ModelBase)this);
        hair9.func_78793_a(0.0f, -2.0f, 6.0f);
        this.setRotationAngle(hair9, -0.5236f, 0.3491f, 0.0f);
        this.Head.func_78792_a(hair9);
        hair9.field_78804_l.add(new ModelBox(hair9, 52, 4, 0.9972f, -4.6289f, -4.1585f, 3, 7, 3, 0.0f));
        ModelRenderer hair8 = new ModelRenderer((ModelBase)this);
        hair8.func_78793_a(3.0f, -8.0f, 2.0f);
        this.setRotationAngle(hair8, 2.7925f, 0.0873f, 0.5236f);
        this.Head.func_78792_a(hair8);
        hair8.field_78804_l.add(new ModelBox(hair8, 52, 2, -0.0028f, -3.971f, -3.2188f, 3, 6, 3, 0.0f));
        ModelRenderer hair = new ModelRenderer((ModelBase)this);
        hair.func_78793_a(-1.0f, -9.0f, 0.0f);
        this.setRotationAngle(hair, -0.0873f, 0.0f, -0.1745f);
        this.Head.func_78792_a(hair);
        hair.field_78804_l.add(new ModelBox(hair, 48, 0, -0.5133f, -5.474f, -2.0714f, 4, 8, 4, 0.0f));
        ModelRenderer hair1 = new ModelRenderer((ModelBase)this);
        hair1.func_78793_a(-3.0f, -10.0f, 0.0f);
        this.setRotationAngle(hair1, 0.0f, 0.0f, 0.2618f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 52, 0, 0.0603f, -2.658f, -3.0f, 3, 6, 3, 0.0f));
        ModelRenderer hair4 = new ModelRenderer((ModelBase)this);
        hair4.func_78793_a(-5.0f, -6.0f, -2.0f);
        this.setRotationAngle(hair4, 2.7925f, 0.0873f, -0.6109f);
        this.Head.func_78792_a(hair4);
        hair4.field_78804_l.add(new ModelBox(hair4, 52, 0, -0.0028f, -3.971f, -3.2188f, 3, 8, 3, 0.0f));
        ...
        hair6.field_78804_l.add(new ModelBox(hair6, 48, 2, 1.8099f, -2.4417f, -5.0982f, 3, 6, 5, 0.0f));
        ModelRenderer hair2 = new ModelRenderer((ModelBase)this);
        hair2.func_78793_a(1.0f, -8.0f, 0.0f);
        this.setRotationAngle(hair2, 0.0f, 0.0f, -0.0873f);
        this.Head.func_78792_a(hair2);
        hair2.field_78804_l.add(new ModelBox(hair2, 52, 0, 0.0603f, -3.342f, -3.0f, 3, 6, 3, 0.0f));
        ModelRenderer hair7 = new ModelRenderer((ModelBase)this);
        hair7.func_78793_a(-5.0f, -7.0f, 2.0f);
        this.setRotationAngle(hair7, 2.7925f, 0.0873f, -0.4363f);
        this.Head.func_78792_a(hair7);
        hair7.field_78804_l.add(new ModelBox(hair7, 52, 0, -0.0028f, -3.971f, -3.2188f, 3, 6, 3, 0.0f));
        ModelRenderer hair10 = new ModelRenderer((ModelBase)this);
        hair10.func_78793_a(-4.0f, -2.0f, 4.0f);
        this.setRotationAngle(hair10, -0.5236f, -0.2618f, 0.0f);
        this.Head.func_78792_a(hair10);
        hair10.field_78804_l.add(new ModelBox(hair10, 52, 0, 0.9972f, -4.6289f, -4.1585f, 3, 7, 3, 0.0f));
        ModelRenderer hair11 = new ModelRenderer((ModelBase)this);
        hair11.func_78793_a(-3.0f, -7.0f, -1.0f);
        this.setRotationAngle(hair11, -0.2618f, 0.0f, 0.0f);
        this.Head.func_78792_a(hair11);
        hair11.field_78804_l.add(new ModelBox(hair11, 56, 2, 1.9972f, -1.971f, -3.2188f, 2, 4, 2, 0.0f));
        ...
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 32, 0, -5.029f, -2.3146f, -2.0032f, 3, 3, 4, 0.0f));
        ...
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 32, 0, 9.9969f, -2.5029f, -2.0112f, 3, 3, 4, 0.0f));
