...
extends ModelBase {
    ...
    public ModelHoi(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        ModelRenderer hood = new ModelRenderer((ModelBase)this);
        hood.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Head.func_78792_a(hood);
        hood.field_78804_l.add(new ModelBox(hood, 0, 16, -4.0f, -6.0f, -4.0f, 8, 8, 8, 0.5f));
        ModelRenderer bone = new ModelRenderer((ModelBase)this);
        bone.func_78793_a(0.0f, 24.0f, 0.0f);
        hood.func_78792_a(bone);
        bone.field_78804_l.add(new ModelBox(bone, 50, 18, -3.0f, -22.0f, 4.0f, 6, 7, 1, 0.0f));
        this.Body = new ModelRenderer((ModelBase)this);
        this.Body.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Body.field_78804_l.add(new ModelBox(this.Body, 0, 32, -4.0f, 2.0f, -2.0f, 8, 11, 4, 0.0f));
        ModelRenderer skilt = new ModelRenderer((ModelBase)this);
        skilt.func_78793_a(3.5f, 18.4f, -3.2f);
        this.Body.func_78792_a(skilt);
        skilt.field_78804_l.add(new ModelBox(skilt, 27, 27, -8.0f, -6.0f, 0.8f, 9, 8, 5, 0.0f));
        this.RArm = new ModelRenderer((ModelBase)this);
        this.RArm.func_78793_a(-5.0f, 2.0f, 0.0f);
        this.Body.func_78792_a(this.RArm);
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 0, 49, -2.0f, -0.005f, -2.0f, 3, 11, 4, 0.0f));
        this.LArm = new ModelRenderer((ModelBase)this);
        this.LArm.func_78793_a(5.0f, 2.0f, 0.0f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 24, 43, -1.0998f, -0.005f, -2.0f, 3, 11, 4, 0.0f));
        this.RLeg = new ModelRenderer((ModelBase)this);
        this.RLeg.func_78793_a(-1.9f, 12.0f, 0.1f);
        this.Body.func_78792_a(this.RLeg);
        this.RLeg.field_78804_l.add(new ModelBox(this.RLeg, 32, 0, -2.0f, 1.0f, -2.0f, 4, 11, 4, 0.0f));
        this.LLeg = new ModelRenderer((ModelBase)this);
        this.LLeg.func_78793_a(1.9f, 12.0f, 0.1f);
        this.Body.func_78792_a(this.LLeg);
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 40, 42, -2.0f, 1.0f, -2.0f, 4, 11, 4, 0.0f));
    }
