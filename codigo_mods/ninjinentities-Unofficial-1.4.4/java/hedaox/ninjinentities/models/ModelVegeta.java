...
extends ModelBase {
    ...
    public ModelVegeta(float _scale) {
        ...
        hair1.field_78804_l.add(new ModelBox(hair1, 42, 2, -0.5133f, -5.474f, -2.0714f, 4, 8, 4, 0.0f));
        ...
        hair5.field_78804_l.add(new ModelBox(hair5, 45, 2, -0.0028f, -3.971f, -3.2188f, 3, 8, 3, 0.0f));
