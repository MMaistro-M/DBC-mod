...
extends ModelBase {
    ...
    public Model6Stars(float _scale) {
        ...
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 0, 16, -4.0f, -8.0f, -4.0f, 8, 8, 8, 0.5f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 72, 0, -2.0f, -10.0f, -5.0f, 4, 4, 10, 0.01f));
        this.HatLayer_r1 = new ModelRenderer((ModelBase)this);
        this.HatLayer_r1.func_78793_a(-1.0f, -8.0f, 3.0f);
        this.bipedHead.func_78792_a(this.HatLayer_r1);
        this.setRotationAngle(this.HatLayer_r1, -1.3963f, 0.0f, 0.0f);
        this.HatLayer_r1.field_78804_l.add(new ModelBox(this.HatLayer_r1, 32, 13, -1.0f, -2.0f, 0.0f, 4, 4, 9, 0.0f));
        this.HatLayer_r2 = new ModelRenderer((ModelBase)this);
        this.HatLayer_r2.func_78793_a(-1.5f, 0.0f, 4.5f);
        this.bipedHead.func_78792_a(this.HatLayer_r2);
        this.setRotationAngle(this.HatLayer_r2, -0.9163f, 0.0f, 0.0f);
        this.HatLayer_r2.field_78804_l.add(new ModelBox(this.HatLayer_r2, 0, 48, 0.0f, -1.0f, 0.0f, 3, 3, 9, 0.0f));
        ...
        this.HatLayer_r3.func_78793_a(-1.0f, -5.0f, 1.0f);
        this.Head2.func_78792_a(this.HatLayer_r3);
        this.setRotationAngle(this.HatLayer_r3, 0.0f, 0.0f, 0.1309f);
        this.HatLayer_r3.field_78804_l.add(new ModelBox(this.HatLayer_r3, 24, 44, -6.0f, -3.0f, -5.0f, 4, 4, 8, 0.49f));
        this.HatLayer_r4 = new ModelRenderer((ModelBase)this);
        this.HatLayer_r4.func_78793_a(1.0f, -5.0f, 1.0f);
        this.Head2.func_78792_a(this.HatLayer_r4);
        this.setRotationAngle(this.HatLayer_r4, 0.0f, 0.0f, -0.1309f);
        this.HatLayer_r4.field_78804_l.add(new ModelBox(this.HatLayer_r4, 25, 32, 2.0f, -3.0f, -5.0f, 4, 4, 8, 0.49f));
        this.HatLayer_r5 = new ModelRenderer((ModelBase)this);
        this.HatLayer_r5.func_78793_a(-1.8096f, 1.0794f, 3.4602f);
        this.Head2.func_78792_a(this.HatLayer_r5);
        this.setRotationAngle(this.HatLayer_r5, 0.1745f, -0.2618f, 0.0f);
        this.HatLayer_r5.field_78804_l.add(new ModelBox(this.HatLayer_r5, 13, 75, -2.0f, 0.0f, 0.0f, 4, 16, 1, 0.5f));
        this.HatLayer_r6 = new ModelRenderer((ModelBase)this);
        this.HatLayer_r6.func_78793_a(1.8096f, 1.0794f, 3.4602f);
        this.Head2.func_78792_a(this.HatLayer_r6);
        this.setRotationAngle(this.HatLayer_r6, 0.1745f, 0.2618f, 0.0f);
        this.HatLayer_r6.field_78804_l.add(new ModelBox(this.HatLayer_r6, -1, 75, -2.0f, 0.0f, 0.0f, 4, 16, 1, 0.5f));
        this.bipedBody = new ModelRenderer((ModelBase)this);
        this.bipedBody.func_78793_a(0.0f, 0.0f, 0.0f);
        this.bipedBody.field_78804_l.add(new ModelBox(this.bipedBody, 0, 32, -4.0f, 0.0f, -2.0f, 8, 12, 4, 0.0f));
        ...
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 50, 42, -2.0f, 0.0f, -2.0f, 4, 12, 4, 0.0f));
        ...
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 50, 26, -2.0f, 0.0f, -2.0f, 4, 12, 4, 0.0f));
        ...
        this.bipedLeftArm.field_78804_l.add(new ModelBox(this.bipedLeftArm, 58, 0, -1.0f, -2.0f, -2.0f, 3, 12, 4, 0.0f));
        ...
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 24, 56, -2.0f, -2.0f, -2.0f, 3, 12, 4, 0.0f));
    }
