...
extends ModelBase {
    ...
    public ModelGohanAdult(float _scale) {
        ...
        this.setRotationAngle(hair1, -0.0873f, 0.0f, 0.1746f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 42, 2, -0.5133f, -5.474f, -2.0714f, 3, 8, 3, 0.0f));
        ...
        hair4.func_78793_a(2.0f, -6.0f, 0.0f);
        this.setRotationAngle(hair4, 0.0f, 0.0873f, 0.2792f);
        this.Head.func_78792_a(hair4);
        hair4.field_78804_l.add(new ModelBox(hair4, 45, 2, -0.5666f, -4.6684f, -2.2431f, 3, 6, 3, 0.0f));
        ModelRenderer hair5 = new ModelRenderer((ModelBase)this);
        hair5.func_78793_a(-5.0f, -8.0f, -2.0f);
        this.setRotationAngle(hair5, 2.7925f, 0.0873f, -0.0873f);
        this.Head.func_78792_a(hair5);
        hair5.field_78804_l.add(new ModelBox(hair5, 45, 2, 0.7972f, -2.171f, -3.2188f, 3, 6, 3, 0.0f));
        ModelRenderer hair6 = new ModelRenderer((ModelBase)this);
        hair6.func_78793_a(-5.0f, -8.8f, 4.0f);
        this.setRotationAngle(hair6, -0.3491f, 0.0f, 0.0873f);
        this.Head.func_78792_a(hair6);
        hair6.field_78804_l.add(new ModelBox(hair6, 45, 2, 1.8099f, -3.1257f, -3.2188f, 3, 6, 3, 0.0f));
        ...
        this.setRotationAngle(hair8, 2.7925f, 0.0873f, -0.2269f);
        this.Head.func_78792_a(hair8);
        hair8.field_78804_l.add(new ModelBox(hair8, 45, 2, 0.4972f, -3.071f, -3.2188f, 3, 6, 3, 0.0f));
        ModelRenderer hair9 = new ModelRenderer((ModelBase)this);
        hair9.func_78793_a(1.4f, -8.0f, 2.0f);
        ...
        strand1.func_78793_a(-0.4f, -5.0f, -2.0f);
        this.setRotationAngle(strand1, -0.3491f, 0.0f, -0.4363f);
