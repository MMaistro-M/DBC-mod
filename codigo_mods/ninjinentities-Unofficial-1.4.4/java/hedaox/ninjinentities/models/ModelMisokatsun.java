...
extends ModelBase {
    ...
    public ModelMisokatsun(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.Head.field_78804_l.add(new ModelBox(this.Head, 0, 18, -4.0f, -8.0f, -4.0f, 8, 8, 8, 0.0f));
        ...
        headChild_2.field_78804_l.add(new ModelBox(headChild_2, 0, 52, 4.0f, -7.0f, -1.0f, 0, 6, 6, 0.0f));
        ...
        headChild_1.field_78804_l.add(new ModelBox(headChild_1, 0, 52, -4.0f, -7.0f, -1.0f, 0, 6, 6, 0.0f));
        ...
        this.setRotationAngle(this.RArm, -0.0086f, 0.0f, 0.2212f);
        this.Body.func_78792_a(this.RArm);
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 38, 42, -5.0f, -2.0f, -2.0f, 4, 12, 4, 0.0f));
        this.LArm = new ModelRenderer((ModelBase)this);
        this.LArm.func_78793_a(5.0f, 2.0f, 0.0f);
        this.setRotationAngle(this.LArm, 0.0086f, 0.0f, -0.2212f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 22, 42, 1.0f, -2.0f, -2.0f, 4, 12, 4, 0.0f));
        this.RLeg = new ModelRenderer((ModelBase)this);
        this.RLeg.func_78793_a(-1.9f, 12.0f, 0.0f);
        this.Body.func_78792_a(this.RLeg);
        this.RLeg.field_78804_l.add(new ModelBox(this.RLeg, 0, 34, -3.0f, 0.0f, -3.0f, 5, 12, 6, 0.0f));
        this.LLeg = new ModelRenderer((ModelBase)this);
        this.LLeg.func_78793_a(1.9f, 12.0f, 0.0f);
        this.Body.func_78792_a(this.LLeg);
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 36, 0, -1.9f, 0.0f, -3.0f, 5, 12, 6, 0.0f));
    }
