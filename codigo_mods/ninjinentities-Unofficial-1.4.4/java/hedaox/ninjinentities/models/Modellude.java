...
extends ModelBase {
    ...
    public Modellude(float _scale) {
        ...
        this.Head_r1.func_78793_a(1.5f, -7.5f, 0.0f);
        this.bipedHead.func_78792_a(this.Head_r1);
        this.setRotationAngle(this.Head_r1, 0.0f, 0.0f, 0.6545f);
        this.Head_r1.field_78804_l.add(new ModelBox(this.Head_r1, 40, 30, 0.0f, -3.0f, -1.0f, 3, 3, 3, 0.0f));
        this.Head_r2 = new ModelRenderer((ModelBase)this);
        this.Head_r2.func_78793_a(-1.5f, -7.5f, 0.0f);
        this.bipedHead.func_78792_a(this.Head_r2);
        this.setRotationAngle(this.Head_r2, 0.0f, 0.0f, -0.6545f);
        this.Head_r2.field_78804_l.add(new ModelBox(this.Head_r2, 12, 38, -3.0f, -3.0f, -1.0f, 3, 3, 3, 0.0f));
        this.bipedBody = new ModelRenderer((ModelBase)this);
        this.bipedBody.func_78793_a(0.0f, 2.0f, 0.0f);
        this.bipedBody.field_78804_l.add(new ModelBox(this.bipedBody, 0, 28, -4.0f, 0.0f, -2.0f, 8, 6, 4, 0.0f));
        this.bipedBody.field_78804_l.add(new ModelBox(this.bipedBody, 0, 16, -4.0f, 6.0f, -4.0f, 8, 6, 6, 0.0f));
        ...
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 33, 0, -2.0f, -2.0f, -1.5f, 3, 10, 3, 0.0f));
        ...
        this.bipedLeftArm.field_78804_l.add(new ModelBox(this.bipedLeftArm, 0, 38, -1.0f, -2.0f, -1.5f, 3, 10, 3, 0.0f));
        ...
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 28, 16, -2.0f, 0.0f, -2.0f, 4, 10, 4, 0.0f));
        ...
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 24, 30, -2.0f, 0.0f, -2.0f, 4, 10, 4, 0.0f));
    }
