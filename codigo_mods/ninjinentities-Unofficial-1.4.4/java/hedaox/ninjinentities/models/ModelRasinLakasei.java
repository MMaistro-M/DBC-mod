...
public class ModelRasinLakasei
extends ModelBase {
    ...
    public ModelRasinLakasei(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.Head.field_78804_l.add(new ModelBox(this.Head, 25, 26, -4.0f, 0.0f, -4.0f, 8, 8, 8, 0.0f));
        this.Head.field_78804_l.add(new ModelBox(this.Head, 0, 72, -4.0f, 5.0f, -4.0f, 8, 3, 9, 0.5f));
        this.Body = new ModelRenderer((ModelBase)this);
        this.Body.func_78793_a(0.2f, 5.4f, -0.2f);
        this.Body.field_78804_l.add(new ModelBox(this.Body, 34, 12, -4.2f, 2.6f, -1.8f, 8, 8, 4, 0.0f));
        ModelRenderer cape = new ModelRenderer((ModelBase)this);
        cape.func_78793_a(-0.2f, -5.4f, 0.2f);
        this.Body.func_78792_a(cape);
        cape.field_78804_l.add(new ModelBox(cape, 84, 0, -4.0f, 8.0f, -3.0f, 8, 5, 6, 0.0f));
        ModelRenderer bone2 = new ModelRenderer((ModelBase)this);
        bone2.func_78793_a(-4.2f, -3.4f, 0.2f);
        this.Body.func_78792_a(bone2);
        bone2.field_78804_l.add(new ModelBox(bone2, 0, 117, 8.0f, 6.0f, -3.0f, 4, 5, 6, 0.0f));
        ModelRenderer bone = new ModelRenderer((ModelBase)this);
        bone.func_78793_a(-0.2f, 18.6f, 0.2f);
        this.Body.func_78792_a(bone);
        bone.field_78804_l.add(new ModelBox(bone, 108, 27, -8.0f, -16.0f, -3.0f, 4, 5, 6, 0.0f));
        this.RArm = new ModelRenderer((ModelBase)this);
        this.RArm.func_78793_a(-4.2f, -3.4f, 0.2f);
        this.Body.func_78792_a(this.RArm);
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 48, 48, -4.0f, 6.0f, -2.0f, 4, 8, 4, 0.0f));
        this.LArm = new ModelRenderer((ModelBase)this);
        this.LArm.func_78793_a(-4.2f, -3.4f, 0.2f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 54, 20, 8.0f, 6.0f, -2.0f, 4, 8, 4, 0.0f));
        this.RLeg = new ModelRenderer((ModelBase)this);
        this.RLeg.func_78793_a(-2.2f, 6.6f, 0.2f);
        this.Body.func_78792_a(this.RLeg);
        this.RLeg.field_78804_l.add(new ModelBox(this.RLeg, 0, 43, -2.0f, 4.0f, -2.0f, 4, 8, 4, 0.0f));
        this.LLeg = new ModelRenderer((ModelBase)this);
        this.LLeg.func_78793_a(-2.2f, 6.6f, 0.2f);
        this.Body.func_78792_a(this.LLeg);
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 16, 43, 2.0f, 4.0f, -2.0f, 4, 8, 4, 0.0f));
    }
