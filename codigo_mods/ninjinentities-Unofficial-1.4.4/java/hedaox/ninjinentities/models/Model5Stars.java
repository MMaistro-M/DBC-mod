...
extends ModelBase {
    ...
    public Model5Stars(float _scale) {
        ...
        this.bipedHead.func_78793_a(0.0f, 7.0f, 0.0f);
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 40, 34, -0.5f, -6.0f, -2.5f, 1, 2, 5, 0.01f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 40, 41, -0.5f, -8.0f, -0.5f, 1, 2, 3, 0.01f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 0, 31, -2.5f, -5.0f, -2.5f, 5, 5, 5, 0.0f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 0, 41, -2.0f, -2.0f, -5.5f, 4, 2, 3, 0.0f));
        this.Line_r1 = new ModelRenderer((ModelBase)this);
        this.Line_r1.func_78793_a(-2.5f, -4.0f, -1.5f);
        this.Line_r1.field_78809_i = true;
        this.bipedHead.func_78792_a(this.Line_r1);
        this.setRotationAngle(this.Line_r1, -0.2618f, -0.48f, 0.0f);
        this.Line_r1.field_78804_l.add(new ModelBox(this.Line_r1, 0, 41, 0.0f, -5.0f, -1.0f, 0, 5, 5, 0.0f));
        this.Line_r2 = new ModelRenderer((ModelBase)this);
        this.Line_r2.func_78793_a(2.5f, -4.0f, -1.5f);
        this.bipedHead.func_78792_a(this.Line_r2);
        this.setRotationAngle(this.Line_r2, -0.2618f, 0.48f, 0.0f);
        this.Line_r2.field_78804_l.add(new ModelBox(this.Line_r2, 0, 41, 0.0f, -5.0f, -1.0f, 0, 5, 5, 0.0f));
        ...
        this.Tail.field_78804_l.add(new ModelBox(this.Tail, 36, 1, -1.5f, -2.0f, -1.0f, 3, 3, 4, 0.0f));
        this.Tail2 = new ModelRenderer((ModelBase)this);
        this.Tail2.func_78793_a(-1.0f, -0.75f, 6.0f);
        this.Tail.func_78792_a(this.Tail2);
        this.setRotationAngle(this.Tail2, 0.3927f, 0.0f, 0.0f);
        this.Tail2.field_78804_l.add(new ModelBox(this.Tail2, 35, 9, 0.0f, -2.0f, -4.0f, 2, 2, 5, 0.0f));
        this.bipedRightArm = new ModelRenderer((ModelBase)this);
        this.bipedRightArm.func_78793_a(-5.0f, 11.0f, 0.0f);
        this.bipedBody.func_78792_a(this.bipedRightArm);
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 20, 34, -1.0f, -2.0f, -1.5f, 2, 10, 3, 0.0f));
        this.bipedLeftArm = new ModelRenderer((ModelBase)this);
        this.bipedLeftArm.func_78793_a(5.0f, 11.0f, 0.0f);
        this.bipedBody.func_78792_a(this.bipedLeftArm);
        this.bipedLeftArm.field_78804_l.add(new ModelBox(this.bipedLeftArm, 30, 34, -1.0f, -2.0f, -1.5f, 2, 10, 3, 0.0f));
        this.bipedRightLeg = new ModelRenderer((ModelBase)this);
        this.bipedRightLeg.func_78793_a(-1.9f, 23.0f, 0.0f);
        this.bipedBody.func_78792_a(this.bipedRightLeg);
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 28, 18, -4.0f, 0.0f, -5.0f, 5, 1, 7, 0.0f));
        this.bipedLeftLeg = new ModelRenderer((ModelBase)this);
        this.bipedLeftLeg.func_78793_a(1.9f, 23.0f, 0.0f);
        this.bipedBody.func_78792_a(this.bipedLeftLeg);
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 28, 26, -1.0f, 0.0f, -5.0f, 5, 1, 7, 0.0f));
    }
