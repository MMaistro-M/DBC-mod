...
public class ModelFreeza6Damaged
extends ModelBase {
    ...
    public ModelFreeza6Damaged(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        chest.field_78804_l.add(new ModelBox(chest, 64, 12, -4.5f, 1.0f, -1.9333f, 9, 4, 1, 0.0f));
        ...
        tail1.field_78804_l.add(new ModelBox(tail1, 64, 48, -2.0f, 7.0f, 4.0f, 4, 4, 12, 0.0f));
        ...
        tail2.field_78804_l.add(new ModelBox(tail2, 32, 48, -2.0f, 15.0f, 2.0f, 4, 4, 5, 0.0f));
