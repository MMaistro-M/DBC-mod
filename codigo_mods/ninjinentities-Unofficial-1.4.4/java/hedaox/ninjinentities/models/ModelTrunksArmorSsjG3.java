...
public class ModelTrunksArmorSsjG3
extends ModelBase {
    ...
    public ModelTrunksArmorSsjG3(float _scale) {
        ...
        hair1.field_78804_l.add(new ModelBox(hair1, 42, 2, -2.5133f, -6.474f, -2.0714f, 3, 8, 3, 0.0f));
        ...
        hair2.field_78804_l.add(new ModelBox(hair2, 42, 2, -0.4867f, -6.474f, -2.0714f, 3, 8, 3, 0.0f));
        ...
        hair3.field_78804_l.add(new ModelBox(hair3, 42, 2, -0.4867f, -5.474f, -2.0714f, 3, 7, 3, 0.0f));
        ...
        hair4.field_78804_l.add(new ModelBox(hair4, 42, 2, -2.5133f, -5.474f, -2.0714f, 3, 7, 3, 0.0f));
        ...
        hair5.field_78804_l.add(new ModelBox(hair5, 42, 2, -2.5133f, -5.474f, -2.0714f, 3, 7, 3, 0.0f));
        ...
        hair6.field_78804_l.add(new ModelBox(hair6, 42, 2, -0.4867f, -5.474f, -2.0714f, 3, 7, 3, 0.0f));
        ...
        hair7.field_78804_l.add(new ModelBox(hair7, 42, 2, 0.5133f, -6.474f, -2.0714f, 2, 8, 2, 0.0f));
        ...
        hair8.field_78804_l.add(new ModelBox(hair8, 42, 2, -2.5133f, -6.474f, -2.0714f, 2, 8, 2, 0.0f));
        ...
        hair9.field_78804_l.add(new ModelBox(hair9, 42, 2, 1.6882f, -5.1308f, -0.0337f, 3, 7, 3, 0.0f));
        ...
        hair10.field_78804_l.add(new ModelBox(hair10, 42, 2, -4.6882f, -5.1308f, -0.0337f, 3, 7, 3, 0.0f));
        ...
        hair11.field_78804_l.add(new ModelBox(hair11, 42, 2, -4.6882f, -5.1308f, -0.0337f, 3, 7, 3, 0.0f));
        ...
        hair12.field_78804_l.add(new ModelBox(hair12, 42, 2, 1.6882f, -5.1308f, -0.0337f, 3, 7, 3, 0.0f));
        ...
        hair13.field_78804_l.add(new ModelBox(hair13, 42, 2, 0.6882f, -5.1308f, -0.0337f, 4, 7, 3, 0.0f));
        ...
        hair14.field_78804_l.add(new ModelBox(hair14, 42, 2, -4.6882f, -5.1308f, -0.0337f, 4, 7, 3, 0.0f));
        ModelRenderer strand1 = new ModelRenderer((ModelBase)this);
        strand1.func_78793_a(-6.0f, -6.0f, -2.9f);
        this.setRotationAngle(strand1, -0.3491f, 0.0f, 0.7854f);
        this.Head.func_78792_a(strand1);
        strand1.field_78804_l.add(new ModelBox(strand1, 38, 2, 1.6436f, -4.6388f, -3.0979f, 1, 8, 1, 0.0f));
        ModelRenderer strand2 = new ModelRenderer((ModelBase)this);
        strand2.func_78793_a(6.0f, -6.0f, -2.9f);
        this.setRotationAngle(strand2, -0.3491f, 0.0f, -0.7854f);
        this.Head.func_78792_a(strand2);
        strand2.field_78804_l.add(new ModelBox(strand2, 38, 2, -2.6436f, -4.6388f, -3.0979f, 1, 8, 1, 0.0f));
