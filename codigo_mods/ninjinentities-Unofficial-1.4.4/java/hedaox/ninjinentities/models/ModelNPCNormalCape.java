...
public class ModelNPCNormalCape
extends ModelBase {
    ...
    public ModelNPCNormalCape(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.Head.field_78804_l.add(new ModelBox(this.Head, 23, 0, -4.0f, -8.0f, -4.0f, 8, 8, 8, 0.0f));
        ModelRenderer field_78114_d = new ModelRenderer((ModelBase)this);
        field_78114_d.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Head.func_78792_a(field_78114_d);
        field_78114_d.field_78804_l.add(new ModelBox(field_78114_d, 55, 0, -4.0f, -8.0f, -4.0f, 8, 8, 8, 0.5f));
        this.Body = new ModelRenderer((ModelBase)this);
        this.Body.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Body.field_78804_l.add(new ModelBox(this.Body, 39, 16, -4.0f, 0.0f, -2.0f, 8, 12, 4, 0.0f));
        ModelRenderer cape = new ModelRenderer((ModelBase)this);
        cape.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(cape, 0.1571f, 0.0f, 0.0f);
        this.Body.func_78792_a(cape);
        cape.field_78804_l.add(new ModelBox(cape, 90, 12, -5.0f, 0.0123f, 2.1564f, 10, 20, 0, 0.0f));
        this.RArm = new ModelRenderer((ModelBase)this);
        this.RArm.func_78793_a(-4.0f, 2.0f, 0.0f);
        this.Body.func_78792_a(this.RArm);
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 63, 16, -4.0f, -2.0f, -2.0f, 4, 12, 4, 0.0f));
        this.LArm = new ModelRenderer((ModelBase)this);
        this.LArm.func_78793_a(4.0f, 2.0f, 0.0f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78809_i = true;
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 63, 16, 0.0f, -2.0f, -2.0f, 4, 12, 4, 0.0f));
        this.RLeg = new ModelRenderer((ModelBase)this);
        this.RLeg.func_78793_a(-1.9f, 12.0f, 0.1f);
        this.Body.func_78792_a(this.RLeg);
        this.RLeg.field_78804_l.add(new ModelBox(this.RLeg, 23, 16, -2.0f, 0.0f, -2.0f, 4, 12, 4, 0.0f));
        this.LLeg = new ModelRenderer((ModelBase)this);
        this.LLeg.func_78793_a(1.9f, 12.0f, 0.1f);
        this.Body.func_78792_a(this.LLeg);
        this.LLeg.field_78809_i = true;
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 23, 16, -2.0f, 0.0f, -2.0f, 4, 12, 4, 0.0f));
    }
