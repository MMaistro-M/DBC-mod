...
extends ModelBase {
    ...
    public Modelomega2(float _scale) {
        ...
        this.setRotationAngle(shape3, 0.695f, -0.5463f, -0.8657f);
        ...
        this.setRotationAngle(rightEars, 2.9596f, -0.5463f, -2.3003f);
        ...
        this.setRotationAngle(faceFang3, -0.2276f, -0.5009f, 0.0f);
        ...
        this.setRotationAngle(faceFang2, -0.2276f, 0.5009f, 0.0f);
        ...
        this.setRotationAngle(faceFang, -0.2276f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(headFang, -0.5463f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(headFang2, -0.5463f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(leftArmFang, -0.2731f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(leftShoulderFang, 0.0f, -0.1367f, -0.6374f);
        ...
        this.setRotationAngle(backFang7, 0.6541f, 0.2095f, 0.1581f);
        ...
        this.setRotationAngle(rightArmFang, -0.2731f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(rightShoulderFang, 0.0f, 0.1367f, 0.6374f);
        ...
        this.setRotationAngle(backFang8, 0.6541f, -0.2095f, -0.1581f);
        ...
        this.setRotationAngle(backFang1, 0.5009f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(backFang3, 0.5009f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(backFang2, 0.5009f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(backFang4, 0.5009f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(backFang6, -0.4098f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(backFang5, -0.4098f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(rightLegFang, 0.2731f, 0.0f, 0.0f);
        ...
        this.setRotationAngle(leftLegFang, 0.2731f, 0.0f, 0.0f);
