...
extends ModelBase {
    ...
    public ModelGarlicJr(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        headChild_2.field_78804_l.add(new ModelBox(headChild_2, 0, 54, 4.0f, 1.0f, -1.0f, 0, 4, 6, 0.0f));
        ...
        headChild_1.field_78804_l.add(new ModelBox(headChild_1, 0, 54, -4.0f, 1.0f, -1.0f, 0, 4, 6, 0.0f));
        ModelRenderer tooth = new ModelRenderer((ModelBase)this);
        tooth.func_78793_a(0.625f, 6.3125f, -4.125f);
        this.setRotationAngle(tooth, -0.2618f, 0.2618f, 0.7854f);
        this.Head.func_78792_a(tooth);
        tooth.field_78804_l.add(new ModelBox(tooth, 0, 0, -1.0f, -1.0f, 0.0f, 1, 1, 0, 0.0f));
        ...
        this.setRotationAngle(cape, 0.0873f, 0.0f, 0.0f);
        this.Body.func_78792_a(cape);
        cape.field_78804_l.add(new ModelBox(cape, 46, 48, -4.0f, 9.0f, 3.0f, 8, 15, 0, 0.0f));
        ModelRenderer scarf = new ModelRenderer((ModelBase)this);
        scarf.func_78793_a(-0.2f, 18.6f, 0.2f);
        this.Body.func_78792_a(scarf);
        scarf.field_78804_l.add(new ModelBox(scarf, 13, 55, -4.0f, -16.0f, -4.0f, 8, 1, 8, 0.5f));
