...
extends ModelBase {
    ...
    public ModelTrioDanger(float _scale) {
        ...
        this.Head.field_78804_l.add(new ModelBox(this.Head, 0, 0, -4.0f, -7.0f, -4.0f, 8, 7, 8, 0.0f));
        ...
        ModelRenderer REar = new ModelRenderer((ModelBase)this);
        REar.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(REar, 0.0f, -0.5236f, 0.0f);
        this.Head.func_78792_a(REar);
        REar.field_78804_l.add(new ModelBox(REar, 32, 0, -4.0f, -10.0f, -1.0f, 0, 6, 6, 0.0f));
        ModelRenderer LEar = new ModelRenderer((ModelBase)this);
        LEar.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(LEar, 0.0f, 0.5236f, 0.0f);
        this.Head.func_78792_a(LEar);
        LEar.field_78804_l.add(new ModelBox(LEar, 32, 0, 4.0f, -10.0f, -1.0f, 0, 6, 6, 0.0f));
        ...
        tail.func_78793_a(4.0f, 6.0f, -2.0f);
        this.setRotationAngle(tail, -0.7854f, 0.0f, 0.0f);
        this.Body.func_78792_a(tail);
        tail.field_78804_l.add(new ModelBox(tail, 32, 0, -1.7f, -2.4f, -0.8f, 3, 3, 12, 0.0f));
    }
