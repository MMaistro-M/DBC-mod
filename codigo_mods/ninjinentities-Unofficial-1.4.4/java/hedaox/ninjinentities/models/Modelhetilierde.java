...
extends ModelBase {
    ...
    public Modelhetilierde(float _scale) {
        ...
        this.bipedBody.field_78804_l.add(new ModelBox(this.bipedBody, 0, 117, -16.0f, -4.0f, 3.5f, 32, 10, 1, 0.0f));
        ...
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 116, 17, -3.0f, 10.0f, -1.5f, 3, 3, 3, 0.0f));
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 0, 67, -2.5f, 13.0f, -1.0f, 2, 2, 2, 0.0f));
