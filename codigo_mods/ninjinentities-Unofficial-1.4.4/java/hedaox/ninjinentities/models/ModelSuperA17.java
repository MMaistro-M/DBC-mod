...
extends ModelBase {
    ...
    public ModelSuperA17(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.head.field_78804_l.add(new ModelBox(this.head, 32, 0, -4.0f, 0.0f, -4.0f, 8, 8, 8, 0.0f));
        ModelRenderer hair_r1 = new ModelRenderer((ModelBase)this);
        hair_r1.func_78793_a(1.0f, -8.0f, -4.0f);
        hair_r1.field_78809_i = true;
        this.head.func_78792_a(hair_r1);
        this.setRotationAngle(hair_r1, 0.0f, -0.2618f, -0.2182f);
        hair_r1.field_78804_l.add(new ModelBox(hair_r1, 24, -2, 0.0f, 0.0f, -1.9f, 0, 8, 2, 0.0f));
        ModelRenderer hair_r2 = new ModelRenderer((ModelBase)this);
        hair_r2.func_78793_a(-1.0f, -8.0f, -4.0f);
        this.head.func_78792_a(hair_r2);
        this.setRotationAngle(hair_r2, 0.0f, 0.2618f, 0.2182f);
        hair_r2.field_78804_l.add(new ModelBox(hair_r2, 24, -2, 0.0f, 0.0f, -1.9f, 0, 8, 2, 0.0f));
    }
