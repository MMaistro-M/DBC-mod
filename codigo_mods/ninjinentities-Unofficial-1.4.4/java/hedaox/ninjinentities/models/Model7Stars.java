...
extends ModelBase {
    ...
    public Model7Stars(float _scale) {
        ...
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 18, 42, -2.5f, -7.0f, 0.5f, 1, 2, 1, 0.01f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 18, 45, 1.5f, -7.0f, 0.5f, 1, 2, 1, 0.01f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 34, 8, -3.0f, -5.0f, -2.5f, 6, 5, 5, 0.0f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 54, 0, -0.5f, -4.5f, -2.6f, 1, 1, 0, 0.0f));
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 0, 51, -2.0f, -2.0f, -6.5f, 4, 2, 4, 0.0f));
        ...
        this.setRotationAngle(this.Line_r1, -0.2618f, -0.48f, 0.0f);
        this.Line_r1.field_78804_l.add(new ModelBox(this.Line_r1, 52, 48, 0.0f, -5.0f, -1.0f, 0, 5, 5, 0.0f));
        ...
        this.setRotationAngle(this.Line_r2, -0.2618f, 0.48f, 0.0f);
        this.Line_r2.field_78804_l.add(new ModelBox(this.Line_r2, 28, 49, 0.0f, -5.0f, -1.0f, 0, 5, 5, 0.0f));
        ...
        this.Tail.func_78793_a(0.0f, 21.0f, 5.0f);
        this.bipedBody.func_78792_a(this.Tail);
        this.setRotationAngle(this.Tail, -0.3054f, 0.0f, 0.0f);
        this.Tail.field_78804_l.add(new ModelBox(this.Tail, 28, 18, -3.5f, -4.0f, -2.0f, 7, 6, 7, 0.0f));
        this.Tail2 = new ModelRenderer((ModelBase)this);
        this.Tail2.func_78793_a(-1.0f, -0.75f, 4.0f);
        this.Tail.func_78792_a(this.Tail2);
        this.setRotationAngle(this.Tail2, 0.3927f, 0.0f, 0.0f);
        this.Tail2.field_78804_l.add(new ModelBox(this.Tail2, 0, 31, -2.0f, -2.852f, -0.2284f, 6, 5, 6, 0.0f));
        this.Tail3 = new ModelRenderer((ModelBase)this);
        this.Tail3.func_78793_a(1.0f, 0.3981f, 4.7716f);
        this.Tail2.func_78792_a(this.Tail3);
        this.setRotationAngle(this.Tail3, 0.3927f, 0.0f, 0.0f);
        this.Tail3.field_78804_l.add(new ModelBox(this.Tail3, 24, 39, -2.0f, -3.5412f, 0.3066f, 4, 5, 5, 0.0f));
        this.Tail4 = new ModelRenderer((ModelBase)this);
        this.Tail4.func_78793_a(-1.0f, -1.2912f, 4.3066f);
        this.Tail3.func_78792_a(this.Tail4);
        this.setRotationAngle(this.Tail4, 0.3927f, 0.0f, 0.0f);
        this.Tail4.field_78804_l.add(new ModelBox(this.Tail4, 48, 31, -0.5f, -1.8519f, -0.2284f, 3, 3, 5, 0.0f));
        ...
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 42, 48, -1.0f, -2.0f, -1.5f, 2, 10, 3, 0.0f));
        ...
        this.bipedLeftArm.field_78804_l.add(new ModelBox(this.bipedLeftArm, 18, 49, -1.0f, -2.0f, -1.5f, 2, 10, 3, 0.0f));
        this.bipedRightLeg = new ModelRenderer((ModelBase)this);
        this.bipedRightLeg.func_78793_a(-2.0f, 21.0f, 0.0f);
        this.bipedBody.func_78792_a(this.bipedRightLeg);
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 24, 31, -3.9f, 2.0f, -6.0f, 5, 1, 7, 0.0f));
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 0, 42, -3.4f, -2.0f, -4.0f, 4, 4, 5, 0.25f));
        this.bipedLeftLeg = new ModelRenderer((ModelBase)this);
        this.bipedLeftLeg.func_78793_a(2.0f, 21.0f, 0.0f);
        this.bipedBody.func_78792_a(this.bipedLeftLeg);
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 34, 0, -1.1f, 2.0f, -6.0f, 5, 1, 7, 0.0f));
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 42, 39, -0.6f, -2.0f, -4.0f, 4, 4, 5, 0.25f));
    }
