...
extends ModelBase {
    ...
    public ModelGamma2(float _scale) {
        ...
        tb.func_78793_a(-1.0f, -5.0f, 0.0f);
        this.Head.func_78792_a(tb);
        this.setRotationAngle(tb, 0.0f, 0.0f, -0.3491f);
        tb.field_78804_l.add(new ModelBox(tb, 44, 2, -0.5f, -7.87f, 0.0f, 1, 5, 3, 0.0f));
        ModelRenderer cube_r1 = new ModelRenderer((ModelBase)this);
        cube_r1.func_78793_a(0.0f, -2.316f, -3.4661f);
        ...
        cube_r2.func_78793_a(0.0f, -4.5f, -3.5f);
        ...
        cube_r3.func_78793_a(0.0f, -4.5f, -3.5f);
        ...
        ModelRenderer tb2 = new ModelRenderer((ModelBase)this);
        tb2.func_78793_a(1.0f, -5.0f, 0.0f);
        this.Head.func_78792_a(tb2);
        this.setRotationAngle(tb2, 0.0f, 0.0f, 0.3491f);
        tb2.field_78804_l.add(new ModelBox(tb2, 44, 2, -0.5f, -7.87f, 0.0f, 1, 5, 3, 0.0f));
        ModelRenderer cube_r4 = new ModelRenderer((ModelBase)this);
        cube_r4.func_78793_a(0.0f, -2.316f, -3.4661f);
        tb2.func_78792_a(cube_r4);
        this.setRotationAngle(cube_r4, -1.2654f, 0.0f, 0.0f);
        cube_r4.field_78804_l.add(new ModelBox(cube_r4, 44, 3, -0.5f, -1.0f, -1.5f, 1, 2, 3, 0.0f));
        ModelRenderer cube_r5 = new ModelRenderer((ModelBase)this);
        cube_r5.func_78793_a(0.0f, -4.5f, -3.5f);
        tb2.func_78792_a(cube_r5);
        this.setRotationAngle(cube_r5, -1.0472f, 0.0f, 0.0f);
        cube_r5.field_78804_l.add(new ModelBox(cube_r5, 42, 0, -0.5f, -4.75f, -1.15f, 1, 3, 5, 0.0f));
        cube_r5.field_78804_l.add(new ModelBox(cube_r5, 43, 1, -0.5f, -2.75f, -1.15f, 1, 3, 4, 0.0f));
        ModelRenderer cube_r6 = new ModelRenderer((ModelBase)this);
        cube_r6.func_78793_a(0.0f, -4.5f, -3.5f);
        tb2.func_78792_a(cube_r6);
        this.setRotationAngle(cube_r6, -0.3054f, 0.0f, 0.0f);
        cube_r6.field_78804_l.add(new ModelBox(cube_r6, 44, 2, -0.5f, -0.6f, -1.0f, 1, 2, 3, 0.0f));
        ...
        cube_r7.func_78793_a(-0.5f, -4.9f, 3.0f);
        this.Body.func_78792_a(cube_r7);
        this.setRotationAngle(cube_r7, 0.2182f, 0.0f, 0.0f);
        cube_r7.field_78804_l.add(new ModelBox(cube_r7, 98, 0, -7.5f, -0.6f, -0.7f, 15, 21, 0, 0.0f));
