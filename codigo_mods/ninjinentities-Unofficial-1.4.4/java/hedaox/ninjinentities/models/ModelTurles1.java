...
extends ModelBase {
    ...
    public ModelTurles1(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        ModelRenderer detector = new ModelRenderer((ModelBase)this);
        detector.func_78793_a(0.0f, 0.0f, 0.0f);
        this.Head.func_78792_a(detector);
        detector.field_78804_l.add(new ModelBox(detector, 67, 18, 4.0f, -5.0f, -2.0f, 1, 3, 3, 0.0f));
        detector.field_78804_l.add(new ModelBox(detector, 68, 21, 4.0f, -4.0f, -4.25f, 1, 1, 2, 0.0f));
        ModelRenderer screen = new ModelRenderer((ModelBase)this);
        screen.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(screen, 0.0f, -0.1745f, 0.0f);
        detector.func_78792_a(screen);
        screen.field_78804_l.add(new ModelBox(screen, 65, 26, 0.0f, -5.0f, -5.0f, 4, 3, 0, 0.0f));
        ...
        cape.field_78804_l.add(new ModelBox(cape, 50, 32, -7.0f, 0.0123f, 2.1564f, 14, 20, 0, 0.0f));
