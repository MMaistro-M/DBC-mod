...
extends ModelBase {
    ...
    public ModelNamekian(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        earR.func_78793_a(-4.0f, -2.0f, 0.0f);
        this.setRotationAngle(earR, 0.0f, -0.5236f, 0.0f);
        this.Head.func_78792_a(earR);
        earR.field_78804_l.add(new ModelBox(earR, 35, 6, 0.0f, -4.0f, 0.0f, 0, 4, 3, 0.0f));
        ModelRenderer earL = new ModelRenderer((ModelBase)this);
        earL.func_78793_a(4.0f, -2.0f, 0.0f);
        this.setRotationAngle(earL, 0.0f, 0.5236f, 0.0f);
        this.Head.func_78792_a(earL);
        earL.field_78809_i = true;
        earL.field_78804_l.add(new ModelBox(earL, 35, 6, 0.0f, -4.0f, 0.0f, 0, 4, 3, 0.0f));
        ModelRenderer antennaR = new ModelRenderer((ModelBase)this);
        antennaR.func_78793_a(-1.9375f, -6.3125f, -5.0625f);
        this.setRotationAngle(antennaR, 0.3491f, 0.2618f, 0.0f);
        this.Head.func_78792_a(antennaR);
        antennaR.field_78804_l.add(new ModelBox(antennaR, 34, 3, -0.5f, -0.5f, -1.5f, 1, 1, 3, 0.0f));
        ModelRenderer antennaL = new ModelRenderer((ModelBase)this);
        antennaL.func_78793_a(1.9375f, -6.3125f, -5.0625f);
        this.setRotationAngle(antennaL, 0.3491f, -0.2618f, 0.0f);
        this.Head.func_78792_a(antennaL);
        antennaL.field_78809_i = true;
        antennaL.field_78804_l.add(new ModelBox(antennaL, 46, 3, -0.5f, -0.5f, -1.5f, 1, 1, 3, 0.0f));
        ...
        this.RLeg.field_78804_l.add(new ModelBox(this.RLeg, 0, 16, -2.1f, 0.0f, -2.1f, 4, 12, 4, 0.0f));
        this.LLeg = new ModelRenderer((ModelBase)this);
        this.LLeg.func_78793_a(1.9f, 12.0f, 0.1f);
        this.Body.func_78792_a(this.LLeg);
        this.LLeg.field_78809_i = true;
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 0, 16, -1.9f, 0.0f, -2.1f, 4, 12, 4, 0.0f));
    }
