...
extends ModelBase {
    ...
    public ModelKishime(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        headChild_2.field_78804_l.add(new ModelBox(headChild_2, 52, 11, 4.0f, -7.0f, -1.0f, 0, 4, 5, 0.0f));
        ...
        headChild_1.field_78804_l.add(new ModelBox(headChild_1, 52, 11, -4.0f, -7.0f, -1.0f, 0, 4, 5, 0.0f));
        ...
        bone.field_78804_l.add(new ModelBox(bone, 56, 19, 0.0f, -23.0f, 2.0f, 0, 9, 4, 0.0f));
        ...
        ModelRenderer field_78112_f = new ModelRenderer((ModelBase)this);
        field_78112_f.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(field_78112_f, 0.0f, 0.0f, 0.1f);
        this.RArm.func_78792_a(field_78112_f);
        ...
        field_78112_f.func_78792_a(rightarmshoulder);
        rightarmshoulder.field_78804_l.add(new ModelBox(rightarmshoulder, 38, 0, -3.0f, -3.0f, -2.3125f, 4, 4, 6, 0.0f));
        ...
        leftarmshoulder.func_78793_a(0.0f, 0.0f, -0.0625f);
        ...
        leftarmshoulder.field_78804_l.add(new ModelBox(leftarmshoulder, 38, 0, -1.0f, -3.0f, -3.0f, 4, 4, 6, 0.0f));
