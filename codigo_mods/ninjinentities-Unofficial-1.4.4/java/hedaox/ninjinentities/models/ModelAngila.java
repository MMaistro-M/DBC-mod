...
extends ModelBase {
    ...
    public ModelAngila(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        hornR.field_78804_l.add(new ModelBox(hornR, 0, 3, -3.0f, -31.0f, -6.0f, 1, 1, 2, 0.0f));
        ...
        hornL.field_78804_l.add(new ModelBox(hornL, 0, 3, 2.0f, -31.0f, -6.0f, 1, 1, 2, 0.0f));
        ...
        bone4.func_78793_a(0.0f, 24.0f, -0.4375f);
        this.Body.func_78792_a(bone4);
        bone4.field_78804_l.add(new ModelBox(bone4, 0, 16, -5.0f, -24.0f, -2.0f, 10, 10, 5, 0.0f));
        ModelRenderer cape = new ModelRenderer((ModelBase)this);
        cape.func_78793_a(0.0f, 0.0f, -1.0f);
        this.setRotationAngle(cape, 0.1745f, 0.0f, 0.0f);
        this.Body.func_78792_a(cape);
        cape.field_78804_l.add(new ModelBox(cape, 0, 32, -5.0f, 1.0f, 4.0f, 10, 22, 0, 0.0f));
        ...
        bone5.field_78804_l.add(new ModelBox(bone5, 55, 55, -2.5872f, -0.5962f, -2.4f, 4, 6, 5, 0.0f));
        ...
        bone6.field_78804_l.add(new ModelBox(bone6, 56, 0, 1.5834f, -12.509f, -2.4f, 4, 5, 5, 0.0f));
    }
