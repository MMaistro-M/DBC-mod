...
public class ModelKaioshinChild
extends ModelBase {
    ...
    public ModelKaioshinChild(float _scale) {
        ...
        this.setRotationAngle(this.hair1, -0.0107f, 0.3033f, -0.0092f);
        ...
        this.RArm.func_78793_a(-4.0f, -3.6f, 0.2f);
        this.Body.func_78792_a(this.RArm);
        this.RArm.field_78804_l.add(new ModelBox(this.RArm, 40, 16, -3.9f, -2.1f, -2.0f, 4, 12, 4, -0.3f));
        this.LArm = new ModelRenderer((ModelBase)this);
        this.LArm.func_78793_a(3.8f, -3.4f, 0.2f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 32, 48, -0.3f, -2.3f, -2.0f, 4, 12, 4, -0.3f));
