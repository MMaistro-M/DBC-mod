...
extends ModelBase {
    ...
    public Model3or4stars(float _scale) {
        ...
        this.bipedHead.field_78804_l.add(new ModelBox(this.bipedHead, 48, 0, -1.0f, -9.0f, -4.0f, 2, 4, 8, 0.01f));
        this.LEar_r1 = new ModelRenderer((ModelBase)this);
        this.LEar_r1.func_78793_a(4.0f, -4.0f, -2.0f);
        ...
        this.REar_r1.func_78793_a(-4.0f, -4.0f, -2.0f);
        ...
        this.bipedRightArm.field_78804_l.add(new ModelBox(this.bipedRightArm, 38, 33, -2.0f, -3.0f, -2.0f, 3, 12, 4, 0.0f));
        ...
        this.bipedRightLeg.field_78804_l.add(new ModelBox(this.bipedRightLeg, 32, 0, -1.9f, 0.0f, -2.0f, 4, 12, 4, 0.0f));
        ...
        this.bipedLeftLeg.field_78804_l.add(new ModelBox(this.bipedLeftLeg, 22, 33, -2.1f, 0.0f, -2.0f, 4, 12, 4, 0.0f));
        this.LeftWing = new ModelRenderer((ModelBase)this);
        this.LeftWing.func_78793_a(0.0f, 0.0f, 4.0f);
        this.bipedBody.func_78792_a(this.LeftWing);
        this.setRotationAngle(this.LeftWing, 0.1731f, 0.0227f, -0.1289f);
        ...
        this.RightWing.func_78793_a(0.0f, 0.0f, 4.0f);
        this.bipedBody.func_78792_a(this.RightWing);
        this.setRotationAngle(this.RightWing, 0.1731f, -0.0227f, 0.1289f);
