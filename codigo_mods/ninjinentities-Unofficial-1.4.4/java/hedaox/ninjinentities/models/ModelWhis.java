...
extends ModelBase {
    ...
    public ModelWhis(float _scale) {
        ...
        hair1.func_78793_a(0.2f, -7.0f, 0.0f);
        this.setRotationAngle(hair1, 0.0f, -1.5708f, 0.0f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 39, 2, -3.0f, -5.0f, -2.3f, 6, 4, 5, 0.0f));
        ModelRenderer hair2 = new ModelRenderer((ModelBase)this);
        hair2.func_78793_a(0.2f, -7.0f, 0.0f);
        this.setRotationAngle(hair2, 0.0f, -1.5708f, 0.0f);
        this.Head.func_78792_a(hair2);
        hair2.field_78804_l.add(new ModelBox(hair2, 41, 2, -1.5f, -8.0f, -1.3f, 4, 5, 3, 0.0f));
        ...
        ModelRenderer neckWear = new ModelRenderer((ModelBase)this);
        neckWear.func_78793_a(3.4f, -5.0f, -4.0f);
        this.setRotationAngle(neckWear, 0.6981f, 0.0f, 0.0f);
        this.Body.func_78792_a(neckWear);
        neckWear.field_78804_l.add(new ModelBox(neckWear, 57, 16, -5.5f, -2.0f, -6.0f, 12, 1, 15, 0.0f));
    ...
    public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        GL11.glPushMatrix();
        float scale = 1.0f;
        GL11.glScalef((float)scale, (float)(scale * 1.1f), (float)scale);
