...
extends ModelBase {
    ...
    public ModelGohanTeen(float _scale) {
        ...
        this.Hair1.field_78804_l.add(new ModelBox(this.Hair1, 42, 2, -0.5133f, -4.474f, -2.0714f, 3, 7, 3, 0.0f));
        ...
        this.Hair2.field_78804_l.add(new ModelBox(this.Hair2, 45, 2, -1.9397f, -1.658f, -3.0f, 3, 5, 3, 0.0f));
        ...
        this.Hair5.field_78804_l.add(new ModelBox(this.Hair5, 45, 2, -0.0028f, -1.971f, -3.2188f, 3, 5, 3, 0.0f));
        ...
        this.Hair6.field_78804_l.add(new ModelBox(this.Hair6, 45, 2, 1.8099f, -2.1257f, -2.2188f, 3, 6, 3, 0.0f));
