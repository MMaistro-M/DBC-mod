...
extends ModelBase {
    ...
    public ModelAka(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        bone.field_78804_l.add(new ModelBox(bone, 0, 0, -0.5f, -33.0f, -2.0f, 1, 4, 1, 0.0f));
        ModelRenderer bone2 = new ModelRenderer((ModelBase)this);
        bone2.func_78793_a(0.0f, 1.0f, -3.0f);
        this.setRotationAngle(bone2, -0.0873f, 0.0f, 0.0f);
        bone.func_78792_a(bone2);
        bone2.field_78804_l.add(new ModelBox(bone2, 0, 4, -0.5f, -35.0f, -2.0f, 1, 3, 1, 0.0f));
        ModelRenderer bone3 = new ModelRenderer((ModelBase)this);
        bone3.func_78793_a(0.0f, 1.0f, 0.0f);
        this.setRotationAngle(bone3, -0.1745f, 0.0f, 0.0f);
        bone.func_78792_a(bone3);
        bone3.field_78804_l.add(new ModelBox(bone3, 0, 4, -0.5f, -35.9581f, -7.9088f, 1, 3, 1, 0.0f));
