...
extends ModelBase {
    ...
    public ModelSalza(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        hair1.func_78793_a(-3.0f, -6.0f, 0.0f);
        this.setRotationAngle(hair1, 0.0f, 0.0f, 0.7854f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 0, 51, -3.1768f, -2.7348f, -4.375f, 3, 4, 9, 0.0f));
        ModelRenderer hair2 = new ModelRenderer((ModelBase)this);
        hair2.func_78793_a(0.75f, -8.0625f, 0.0f);
        this.Head.func_78792_a(hair2);
        hair2.field_78804_l.add(new ModelBox(hair2, 1, 19, -4.0f, -1.7348f, -4.4375f, 6, 3, 9, 0.0f));
        ModelRenderer hair3 = new ModelRenderer((ModelBase)this);
        hair3.func_78793_a(2.75f, -8.0625f, 0.0f);
        this.setRotationAngle(hair3, 0.0f, 0.0f, 0.6981f);
        this.Head.func_78792_a(hair3);
        hair3.field_78804_l.add(new ModelBox(hair3, 0, 51, -0.75f, -2.7348f, -4.4375f, 3, 4, 9, 0.0f));
        ModelRenderer hair4 = new ModelRenderer((ModelBase)this);
        hair4.func_78793_a(0.75f, -9.0625f, 0.0f);
        this.setRotationAngle(hair4, 0.0f, 0.0f, 0.6981f);
        this.Head.func_78792_a(hair4);
        hair4.field_78804_l.add(new ModelBox(hair4, 0, 52, -0.75f, -2.7348f, -4.1875f, 3, 3, 9, 0.0f));
        ModelRenderer hair5 = new ModelRenderer((ModelBase)this);
        hair5.func_78793_a(-1.25f, -9.0625f, 0.0f);
        this.setRotationAngle(hair5, 0.0f, 0.0f, 0.6981f);
        this.Head.func_78792_a(hair5);
        hair5.field_78804_l.add(new ModelBox(hair5, 0, 52, -0.75f, -2.7348f, -4.375f, 3, 3, 9, 0.0f));
        ModelRenderer hair6 = new ModelRenderer((ModelBase)this);
        hair6.func_78793_a(0.75f, -4.0625f, -1.0f);
        this.setRotationAngle(hair6, -0.1745f, 0.0f, 0.0873f);
        this.Head.func_78792_a(hair6);
        hair6.field_78804_l.add(new ModelBox(hair6, 0, 49, -0.75f, -5.7348f, -4.4375f, 3, 6, 0, 0.0f));
        ModelRenderer hair7 = new ModelRenderer((ModelBase)this);
        hair7.func_78793_a(0.0f, -5.5f, 3.9375f);
        this.setRotationAngle(hair7, -0.0873f, 0.0f, 0.0f);
        this.Head.func_78792_a(hair7);
        hair7.field_78804_l.add(new ModelBox(hair7, 9, 0, -3.0f, -4.5f, -0.5f, 6, 7, 1, 0.0f));
