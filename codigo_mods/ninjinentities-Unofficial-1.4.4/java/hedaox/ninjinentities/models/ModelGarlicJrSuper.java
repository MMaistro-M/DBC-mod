...
public class ModelGarlicJrSuper
extends ModelBase {
    ...
    public ModelGarlicJrSuper(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        ModelRenderer ear2 = new ModelRenderer((ModelBase)this);
        ear2.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(ear2, 0.0f, 0.5236f, 0.0f);
        this.Head.func_78792_a(ear2);
        ear2.field_78804_l.add(new ModelBox(ear2, 22, 11, 4.0f, -7.0f, -1.0f, 0, 4, 6, 0.0f));
        ModelRenderer ear = new ModelRenderer((ModelBase)this);
        ear.func_78793_a(0.0f, 0.0f, 0.0f);
        this.setRotationAngle(ear, 0.0f, -0.5236f, 0.0f);
        this.Head.func_78792_a(ear);
        ear.field_78804_l.add(new ModelBox(ear, 22, 11, -4.0f, -7.0f, -1.0f, 0, 4, 6, 0.0f));
        this.Body = new ModelRenderer((ModelBase)this);
        this.Body.func_78793_a(-3.8f, 5.4f, 3.8f);
        this.Body.field_78804_l.add(new ModelBox(this.Body, 32, 0, -1.2f, -5.4f, -6.8f, 10, 7, 6, 0.0f));
        ModelRenderer body2 = new ModelRenderer((ModelBase)this);
        body2.func_78793_a(3.8f, -4.4f, -3.8f);
        this.Body.func_78792_a(body2);
        body2.field_78804_l.add(new ModelBox(body2, 16, 16, -4.0f, 0.0f, -2.0f, 8, 12, 4, 0.0f));
        this.RArm = new ModelRenderer((ModelBase)this);
        this.RArm.func_78793_a(-1.2f, -3.4f, -3.8f);
        ...
        this.LArm.func_78793_a(8.8f, -3.4f, -3.8f);
        this.Body.func_78792_a(this.LArm);
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 40, 16, 0.0f, -2.0f, -2.0f, 5, 12, 4, 0.0f));
