...
public class ModelVegetaArmorDamaged
extends ModelBase {
    ...
    public ModelVegetaArmorDamaged(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.LArm.field_78809_i = false;
        this.LArm.field_78804_l.add(new ModelBox(this.LArm, 0, 0, 12.02f, -2.0f, -1.0f, 0, 2, 2, 0.0f));
        ...
        this.LLeg.field_78804_l.add(new ModelBox(this.LLeg, 0, 0, 3.0f, 2.0f, -2.02f, 2, 2, 0, 0.0f));
    }
