...
extends ModelBase {
    ...
    public ModelGotenks(float _scale) {
        ...
        this.setRotationAngle(hair1, -0.3491f, 0.0f, -0.1745f);
        this.Head.func_78792_a(hair1);
        hair1.field_78804_l.add(new ModelBox(hair1, 35, 2, -0.5133f, -5.474f, -2.0714f, 4, 8, 4, 0.0f));
        ModelRenderer hair2 = new ModelRenderer((ModelBase)this);
        hair2.func_78793_a(-3.0f, -10.0f, 0.0f);
        this.setRotationAngle(hair2, -0.2618f, 0.0f, 0.2618f);
        this.Head.func_78792_a(hair2);
        hair2.field_78804_l.add(new ModelBox(hair2, 38, 2, 0.0603f, -2.658f, -3.0f, 3, 6, 3, 0.0f));
        ...
        hair3.field_78804_l.add(new ModelBox(hair3, 38, 2, 0.0603f, -3.342f, -3.0f, 3, 6, 3, 0.0f));
        ...
        hair4.field_78804_l.add(new ModelBox(hair4, 52, 2, -2.9972f, -3.971f, -3.2188f, 3, 8, 3, 0.0f));
        ...
        hair5.field_78804_l.add(new ModelBox(hair5, 52, 2, -0.0028f, -3.971f, -3.2188f, 3, 8, 3, 0.0f));
        ...
        hair6.field_78804_l.add(new ModelBox(hair6, 40, 2, 1.8099f, -4.1257f, -3.2188f, 3, 7, 3, 0.0f));
        ...
        hair7.field_78804_l.add(new ModelBox(hair7, 33, 2, 1.8099f, -2.4417f, -5.0982f, 3, 6, 5, 0.0f));
        ...
        hair8.field_78804_l.add(new ModelBox(hair8, 52, 4, -0.0028f, -3.971f, -3.2188f, 3, 6, 3, 0.0f));
        ...
        hair9.field_78804_l.add(new ModelBox(hair9, 52, 4, -0.0028f, -3.971f, -3.2188f, 3, 6, 3, 0.0f));
        ...
        hair10.field_78804_l.add(new ModelBox(hair10, 52, 2, 0.9972f, -4.6289f, -4.1585f, 3, 7, 3, 0.0f));
        ...
        hair11.field_78804_l.add(new ModelBox(hair11, 52, 2, 0.9972f, -4.6289f, -4.1585f, 3, 7, 3, 0.0f));
        ModelRenderer strand2 = new ModelRenderer((ModelBase)this);
        strand2.func_78793_a(-3.0f, -7.4f, -1.0f);
        ...
        belt.field_78804_l.add(new ModelBox(belt, 56, 20, -1.2857f, -1.145f, -0.1004f, 2, 8, 0, 0.0f));
