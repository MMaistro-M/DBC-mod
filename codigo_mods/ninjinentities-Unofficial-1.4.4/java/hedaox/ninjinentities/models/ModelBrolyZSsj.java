...
extends ModelBase {
    ...
    public ModelBrolyZSsj(float _scaleX, float _scaleY, float _scaleZ) {
        ...
        this.setRotationAngle(hair5, 2.7925f, 0.0873f, -1.5709f);
        ...
        this.setRotationAngle(hair6, 2.7925f, -0.0873f, 1.7454f);
        ...
        this.setRotationAngle(hair9, 2.7925f, 0.0873f, 2.269f);
        ...
        this.setRotationAngle(hair10, 2.7925f, -0.0873f, -2.3562f);
