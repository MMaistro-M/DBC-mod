...
public class EntityDAIMAGokuSsj2
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityDAIMAGokuSsj2(World par1World) {
        super(par1World, 100, EntityDBCNinjin.MindState.AGGRESSIVE, true, true, new byte[]{3, 3, 1, 6, 5, 2}, new byte[]{2, 2, 2, 2, 2, 7}, 255.0f, 217.0f, 25.0f, true);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/DaimagokuSsj2.png";
    }
