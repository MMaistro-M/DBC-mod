...
public class EntityKaioshinChild
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityKaioshinChild(World par1World) {
        super(par1World, 0, EntityDBCNinjin.MindState.AGGRESSIVE, true, false, new byte[]{1}, new byte[]{4});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/KaioshinChild.png";
    }
}
