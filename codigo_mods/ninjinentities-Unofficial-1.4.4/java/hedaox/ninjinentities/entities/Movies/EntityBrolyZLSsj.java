...
public class EntityBrolyZLSsj
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityBrolyZLSsj(World par1World) {
        super(par1World, 15, EntityDBCNinjin.MindState.AGGRESSIVE, false, true, new byte[]{1, 3, 5, 6}, new byte[]{6, 6, 6, 6});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/dbsbrolyLSSJ.png";
    }
}
