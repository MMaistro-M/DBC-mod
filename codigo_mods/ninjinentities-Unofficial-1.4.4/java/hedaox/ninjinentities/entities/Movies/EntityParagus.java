...
public class EntityParagus
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityParagus(World par1World) {
        super(par1World, 10, EntityDBCNinjin.MindState.NEUTRAL, false, false, new byte[]{1, 3}, new byte[]{6, 6});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/paragus.png";
    }
}
