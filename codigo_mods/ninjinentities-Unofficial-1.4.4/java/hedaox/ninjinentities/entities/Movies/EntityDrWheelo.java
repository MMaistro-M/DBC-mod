...
public class EntityDrWheelo
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityDrWheelo(World par1World) {
        super(par1World, 0, EntityDBCNinjin.MindState.AGGRESSIVE, false, false, new byte[]{1, 3, 5}, new byte[]{7, 7, 4});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/drWheelo.png";
    }
}
