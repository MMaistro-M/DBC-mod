...
public class EntityParagusSoldier
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityParagusSoldier(World par1World) {
        super(par1World, 10, EntityDBCNinjin.MindState.AGGRESSIVE, false, false, new byte[]{6}, new byte[]{3});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/paragusSoldier.png";
    }
}
