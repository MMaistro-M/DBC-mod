...
public class EntityBujin
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityBujin(World par1World) {
        super(par1World, 10, EntityDBCNinjin.MindState.AGGRESSIVE, false, true, new byte[]{1, 3}, new byte[]{2, 2});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/bujin.png";
    }
}
