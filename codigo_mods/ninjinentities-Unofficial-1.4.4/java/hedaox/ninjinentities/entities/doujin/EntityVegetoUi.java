...
extends EntityDBCNinjin {
    ...
    public EntityVegetoUi(World par1World) {
        super(par1World, 100, EntityDBCNinjin.MindState.AGGRESSIVE, true, true, new byte[]{3, 3, 1, 6, 5, 2}, new byte[]{2, 2, 2, 2, 2, 7}, 255.0f, 255.0f, 255.0f, false, true, 225.0f, 225.0f, 225.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/vegetoUi.png";
    }
}
