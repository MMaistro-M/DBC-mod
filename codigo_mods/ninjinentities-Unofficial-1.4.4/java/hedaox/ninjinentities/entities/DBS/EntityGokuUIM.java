...
extends EntityDBCNinjin {
    ...
    public EntityGokuUIM(World par1World) {
        super(par1World, 100, EntityDBCNinjin.MindState.NEUTRAL, true, true, new byte[]{3, 3, 1, 6, 5, 2}, new byte[]{2, 2, 2, 2, 2, 7}, 255.0f, 255.0f, 255.0f, false, true, 225.0f, 225.0f, 225.0f);
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(17000.0);
    }
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/gokuUiM.png";
    }
}
