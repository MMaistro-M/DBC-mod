...
extends EntityDBCNinjin {
    public EntityVegetaCopyBlue(World par1World) {
        super(par1World, 5, EntityDBCNinjin.MindState.AGGRESSIVE, false, true, new byte[]{3, 6}, new byte[]{3, 3}, 50.0f, 255.0f, 255.0f, false, true, 50.0f, 200.0f, 255.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/vegetaCopyBlue.png";
    }
}
