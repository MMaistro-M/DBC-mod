...
public class EntityVegetaZw
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;
    private double initialAttackDamage;

    public EntityVegetaZw(World par1World) {
        super(par1World, 85, EntityDBCNinjin.MindState.NEUTRAL, true, true, new byte[]{1, 2, 3, 4, 5, 6}, new byte[]{3, 3, 3, 3, 3, 3}, 135.0f, 40.0f, 200.0f, false, true, 135.0f, 0.0f, 155.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/vegetazw.png";
    }
}
