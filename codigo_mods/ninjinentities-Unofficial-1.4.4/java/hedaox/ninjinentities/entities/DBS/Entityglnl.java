...
public class Entityglnl
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public Entityglnl(World par1World) {
        super(par1World, 85, EntityDBCNinjin.MindState.AGGRESSIVE, false, true, new byte[]{1, 2, 3, 4, 5, 6}, new byte[]{3, 3, 3, 3, 3, 3});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/glnl.png";
    }
}
