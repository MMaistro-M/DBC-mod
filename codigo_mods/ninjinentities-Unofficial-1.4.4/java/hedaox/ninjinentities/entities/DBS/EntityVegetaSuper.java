...
public class EntityVegetaSuper
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityVegetaSuper(World par1World) {
        super(par1World, 70, EntityDBCNinjin.MindState.NEUTRAL, true, true, new byte[]{3, 6, 3, 5}, new byte[]{3, 7, 7, 7});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/vegetaSuper.png";
    }
}
