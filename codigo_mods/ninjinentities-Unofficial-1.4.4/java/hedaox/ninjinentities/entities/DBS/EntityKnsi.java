...
public class EntityKnsi
extends EntityDBCNinjin {
    public EntityKnsi(World par1World) {
        super(par1World, 80, EntityDBCNinjin.MindState.NEUTRAL, false, true, new byte[]{1}, new byte[]{7});
        this.field_70728_aV = 80;
        this.func_70105_a(0.54f, 1.44f);
    }
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/knsi.png";
    }
