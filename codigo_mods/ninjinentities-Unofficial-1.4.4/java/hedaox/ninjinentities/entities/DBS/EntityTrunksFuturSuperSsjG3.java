...
public class EntityTrunksFuturSuperSsjG3
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityTrunksFuturSuperSsjG3(World par1World) {
        super(par1World, 100, EntityDBCNinjin.MindState.AGGRESSIVE, true, false, new byte[]{3, 5, 6}, new byte[]{7, 7, 7}, 255.0f, 217.0f, 25.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/trunksFuturSuperSsjG3.png";
    }
