...
public class EntityGogetaSsj
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityGogetaSsj(World par1World) {
        super(par1World, 85, EntityDBCNinjin.MindState.AGGRESSIVE, true, true, new byte[]{1, 3, 4, 5, 6}, new byte[]{2, 2, 2, 2, 2}, 255.0f, 217.0f, 25.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/gogetaSsj.png";
    }
