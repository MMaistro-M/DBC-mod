...
public class EntityVegetaSsjb
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityVegetaSsjb(World par1World) {
        super(par1World, 70, EntityDBCNinjin.MindState.NEUTRAL, true, true, new byte[]{3, 6, 3, 5}, new byte[]{3, 7, 7, 7}, 50.0f, 255.0f, 255.0f, false, true, 50.0f, 255.0f, 200.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/vegetaSsjb.png";
    }
}
