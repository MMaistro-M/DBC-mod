...
public class EntityRecoomeDamaged
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityRecoomeDamaged(World par1World) {
        super(par1World, 0, EntityDBCNinjin.MindState.AGGRESSIVE, false, false, new byte[]{3, 5, 6}, new byte[]{3, 3, 3});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/recoomeDamaged.png";
    }
}
