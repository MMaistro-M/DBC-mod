...
public class EntityVegeta1
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityVegeta1(World par1World) {
        super(par1World, 70, EntityDBCNinjin.MindState.NEUTRAL, true, false, new byte[]{3, 6, 3, 5}, new byte[]{3, 7, 7, 7});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/vegeta1.png";
    }
}
