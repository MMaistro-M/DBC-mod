...
extends EntityDBCWildlife {
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/hercule.png";
    }
    ...
    protected void func_70628_a(boolean par1, int par2) {
        ...
        for (var4 = 0; var4 < var3; ++var4) {
            this.func_145779_a(ItemsDBC.ItemsOutfit1[20], 1);
        }
        var3 = this.field_70146_Z.nextInt(2 + par2);
        for (var4 = 0; var4 < var3; ++var4) {
            this.func_145779_a(ItemsDBC.ItemsOutfit2[20], 1);
        }
        var3 = this.field_70146_Z.nextInt(2 + par2);
        for (var4 = 0; var4 < var3; ++var4) {
            this.func_145779_a(ItemsDBC.ItemsOutfit3[20], 1);
        }
    }
}
