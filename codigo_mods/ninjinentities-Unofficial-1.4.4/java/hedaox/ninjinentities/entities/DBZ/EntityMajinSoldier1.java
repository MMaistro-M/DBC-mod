...
public class EntityMajinSoldier1
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityMajinSoldier1(World par1World) {
        super(par1World, 0, EntityDBCNinjin.MindState.NEUTRAL, false, false, new byte[]{1}, new byte[]{4});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/majinSoldier1.png";
    }
}
