...
public class EntityGohanUltimate
extends EntityDBCNinjin {
        ...
        if (this.field_70170_p.field_72995_K && JGConfigClientSettings.CLIENT_DA8) {
            for (int k = 0; k < JGConfigClientSettings.get_da1(); ++k) {
                for (int i = 0; i < 4; ++i) {
                    ...
                    EntityAura EntityAura2 = new EntityAura(this.field_70170_p, (Entity)entityGokuSsjR3, 0xDCDCDC, 1.0f, 0.0f, 0, false);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/gohanUltimate.png";
    }
