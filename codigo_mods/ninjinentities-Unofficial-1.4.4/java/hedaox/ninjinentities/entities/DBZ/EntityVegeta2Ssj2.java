...
public class EntityVegeta2Ssj2
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityVegeta2Ssj2(World par1World) {
        super(par1World, 70, EntityDBCNinjin.MindState.NEUTRAL, true, false, new byte[]{3, 6, 3, 5}, new byte[]{3, 7, 7, 7}, 255.0f, 217.0f, 25.0f, true);
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(24000.0);
