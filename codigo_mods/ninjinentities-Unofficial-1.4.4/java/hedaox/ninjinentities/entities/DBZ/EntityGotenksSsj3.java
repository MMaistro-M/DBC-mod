...
public class EntityGotenksSsj3
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityGotenksSsj3(World par1World) {
        super(par1World, 85, EntityDBCNinjin.MindState.NEUTRAL, true, true, new byte[]{3, 3, 1, 6}, new byte[]{2, 7, 7, 7}, 255.0f, 217.0f, 25.0f, true);
        this.field_70728_aV = 80;
        this.func_70105_a(0.45f, 1.35f);
    }
    ...
    protected void func_110147_ax() {
        ...
        this.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111128_a(31000.0);
        this.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111128_a(3100.0);
    }

    @Override
    @SideOnly(value=Side.CLIENT)
    public String getTexture() {
        return "ninjinentities:textures/entity/gotrunksSsj3.png";
    }
