...
public class EntityGoku1
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityGoku1(World par1World) {
        super(par1World, 100, EntityDBCNinjin.MindState.NEUTRAL, true, false, new byte[]{3, 3, 1, 6}, new byte[]{2, 2, 2, 2});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/goku1.png";
    }
