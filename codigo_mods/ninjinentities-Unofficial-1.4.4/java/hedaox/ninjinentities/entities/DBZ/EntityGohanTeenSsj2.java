...
public class EntityGohanTeenSsj2
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityGohanTeenSsj2(World par1World) {
        super(par1World, 100, EntityDBCNinjin.MindState.AGGRESSIVE, true, true, new byte[]{3, 3, 6, 1}, new byte[]{2, 7, 2, 2}, 255.0f, 217.0f, 25.0f, true);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/gohanTeenSsj2.png";
    }
}
