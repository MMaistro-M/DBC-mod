...
public class EntityPiccoloInjury
extends EntityDBCNinjin {
    public EntityPiccoloInjury(World par1World) {
        super(par1World, 50, EntityDBCNinjin.MindState.NEUTRAL, false, true, new byte[]{1, 3, 6}, new byte[]{7, 7, 7});
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/PiccoloInjury.png";
    }
}
