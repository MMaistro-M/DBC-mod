...
public class EntityKanbaSsjoozaru
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityKanbaSsjoozaru(World par1World) {
        super(par1World, 0, EntityDBCNinjin.MindState.AGGRESSIVE, false, false, new byte[]{3, 3, 1, 6, 5, 2}, new byte[]{2, 2, 2, 2, 2, 7}, 255.0f, 217.0f, 25.0f, false);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/kanbaSsjoozaru.png";
    }
}
