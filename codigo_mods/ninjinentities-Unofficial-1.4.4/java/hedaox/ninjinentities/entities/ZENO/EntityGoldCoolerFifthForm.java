...
public class EntityGoldCoolerFifthForm
extends EntityDBCNinjin {
    public int randomSoundDelay = 0;

    public EntityGoldCoolerFifthForm(World par1World) {
        super(par1World, 0, EntityDBCNinjin.MindState.AGGRESSIVE, false, true, new byte[]{1, 6, 2, 3, 4, 3}, new byte[]{3, 2, 7, 3, 7, 2}, 255.0f, 217.0f, 25.0f);
    ...
    public String getTexture() {
        return "ninjinentities:textures/entity/hjcoolerFifthForm.png";
    }
}
