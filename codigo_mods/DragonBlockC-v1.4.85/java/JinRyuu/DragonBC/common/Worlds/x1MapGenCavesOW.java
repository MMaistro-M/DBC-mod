...
extends MapGenBase {
    ...
    protected void func_151542_a(long p_151542_1_, int p_151542_3_, int p_151542_4_, Block[] p_151542_5_, double p_151542_6_, double p_151542_8_, double p_151542_10_) {
        this.func_151541_a(p_151542_1_, p_151542_3_, p_151542_4_, p_151542_5_, p_151542_6_, p_151542_8_, p_151542_10_, 1.0f + this.field_75038_b.nextFloat() * 6.0f, 0.0f, 0.0f, -1, -1, 0.5);
    }
    ...
    protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_) {
        ...
        while (p_151541_15_ < p_151541_16_) {
            double d6 = 1.5 + (double)(MathHelper.func_76126_a((float)((float)p_151541_15_ * (float)Math.PI / (float)p_151541_16_)) * p_151541_12_ * 1.0f);
            double d7 = d6 * p_151541_17_;
            float f5 = MathHelper.func_76134_b((float)p_151541_14_);
            float f6 = MathHelper.func_76126_a((float)p_151541_14_);
            p_151541_6_ += (double)(MathHelper.func_76134_b((float)p_151541_13_) * f5);
            p_151541_8_ += (double)f6;
            p_151541_10_ += (double)(MathHelper.func_76126_a((float)p_151541_13_) * f5);
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_151541_6_ >= d4 - 16.0 - d6 * 2.0 && p_151541_10_ >= d5 - 16.0 - d6 * 2.0 && p_151541_6_ <= d4 + 16.0 + d6 * 2.0 && p_151541_10_ <= d5 + 16.0 + d6 * 2.0) {
                    int j3;
                    int k2;
                    int i4 = MathHelper.func_76128_c((double)(p_151541_6_ - d6)) - p_151541_3_ * 16 - 1;
                    int l1 = MathHelper.func_76128_c((double)(p_151541_6_ + d6)) - p_151541_3_ * 16 + 1;
                    int j4 = MathHelper.func_76128_c((double)(p_151541_8_ - d7)) - 1;
                    int i2 = MathHelper.func_76128_c((double)(p_151541_8_ + d7)) + 1;
                    int k4 = MathHelper.func_76128_c((double)(p_151541_10_ - d6)) - p_151541_4_ * 16 - 1;
                    int j2 = MathHelper.func_76128_c((double)(p_151541_10_ + d6)) - p_151541_4_ * 16 + 1;
                    if (i4 < 0) {
                        i4 = 0;
                    }
                    if (l1 > 16) {
    ...
    protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
        ...
        for (int j1 = 0; j1 < i1; ++j1) {
            ...
            for (int l1 = 0; l1 < k1; ++l1) {
                ...
                this.func_151541_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d1, d2, f2, f, f1, 0, 0, 1.0);
            }
        }
    }
