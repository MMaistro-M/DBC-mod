...
extends ModelBase {
    ...
    public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        float n4 = par4;
        float n5 = par5;
        this.Hair.field_78796_g = n4 / (r2 / (float)Math.PI);
        this.Hair.field_78795_f = n5 / (r2 / (float)Math.PI);
        ...
        this.ArmR.field_78795_f = -0.0f + MathHelper.func_76134_b((float)(par1 * 0.6662f)) * 0.3f * par2;
