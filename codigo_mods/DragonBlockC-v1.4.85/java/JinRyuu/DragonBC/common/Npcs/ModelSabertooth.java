...
extends ModelBase {
    ...
    public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.RFrontLeg1.field_78795_f = 0.1f - MathHelper.func_76134_b((float)(par1 * 0.6662f)) * 1.2f * par2;
        this.LFrontLeg1.field_78795_f = 0.1f - MathHelper.func_76134_b((float)(par1 * 0.6662f + (float)Math.PI)) * 1.2f * par2;
        this.LBackLeg1.field_78795_f = -0.6f - MathHelper.func_76134_b((float)(par1 * 0.6662f)) * 1.2f * par2;
        this.RBackLeg1.field_78795_f = -0.6f - MathHelper.func_76134_b((float)(par1 * 0.6662f + (float)Math.PI)) * 1.2f * par2;
        float ex = par7Entity.field_70173_aa;
        float r3 = MathHelper.func_76134_b((float)(ex * 0.14f)) * 0.1f;
        float r4 = MathHelper.func_76134_b((float)(ex / 8.0f)) / 3.0f - 0.2f;
