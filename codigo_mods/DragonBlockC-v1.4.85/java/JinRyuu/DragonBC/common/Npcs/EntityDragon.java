    ...
    public boolean func_70085_c(EntityPlayer par1EntityPlayer) {
        ...
        if (this.func_70089_S()) {
            if (!this.field_70170_p.field_72995_K) {
                ...
                this.granted = true;
                par1EntityPlayer.openGui((Object)mod_DragonBC.instance, 2, par1EntityPlayer.field_70170_p, (int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v);
            }
            if (!par1EntityPlayer.field_70170_p.field_72995_K) {
                ...
                par1EntityPlayer.field_70170_p.func_72838_d((Entity)Dragon2);
            }
            this.func_70106_y();
            return true;
        }
