 ...
 */
package com.tobiasmjc.dbcadditions.entities.render;
...
extends RenderDBC {
    ...
    public AuraEntityRender() {
        super((ModelBase)new ModelAura(), 0.5f);
        this.aModel = new ModelAura();
        this.bModel = new ModelAuraG();
    }

    public AuraEntityRender(String mdid) {
        this();
        this.mdid = mdid;
    }

    public void renderAura(AuraEntity par1Entity, double parX, double parY, double parZ, float par8, float par9) {
    ...
    private void func_tad(AuraEntity par1Entity, double parX, double parY, double parZ, float par8, float par9) {
        boolean plyrSP;
        if (!DBCClient.mc.func_147113_T()) {
            boolean bool;
            int i = par1Entity.getColL3();
            boolean bl = bool = i > 0;
            if (bool) {
        ...
        boolean bl = plyrSP = DBCClient.mc.field_71439_g.func_70005_c_().equals(par1Entity.getmot()) && DBCClient.mc.field_71474_y.field_74320_O == 0;
        ...
        AuraEntityRender.glColor4f(c, p);
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                if (var13 < 15.0f) {
                    ...
                    if (hasl2) {
                        ...
                        AuraEntityRender.glColor4f(cl2, p);
                        if (spawn) {
                            this.aModel.renderModel(par1Entity, 0.0625f, var13, (float)i2 * w, spd);
                        }
                    }
                ...
                AuraEntityRender.glColor4f(cl3, p);
                if (spawn) {
                    this.aModel.renderModel(par1Entity, 0.0625f, var13 + 4.0f, (float)i2 * w, spd);
                }
                GL11.glPopMatrix();
    ...
    private void lightning(AuraEntity e, double par2, double par4, double par6, float par9, float var20, float var13, boolean rot) {
        if (var13 < (float)e.getLightLivingTime() && (e.getState() > 4.0f && e.getState() < 7.0f || e.hasLightning) && !rot) {
            GL11.glPushMatrix();
            ...
            for (int i = 0; i < this.lightVertN; ++i) {
                ...
                for (int j = 0; j < nu2; ++j) {
                    ...
                    for (int i1 = k; i1 >= l; --i1) {
                        ...
                        float f2 = 0.5f;
                        if (!e.getBol7()) {
                            tessellator2.func_78369_a(e.lightningColorR * f2, e.lightningColorG * f2, e.lightningColorB * f2, e.lightningColorA);
                        } else {
                        ...
                        for (int j1 = 0; j1 < 5; ++j1) {
                            ...
                            if (i1 >= 8) continue;
                            tessellator2.func_78377_a(d13 + d5 * (double)sc, (double)((float)(-(i1 * 1 - 7)) * sc), d14 + d6 * (double)sc);
                            tessellator2.func_78377_a(d11 + d7 * (double)sc, (double)((float)(-((i1 + 1) * 1 - 7)) * sc), d12 + d8 * (double)sc);
                        }
    ...
    public void func_76986_a(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderAura((AuraEntity)par1Entity, par2, par4, par6, par8, par9);
    }
}
