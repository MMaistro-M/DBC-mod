...
extends CommandBase {
    ...
    public void func_71515_b(ICommandSender par1ICommandSender, String[] stringArray) {
        ...
        EntityPlayerMP entityplayermp = stringArray.length > 3 ? ComJrmcStatusEffect.func_82359_c((ICommandSender)par1ICommandSender, (String)stringArray[3]) : ComJrmcStatusEffect.func_71521_c((ICommandSender)par1ICommandSender);
        String entitycommansender = "Console";
        try {
            EntityPlayerMP commansender = ComJrmcStatusEffect.func_71521_c((ICommandSender)par1ICommandSender);
        ...
        if (set) {
            ...
            if (id == 5) {
                ...
                if (n) {
                    this.notifyAdmins(par1ICommandSender, "%s's Status Effect %s has been " + (value == 0.0f ? "removed" : "added") + ".", new Object[]{entityplayermp.func_70005_c_(), this.STATUS[id], Float.valueOf(value)});
                }
            } else if (id == 4) {
                ...
                entityplayermp.func_145747_a(new ChatComponentTranslation(t, new Object[0]).func_150255_a(JRMCoreH2.styl_ylw));
                if (n) {
                    this.notifyAdmins(par1ICommandSender, "%s's Status Effect %s has been set to %s mins.", new Object[]{entityplayermp.func_70005_c_(), this.STATUS[id], Float.valueOf(value)});
                }
            }
        }
    }
    ...
    public List func_71516_a(ICommandSender commandSender, String[] stringArray) {
        ...
        switch (length) {
            case 1: {
                return ComJrmcStatusEffect.func_71530_a((String[])stringArray, (String[])this.MODES);
            }
            case 2: {
                return ComJrmcStatusEffect.func_71530_a((String[])stringArray, (String[])this.STATUS);
            }
            case 3: {
                return ComJrmcStatusEffect.func_71530_a((String[])stringArray, (String[])this.TIME);
            }
            case 4: {
                return ComJrmcStatusEffect.func_71530_a((String[])stringArray, (String[])this.getListOfPlayers());
            }
        }
        return null;
    }
