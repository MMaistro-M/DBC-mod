...
public class JRMCoreGuiSlider00 extends GuiButton {
   ...
   protected void func_146119_b(Minecraft par1Minecraft, int par2, int par3) {
      if (this.field_146125_m) {
         if (this.dragging) {
            this.sliderValue = (float)(par3 - (this.field_146129_i + 4)) / (this.field_146121_g - 8);
         ...
         par1Minecraft.func_110434_K().func_110577_a(txx);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         this.func_73729_b(this.field_146128_h, this.field_146129_i + (int)(this.sliderValue * (this.field_146121_g - 4)), 216, 0, 20, 2);
         this.func_73729_b(this.field_146128_h, this.field_146129_i + (int)(this.sliderValue * (this.field_146121_g - 4)) + 2, 216, 126, 20, 2);
      }
   }
