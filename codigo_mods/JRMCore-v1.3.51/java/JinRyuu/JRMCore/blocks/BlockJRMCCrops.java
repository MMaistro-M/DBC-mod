...
implements IGrowable {
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (p_149674_1_.func_72957_l(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9 && (l = p_149674_1_.func_72805_g(p_149674_2_, p_149674_3_, p_149674_4_)) < 7 && p_149674_5_.nextInt((int)(25.0f / (f = this.func_149864_n(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))) + 1) == 0) {
    ...
    public void incrementGrowStage(World parWorld, Random parRand, int parX, int parY, int parZ) {
        int growStage = parWorld.func_72805_g(parX, parY, parZ) + MathHelper.func_76136_a((Random)parRand, (int)2, (int)5);
