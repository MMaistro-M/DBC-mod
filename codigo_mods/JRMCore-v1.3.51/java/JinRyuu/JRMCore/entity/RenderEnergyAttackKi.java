...
extends RenderEnergyAttack<EntityEnergyAtt> {
    ...
    public void renderEnergy(EntityEnergyAtt entity, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (shrink > 0) {
            ...
            entity.finalDist = entity.dist = (double)MathHelper.func_76133_a((double)(x * x + y * y + z * z));
        }
    ...
    public void render_3d(EntityEnergyAtt entity, double par2, double par4, double par6, float par8, float par9, float scale, double sx, double sy, double sz, int color, int color2, float rotation) {
        ...
        if (type == 1 || type == 5 || type == 6) {
            ...
            GL11.glRotatef((float)(entity.field_70126_B + (entity.field_70177_z - entity.field_70126_B) * par9 - 180.0f), (float)0.0f, (float)1.0f, (float)0.0f);
            GL11.glRotatef((float)(entity.field_70127_C + (entity.field_70125_A - entity.field_70127_C) * par9), (float)1.0f, (float)0.0f, (float)0.0f);
