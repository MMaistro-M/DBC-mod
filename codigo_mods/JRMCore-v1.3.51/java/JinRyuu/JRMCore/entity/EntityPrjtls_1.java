...
IProjectile {
    ...
    public double field_70255_ao = 0.0;
    ...
    public EntityPrjtls_1(World world, Entity shootingEntity, Entity target, float par4, float par5, int id) {
        ...
        this.field_70163_u = shootingEntity.field_70163_u + (double)shootingEntity.func_70047_e() - (double)0.1f - 1.0;
        double var6 = target.field_70165_t - shootingEntity.field_70165_t;
        double var8 = target.field_70163_u + (double)target.func_70047_e() - (double)0.7f - this.field_70163_u;
        double var10 = target.field_70161_v - shootingEntity.field_70161_v;
        double var12 = (double)MathHelper.func_76133_a((double)(var6 * var6 + var10 * var10)) * (shootingEntity instanceof EntityRRMecha ? 1.0 : 2.0);
        if (var12 >= 1.0E-7) {
        ...
        this.field_70255_ao = this.damages[id] / 2;
    }
    ...
    public void func_70071_h_() {
        ...
        if (isRocket && !this.field_70170_p.field_72995_K && (this.field_70173_aa == 1 || this.field_70173_aa % 5 == 0)) {
            this.field_70170_p.func_72956_a((Entity)this, "jinryuudragonbc:DBC4.rocket_travel", 0.3f, this.field_70170_p.field_73012_v.nextFloat() * 0.1f + 0.9f);
        }
        if (this.field_70170_p.field_72995_K) {
            float sizeMulti = isRocket ? 1.0f : 0.5f;
            for (int i = 0; i < (isRocket ? 5 : 2); ++i) {
                mod_JRMCore.proxy.func_gcp((Entity)this, EntityCusPars.PART5, Math.random() * 0.5 - 0.25, 0.0 - (double)(this.field_70131_O / 2.0f), Math.random() * 0.5 - 0.25, Math.random() * 0.05 - 0.025, Math.random() * 0.1 + 0.05, Math.random() * 0.05 - 0.025, 0.05f * sizeMulti, 0.05f * sizeMulti, 0.05f * sizeMulti);
            }
        }
        this.func_70030_z();
        if (this.field_70127_C == 0.0f && this.field_70126_B == 0.0f) {
        ...
        if (this.inGround) {
            if (isRocket) {
                JRMCoreH.newExpl(this.field_70170_p, (Entity)this, this.field_70165_t, this.field_70163_u, this.field_70161_v, this.explevel, false, this.field_70255_ao, this.field_70250_c, (byte)5);
            }
            this.func_70106_y();
            ...
            if (!this.field_70170_p.field_72995_K) {
                ...
                for (var9 = 0; var9 < var6.size(); ++var9) {
                    ...
                    if (!var10.func_70067_L() || var10 == this.field_70250_c && this.ticksInAir < 5 || (var13 = (var12 = var10.field_70121_D.func_72314_b((double)(var11 = 0.3f), (double)var11, (double)var11)).func_72327_a(var17, var3)) == null || !this.isNotRedRibbon(var10) || !((var14 = var17.func_72438_d(var13.field_72307_f)) < var7) && var7 != 0.0) continue;
                    var5 = var10;
                    var7 = var14;
                }
                if (var5 != null) {
            ...
            if (var4 != null) {
                if (var4.field_72308_g != null && this.isNotRedRibbon(var4.field_72308_g)) {
                    ...
                    int var23 = MathHelper.func_76143_f((double)((double)var20 * this.field_70255_ao));
                    if (this.func_70241_g()) {
                        var23 += this.field_70146_Z.nextInt(var23 / 2 + 2);
                    }
                    DamageSource damagesource = null;
                    damagesource = this.field_70250_c == null ? mod_DragonBC.causePrjctlsDamage(this, (Entity)this) : mod_DragonBC.causePrjctlsDamage(this, this.field_70250_c);
                    if (this.func_70027_ad()) {
                        var4.field_72308_g.func_70015_d(5);
                    }
                    if (var4.field_72308_g.func_70097_a(damagesource, (float)var23)) {
                        float var25;
                        if (var4.field_72308_g instanceof EntityLivingBase && this.knockbackStrength > 0 && (var25 = MathHelper.func_76133_a((double)(this.field_70159_w * this.field_70159_w + this.field_70179_y * this.field_70179_y))) > 0.0f) {
