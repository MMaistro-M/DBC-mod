...
IProjectile {
    ...
    public void func_70071_h_() {
        ...
        if ((block = this.field_70170_p.func_147439_a((int)this.field_70165_t, (int)this.field_70163_u, (int)this.field_70161_v)).func_149688_o() != Material.field_151579_a) {
    ...
    private void func_chins() {
        ...
        if (!this.field_70170_p.field_72995_K) {
            Entity var5 = null;
            entityList = this.field_70170_p.func_72839_b((Entity)this, this.field_70121_D.func_72321_a(this.field_70159_w, this.field_70181_x, this.field_70179_y).func_72314_b(0.5, 0.5, 0.5));
            double var7 = 0.0;
            for (int n = 0; n < entityList.size(); ++n) {
                ...
                if (!entity.func_70067_L() || entity == this.shootingEntity || (var13 = (var12 = entity.field_70121_D.func_72314_b((double)(var11 = 0.0f), (double)var11, (double)var11)).func_72327_a(var17, var3)) == null || !((var14 = var17.func_72438_d(var13.field_72307_f)) < var7) && var7 != 0.0) continue;
                var5 = entity;
                var7 = var14;
            }
            if (var5 != null) {
