...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        EntityPlayer entitylivingbase = this.thePet.field_70170_p.func_72924_a(this.thePet.getDad());
        EntityPlayer mom = this.thePet.field_70170_p.func_72924_a(this.thePet.getMom());
    ...
    public boolean func_75253_b() {
        return !this.petPathfinder.func_75500_f() && this.thePet.func_70068_e((Entity)this.theOwner) > (double)(this.maxDist * this.maxDist) && !this.thePet.stopMoving();
    }
            ...
            if (!this.petPathfinder.func_75497_a((Entity)this.theOwner, this.field_75336_f) && !this.thePet.func_110167_bD() && this.thePet.func_70068_e((Entity)this.theOwner) >= 144.0) {
                ...
                for (int l = 0; l <= 4; ++l) {
                    for (int i1 = 0; i1 <= 4; ++i1) {
                        ...
                        if (!World.func_147466_a((IBlockAccess)this.theWorld, (int)(i + l), (int)(k - 1), (int)(j + i1)) || this.theWorld.func_147445_c(i + l, k, j + i1, false) || this.theWorld.func_147445_c(i + l, k + 1, j + i1, false)) continue;
                        this.thePet.func_70012_b((float)(i + l) + 0.5f, k, (float)(j + i1) + 0.5f, this.thePet.field_70177_z, this.thePet.field_70125_A);
                        this.petPathfinder.func_75499_g();
                        return;
                    }
                }
