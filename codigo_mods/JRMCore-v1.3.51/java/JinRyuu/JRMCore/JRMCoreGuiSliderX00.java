...
public class JRMCoreGuiSliderX00 extends GuiButton {
   ...
   public void func_146112_a(Minecraft par1Minecraft, int par2, int par3) {
      if (this.field_146125_m) {
         ...
         if (this.mc0 && super.func_146116_c(par1Minecraft, par2, par3)) {
            sliderValue = (float)(par3 - (this.field_146129_i + 4)) / (this.field_146121_g - 8);
            if (sliderValue < 0.0F) {
               sliderValue = 0.0F;
            }
   ...
   protected void func_146119_b(Minecraft par1Minecraft, int par2, int par3) {
      if (this.field_146125_m) {
         ...
         par1Minecraft.func_110434_K().func_110577_a(txx);
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         this.func_73729_b(this.field_146128_h, this.field_146129_i + (int)(sliderValue * (this.field_146121_g - 4)), 241, 155, 15, 2);
         this.func_73729_b(this.field_146128_h, this.field_146129_i + (int)(sliderValue * (this.field_146121_g - 4)) + 2, 241, 157, 15, 2);
      }
   }
