...
public class ExtendedEntity implements IExtendedEntityProperties {
   ...
   public void onUpdate() {
      if (!this.e.field_70170_p.field_72995_K && this.getLvl() == 0 && this.e instanceof EntityMob) {
         ...
         int newHealth = (int)(mob.func_110148_a(SharedMonsterAttributes.field_111267_a).func_111125_b() * lvl * 1.0);
         AttributeModifier modifier = new AttributeModifier(mob.func_110124_au(), "maxHealthModifier", newHealth, 0);
         if (modifier != null) {
            mob.func_110140_aT().func_111151_a(SharedMonsterAttributes.field_111267_a).func_111121_a(modifier);
         }

         int newDamage = (int)(mob.func_110148_a(SharedMonsterAttributes.field_111264_e).func_111125_b() * lvl * 5.0);
         modifier = new AttributeModifier(mob.func_110124_au(), "attackDamageModifier", newDamage, 0);
         if (modifier != null) {
