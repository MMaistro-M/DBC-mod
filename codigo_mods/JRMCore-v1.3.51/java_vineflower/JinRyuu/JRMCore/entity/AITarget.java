   ...
   protected boolean isSuitableTarget(EntityLivingBase par1EntityLivingBase, boolean par2) {
      ...
      if (this.taskOwner instanceof IEntityOwnable && StringUtils.isNotEmpty(((IEntityOwnable)this.taskOwner).func_152113_b())) {
         if (par1EntityLivingBase instanceof IEntityOwnable
            && ((IEntityOwnable)this.taskOwner).func_152113_b().equals(((IEntityOwnable)par1EntityLivingBase).func_152113_b())) {
            return false;
         }
      ...
      if (!this.taskOwner
         .func_110176_b(
            MathHelper.func_76128_c(par1EntityLivingBase.field_70165_t),
            MathHelper.func_76128_c(par1EntityLivingBase.field_70163_u),
            MathHelper.func_76128_c(par1EntityLivingBase.field_70161_v)
         )) {
         return false;
      }

      if (this.shouldCheckSight && !this.taskOwner.func_70635_at().func_75522_a(par1EntityLivingBase)) {
         return false;
      }
