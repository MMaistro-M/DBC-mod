...
public class EntityNPC extends EntityCreature {
   ...
   protected void func_70626_be() {
      if (this.angerLevel > 0) {
         ...
         if (this.targetedEntity == null || this.aggroCooldown-- <= 0) {
            this.targetedEntity = this.field_70170_p.func_72856_b(this, 100.0);
            super.func_70626_be();
         ...
         if (this.targetedEntity != null && this.targetedEntity.func_70068_e(this) < d4 * d4) {
            ...
            double d6 = this.targetedEntity.field_70121_D.field_72338_b
               + this.targetedEntity.field_70131_O / 2.0F
            ...
            if (this.func_70685_l(this.targetedEntity)) {
               ...
               if (this.attackCounter == 80) {
                  ...
                  if (t == 6) {
                     ...
                     int dmg1 = this.dam;
                     int cst = this.dam / 2;
                     Entity entityball = new EntityEnergyAttJ(
                        this, type, speed, this.dam, effect, color, density, sincantation, sfire, smove, (byte)-1, dmg1, cst, 5
                     );
                     double d8 = 0.5;
                     Vec3 vec3 = this.func_70676_i(1.0F);
                     entityball.field_70165_t = this.field_70165_t + vec3.field_72450_a * d8;
                     entityball.field_70163_u = this.field_70163_u + this.field_70131_O / 2.0F + 0.5;
   ...
   public boolean func_70652_k(Entity par1Entity) {
      ...
      if (par1Entity instanceof EntityLiving) {
         i = (int)(i + EnchantmentHelper.func_77512_a(this, (EntityLiving)par1Entity));
      ...
      if (flag) {
         if (j > 0) {
            par1Entity.func_70024_g(
               -MathHelper.func_76126_a(this.field_70177_z * (float) Math.PI / 180.0F) * j * 0.5F,
               0.1,
               MathHelper.func_76134_b(this.field_70177_z * (float) Math.PI / 180.0F) * j * 0.5F
            );
