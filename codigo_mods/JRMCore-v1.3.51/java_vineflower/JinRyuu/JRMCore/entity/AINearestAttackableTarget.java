...
public class AINearestAttackableTarget extends AITarget {
   ...
   public AINearestAttackableTarget(
      EntityCreature par1EntityCreature, Class par2Class, int par3, boolean par4, boolean par5, IEntitySelector par6IEntitySelector
   ) {
   ...
   public boolean func_75250_a() {
      ...
      List list = this.taskOwner
         .field_70170_p
         .func_82733_a(this.targetClass, this.taskOwner.field_70121_D.func_72314_b(d0, 4.0, d0), this.targetEntitySelector);
