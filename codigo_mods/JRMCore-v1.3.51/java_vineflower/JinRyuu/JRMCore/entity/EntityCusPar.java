...
public class EntityCusPar extends Entity {
   ...
   public EntityCusPar(
      ...
      int data32,
      boolean rotate,
      float max_rotation_sp,
      boolean rotate2,
      float max_rotation_sp2,
      int data1,
      String rr,
      int data2,
      int data4,
      ...
      if (rotate) {
         ...
         this.rotation_sp = (float)(Math.random() * max_rotation_sp) + 0.001F;
      }

      if (rotate) {
         this.rotation2 = (int)(Math.random() * 2.0) == 0;
         this.max_rotation_sp2 = max_rotation_sp2;
         this.rotation_sp2 = (float)(Math.random() * max_rotation_sp2) + 0.001F;
      }
   ...
   public void func_70071_h_() {
      if (this.field_70170_p.field_72995_K) {
         if (!JRMCoreClient.mc.func_147113_T() && !this.ended) {
            ...
            if (this.data29 != 0.0F) {
               this.data30 = this.data30 + this.data29;
               this.field_70159_w = this.field_70159_w * this.data30;
               this.field_70181_x = this.field_70181_x * this.data30;
               this.field_70179_y = this.field_70179_y * this.data30;
            }

            this.field_70165_t = this.field_70165_t + this.field_70159_w * JGConfigClientSettings.get_da2();
            this.field_70163_u = this.field_70163_u + this.field_70181_x * JGConfigClientSettings.get_da2();
            this.field_70161_v = this.field_70161_v + this.field_70179_y * JGConfigClientSettings.get_da2();
            this.data36 = this.data36 + this.field_70159_w * JGConfigClientSettings.get_da2();
            this.data37 = this.data37 + this.field_70181_x * JGConfigClientSettings.get_da2();
            this.data38 = this.data38 + this.field_70179_y * JGConfigClientSettings.get_da2();
         }

         if (this.hasEnt()) {
            this.func_70107_b(
               this.ent.field_70165_t + this.data17 + this.data36,
               this.ent.field_70163_u + this.data18 + this.data37 + (this.ent instanceof EntityPlayerSP ? -1.6F : 0.0F),
               this.ent.field_70161_v + this.data19 + this.data38
            );
         } else {
   ...
   public void part_atlatszosag() {
      if (!this.data27) {
         if (this.data20 == 1) {
            if (this.data25 > 0.0F) {
               this.data21 = this.data21 + this.data25;
               this.data28 = this.data28 + this.data25;
            ...
            float calc = this.field_70173_aa / egy / 100.0F;
            if (this.data25 > 0.0F) {
               this.data21 = calc;
               this.data28 = calc;
               if (this.data21 > 1.0F) {
   ...
   public boolean func_70112_a(double par1) {
      ...
      return par1 < d1 * d1 * (JGConfigClientSettings.renderdistanceMultiplierParticles / 100.0);
   }
}
