...
public class EntityPunch extends EntityKiAttacksLight implements IEntityAdditionalSpawnData, IEntitySelector {
   ...
   public EntityPunch(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
      ...
      this.field_70163_u = par2EntityLivingBase.field_70163_u + par2EntityLivingBase.func_70047_e() - 0.1F;
      double var6 = par3EntityLivingBase.field_70165_t - par2EntityLivingBase.field_70165_t;
      double var8 = par3EntityLivingBase.field_70163_u + par3EntityLivingBase.func_70047_e() - 0.7F - this.field_70163_u;
   ...
   public EntityPunch(World par1World, EntityLivingBase par2EntityLivingBase, float par3, float prc, double dam) {
      ...
      double y = par2EntityLivingBase.field_70163_u + vec3.field_72448_b * d8 + par2EntityLivingBase.field_70131_O * 0.55F;
      ...
      if (this.inGround) {
         ...
         if (var4 != null) {
            ...
            if (var4.field_72308_g != null
               && var4.field_72308_g instanceof EntityLivingBase
               && var4.field_72308_g != this.shootingEntity
               && var4.field_72308_g.func_70089_S()) {
               ...
               if (JRMCoreH.NC()
                  ...
                  && JRMCoreH.clsTypOn((EntityPlayer)var4.field_72308_g) == 1
                  && JRMCoreH.getByte((EntityPlayer)var4.field_72308_g, "jrmcPwrtyp") == 2) {
                  JRMCoreH.jrmcEnergyDam(var4.field_72308_g, (int)(this.damage * this.prc), null);
               }
   ...
   public boolean attackEntityFrom(DamageSource par1DamageSource, float par2, EntityLivingBase e) {
      ...
      if (flag) {
         ...
         if (entity != null) {
            ...
            double d1;
            for (d1 = entity.field_70161_v - e.field_70161_v; d0 * d0 + d1 * d1 < 1.0E-4; d1 = (Math.random() - Math.random()) * 0.01) {
