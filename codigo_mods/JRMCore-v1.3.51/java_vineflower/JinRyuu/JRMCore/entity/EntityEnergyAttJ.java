...
public class EntityEnergyAttJ extends EntityEnAttacks implements IThrowableEntity, IEntityAdditionalSpawnData, IEntitySelector, IProjectile {
   ...
   public float getScale() {
      ...
      return JRMCoreH.calculateEnergyScale(damage, this.maxDamage, perc, null, den, this.minScale, this.maxScale);
   }
   ...
   public EntityEnergyAttJ(
      ...
      this.speed = (byte)((speed + 1.0F) * 10.0F + (type == 2 ? 10 : 0) + (density == 2 ? 40 : 0));
      this.dam = dam;
      this.perc = 50;
      this.effect = effect;
      ...
      if (JRMCoreConfig.JutsuScalesWithUser) {
         this.size = this.size * (this.shootingEntity == null ? 1.0F : this.shootingEntity.field_70131_O / 1.8F);
      }
      ...
      double y = par2EntityLivingBase.field_70163_u + vec3.field_72448_b * d8 + par2EntityLivingBase.field_70131_O * 0.7F;
      ...
      this.func_70186_c(this.field_70159_w, this.field_70181_x, this.field_70179_y, this.speed * 0.05F, 1.0F);
      this.strtX = (float)x;
      this.strtY = (float)y;
      this.strtZ = (float)z;
      ...
      if (this.inGround) {
         ...
         if (!this.field_70170_p.field_72995_K) {
            ...
            for (int var9 = 0; var9 < var6.size(); var9++) {
               ...
               if (var10.func_70067_L() && (var10 != this.shootingEntity || this.ticksInAir >= 5)) {
                  float var11 = 0.0F;
                  AxisAlignedBB var12 = var10.field_70121_D.func_72314_b(var11, var11, var11);
            ...
            for (int var9 = 0; var9 < var6.size(); var9++) {
               ...
               if (var10 != this.shootingEntity) {
                  if (this.isContinuesWave() && var10 instanceof EntityLivingBase) {
                     ...
                     float den = t.getDen() * 10.0F;
                     float damt = (float)(this.damage / 2.0);
                     float spet = this.speed * 2.0F;
                     float dent = this.density * 10.0F;
                     float power = damt - dam + (spe - spet) + (dent - den);
                     float calc = 1.0F - power * 0.01F;
                     if (this.conn == 0) {
                        this.conn++;
                     }
         ...
         if (var4 != null && var4.field_72308_g != this.shootingEntity) {
            if (var4.field_72308_g != null
               && (this.shootingEntity instanceof EntityPlayer || var4.field_72308_g instanceof EntityPlayer)
               && this.isContinuesWave()
               && this.shooterHolds) {
               if (this.shootingEntity instanceof EntityPlayer) {
                     ...
                     if (this.target != null) {
                        if (this.waveCount == 20) {
                           ...
                           if (!this.field_70170_p.field_72995_K) {
                              ...
                              float cost2 = (float)((double)this.cost * curRel * 0.01F * (this.perc * 0.02F));
                              if (!(curEn - cost2 > 0.0F)) {
                                 this.func_70106_y();
                              }
                           ...
                           if (this.target.func_70097_a(damagesource, var23)) {
                           }
               ...
               if (this.density != 2 && var4.field_72308_g.func_70097_a(damagesource, var23)) {
                  if (var4.field_72308_g instanceof EntityLivingBase) {
                     if (!this.field_70170_p.field_72995_K) {
         ...
         for (int test = 0; this.field_70125_A - this.field_70127_C >= 180.0F && test < 20; test++) {
            this.field_70127_C += 360.0F;
         }

         for (int var66 = 0; this.field_70177_z - this.field_70126_B < -180.0F && var66 < 20; var66++) {
            this.field_70126_B -= 360.0F;
         }

         for (int var67 = 0; this.field_70177_z - this.field_70126_B >= 180.0F && var67 < 20; var67++) {
            this.field_70126_B += 360.0F;
         }
   ...
   private void createExplosion(int type) {
      JRMCoreH.newExpl(
         this.field_70170_p, this, this.field_70165_t, this.field_70163_u, this.field_70161_v, this.size, false, this.damage, this.shootingEntity, (byte)type
      );
   }
