...
public class ComJrmcaBonusCheck extends CommandBase {
   ...
   public void func_71515_b(ICommandSender commandSender, String[] stringArray) {
      ...
      byte mode = (byte)(modeSting.equals("sheet") ? 0 : -1);
      byte attribute = 0;
      ...
      boolean canRun = true;
      if (!JRMCoreConfig.JRMCABonusCheckOnOthersWithoutOP
         && commansender != null
         && !entitycommansender.equals("Console")
         && !entityplayermp.func_70005_c_().equals(entitycommansender)) {
         canRun = false;
