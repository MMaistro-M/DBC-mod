...
public class ComJrmc extends CommandBase {
   ...
   public void func_71515_b(ICommandSender commandSender, String[] stringArray) {
      ...
      if (entityplayermp != null && JRMCoreConfig.osbic > 0 && JRMCoreH.osbic.get(entityplayermp.func_70005_c_()) < JRMCoreConfig.osbic * 20) {
         entityplayermp.func_145747_a(
            new ChatComponentTranslation(
                  "Offline Protection: " + ((int)((JRMCoreConfig.osbic * 20 - JRMCoreH.osbic.get(entityplayermp.func_70005_c_())) * 0.05F) + 1) + "s left",
                  new Object[0]
               )
         ...
         if (startnew) {
            ...
            EntityPlayerMP p = entityplayermp;
            String toteach1 = JRMCoreH.getString(p, "jrmcTechLearn");
            if (toteach1.contains(";:;")) {
               ...
               if (teacher != null && p.func_70032_d(teacher) < 8.0F && accept) {
                  if (pwrtyp == 1) {
                     int b = 0;
                     boolean may = false;

                     for (int i = 0; i < 4; i++) {
                        String s1 = JRMCoreH.getString(p, JRMCoreH.techNbt[i]);
                        if (!s1.contains(";")) {
                           b = i;
                           may = true;
                           break;
                     ...
                     if (may) {
                        ...
                        if (tp - costTp >= 0) {
                           ...
                           teacher.func_145747_a(
                              new ChatComponentTranslation(JRMCoreH.trlai("jrmc", "teachingOfferAccepted"), new Object[]{p.func_70005_c_(), tn[0]})
                                 .func_150255_a(JRMCoreH2.styl_ylw)
                           );
                           p.func_145747_a(
                              new ChatComponentTranslation(JRMCoreH.trlai("jrmc", "techadded"), new Object[]{tn[0]}).func_150255_a(JRMCoreH2.styl_ylw)
                           );
                        } else {
                  ...
                  JRMCoreH.setString(" ", p, "jrmcTechLearn");
                  p.func_145747_a(
                     new ChatComponentTranslation(JRMCoreH.trlai("jrmc", "teachingOfDeclByYou"), new Object[]{toteach[1], tn[0]})
                        .func_150255_a(JRMCoreH2.styl_ylw)
                  );
                  if (teacher != null) {
                     teacher.func_145747_a(
                        new ChatComponentTranslation(JRMCoreH.trlai("jrmc", "teachingOfDeclByPlayr"), new Object[]{p.func_70005_c_()})
                           .func_150255_a(JRMCoreH2.styl_ylw)
                     );
                  }
               } else {
                  JRMCoreH.setString(" ", p, "jrmcTechLearn");
                  p.func_145747_a(
                     new ChatComponentTranslation(JRMCoreH.trlai("jrmc", "teachingOfferDeclined"), new Object[]{toteach[1], tn[0]})
                        .func_150255_a(JRMCoreH2.styl_ylw)
                  );
               }
            } else {
