...
public class ClassGenUtils {
    ...
    static {
        ...
        try {
            ...
            theDefiner = (name, bytes, scope) -> defineClass.invoke((Object)unsafe, name, bytes, 0, bytes.length, scope.lookupClass().getClassLoader(), scope.lookupClass().getProtectionDomain());
        }
            ...
            try {
                ...
                theDefiner = (name, bytes, scope) -> defineClass.invoke((Object)scope, new Object[]{bytes});
            }
