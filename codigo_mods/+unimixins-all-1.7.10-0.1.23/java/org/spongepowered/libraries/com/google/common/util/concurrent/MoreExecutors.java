...
import org.spongepowered.libraries.com.google.common.util.concurrent.AbstractListeningExecutorService;
import org.spongepowered.libraries.com.google.common.util.concurrent.Callables;
...
import org.spongepowered.libraries.com.google.common.util.concurrent.ListeningScheduledExecutorService;
import org.spongepowered.libraries.com.google.common.util.concurrent.ThreadFactoryBuilder;
import org.spongepowered.libraries.com.google.common.util.concurrent.TrustedListenableFutureTask;
import org.spongepowered.libraries.com.google.common.util.concurrent.WrappingExecutorService;
import org.spongepowered.libraries.com.google.common.util.concurrent.WrappingScheduledExecutorService;
...
public final class MoreExecutors {
    ...
    public static ThreadFactory platformThreadFactory() {
        ...
        try {
            return (ThreadFactory)Class.forName("org.spongepowered.libraries.com.google.appengine.api.ThreadManager").getMethod("currentRequestThreadFactory", new Class[0]).invoke(null, new Object[0]);
        }
    ...
    private static boolean isAppEngine() {
        ...
        try {
            return Class.forName("org.spongepowered.libraries.com.google.apphosting.api.ApiProxy").getMethod("getCurrentEnvironment", new Class[0]).invoke(null, new Object[0]) != null;
        }
        catch (ClassNotFoundException e) {
            return false;
        }
