...
extends BasicInterpreter {
    ...
    public BasicValue ternaryOperation(AbstractInsnNode insn, BasicValue value1, BasicValue value2, BasicValue value3) throws AnalyzerException {
        ...
        if (!this.isSubTypeOf(value1, expected1)) {
            throw new AnalyzerException(insn, "First argument", BasicVerifier.stringConcat$0(String.valueOf(expected1)), value1);
        }
    ...
    private static /* synthetic */ String stringConcat$0(String string) {
        return "a " + string + " array reference";
    }
    ...
    public BasicValue naryOperation(AbstractInsnNode insn, List<? extends BasicValue> values) throws AnalyzerException {
        ...
        if (opcode == 197) {
            ...
            while (i < values.size()) {
                ...
                throw new AnalyzerException(insn, BasicVerifier.stringConcat$1((int)var5_8), expected, actual);
            }
        }
