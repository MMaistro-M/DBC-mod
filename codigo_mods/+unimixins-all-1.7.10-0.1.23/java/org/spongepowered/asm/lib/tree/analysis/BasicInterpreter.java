...
implements Opcodes {
        ...
        switch (insn.getOpcode()) {
            ...
            case 18: {
                ...
                if (value instanceof Type) {
                    ...
                    throw new AnalyzerException(insn, BasicInterpreter.stringConcat$0(String.valueOf(value)));
                }
                ...
                throw new AnalyzerException(insn, BasicInterpreter.stringConcat$1(String.valueOf(value)));
            }
            case 168: {
    ...
    private static /* synthetic */ String stringConcat$0(String string) {
        return "Illegal LDC value " + string;
    }
    ...
    public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 189: {
                return this.newValue(Type.getType(BasicInterpreter.stringConcat$2(String.valueOf(Type.getObjectType(((TypeInsnNode)insn).desc)))));
            }
            case 190: {
                return BasicValue.INT_VALUE;
            }
