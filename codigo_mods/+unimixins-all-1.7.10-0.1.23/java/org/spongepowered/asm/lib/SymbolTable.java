...
final class SymbolTable {
    ...
    Symbol addConstant(Object value) {
        ...
        throw new IllegalArgumentException(SymbolTable.stringConcat$0(String.valueOf(value)));
    }
    ...
    Symbol addConstantMethodHandle(int referenceKind, String owner, String name, String descriptor, boolean isInterface) {
        int tag = 15;
        int data = SymbolTable.getConstantMethodHandleSymbolData(referenceKind, isInterface);
        int hashCode = SymbolTable.hash(15, owner, name, descriptor, data);
        Entry entry = this.get(hashCode);
        while (entry != null) {
        ...
        return this.put(new Entry(this.constantPoolCount++, 15, owner, name, descriptor, data, hashCode));
    }
    ...
    private void addConstantMethodHandle(int index, int referenceKind, String owner, String name, String descriptor, boolean isInterface) {
        ...
        int data = SymbolTable.getConstantMethodHandleSymbolData(referenceKind, isInterface);
        int hashCode = SymbolTable.hash(15, owner, name, descriptor, data);
        this.add(new Entry(index, 15, owner, name, descriptor, data, hashCode));
    }

    private static int getConstantMethodHandleSymbolData(int referenceKind, boolean isInterface) {
        if (referenceKind > 4 && isInterface) {
