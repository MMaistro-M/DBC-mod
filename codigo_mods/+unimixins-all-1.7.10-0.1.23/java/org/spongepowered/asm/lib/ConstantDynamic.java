...
public final class ConstantDynamic {
    ...
    public String toString() {
        return ConstantDynamic.stringConcat$0(this.name, this.descriptor, String.valueOf(this.bootstrapMethod), Arrays.toString(this.bootstrapMethodArguments));
    }

    private static /* synthetic */ String stringConcat$0(String string, String string2, String string3, String string4) {
