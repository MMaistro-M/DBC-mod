    ...
    public void visitMethodInsn(int opcodeAndSource, String owner, String name, String descriptor, boolean isInterface) {
        ...
        if (opcode != 184) {
            ...
            if (opcode == 183 && name.equals("<init>")) {
                int i;
                String initializedValue = value == Opcodes.UNINITIALIZED_THIS ? this.owner : owner;
    ...
    private void execute(int opcode, int intArg, String stringArg) {
        ...
        block0 : switch (opcode) {
            ...
            case 188: {
                ...
                throw new IllegalArgumentException(AnalyzerAdapter.stringConcat$0(intArg));
            }
            case 189: {
                this.pop();
                this.pushDescriptor(AnalyzerAdapter.stringConcat$1(String.valueOf(Type.getObjectType(stringArg))));
                break;
            }
            case 192: {
                this.pop();
            ...
            default: {
                throw new IllegalArgumentException(AnalyzerAdapter.stringConcat$2(opcode));
            }
        }
        this.labels = null;
    }
