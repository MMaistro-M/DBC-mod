        ...
        block23: {
            block22: {
                ...
                switch (opcode) {
                    ...
                    default: {
                        throw new IllegalArgumentException(AdviceAdapter.stringConcat$0(opcode));
                    }
                }
            }
            switch (opcode) {
    ...
    public void visitVarInsn(int opcode, int varIndex) {
        ...
        if (this.isConstructor && !this.superClassConstructorCalled) {
            switch (opcode) {
                ...
                default: {
                    throw new IllegalArgumentException(AdviceAdapter.stringConcat$1(opcode));
                }
            }
        }
    }
    ...
    public void visitFieldInsn(int opcode, String owner, String name, String descriptor) {
        ...
        if (this.isConstructor && !this.superClassConstructorCalled) {
            ...
            switch (opcode) {
                ...
                default: {
                    throw new IllegalArgumentException(AdviceAdapter.stringConcat$2(opcode));
                }
            }
        }
    }
