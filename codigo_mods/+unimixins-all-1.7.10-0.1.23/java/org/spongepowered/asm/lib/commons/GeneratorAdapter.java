...
import org.spongepowered.asm.lib.commons.LocalVariablesSorter;
import org.spongepowered.asm.lib.commons.Method;
import org.spongepowered.asm.lib.commons.TableSwitchGenerator;
...
extends LocalVariablesSorter {
    ...
    public void push(Type value) {
        if (value == null) {
            ...
            switch (value.getSort()) {
                case 0: {
                    this.mv.visitFieldInsn(178, "java/lang/Void", "TYPE", CLASS_DESCRIPTOR);
                    break;
                }
                case 1: {
    ...
    public void cast(Type from, Type to) {
        if (from != to) {
            if (from.getSort() < 1 || from.getSort() > 8 || to.getSort() < 1 || to.getSort() > 8) {
                throw new IllegalArgumentException(GeneratorAdapter.stringConcat$0(String.valueOf(from), String.valueOf(to)));
            }
    ...
    private static /* synthetic */ String stringConcat$0(String string, String string2) {
        return "Cannot cast from " + string + " to " + string2;
    }
    ...
    public void ifCmp(Type type, int mode, Label label) {
        switch (type.getSort()) {
            ...
            case 10: {
                ...
                throw new IllegalArgumentException(GeneratorAdapter.stringConcat$1(String.valueOf(type)));
            }
            default: {
                int intOp = -1;
                switch (mode) {
                    ...
                    default: {
                        throw new IllegalArgumentException(GeneratorAdapter.stringConcat$2(mode));
                    }
                }
    ...
    private static /* synthetic */ String stringConcat$1(String string) {
        return "Bad comparison for type " + string;
    }

    private static /* synthetic */ String stringConcat$2(int n) {
        return "Bad comparison mode " + n;
    }
