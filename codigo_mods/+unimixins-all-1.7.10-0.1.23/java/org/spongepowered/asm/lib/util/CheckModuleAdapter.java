...
extends ModuleVisitor {
    ...
    public void visitRequire(String module, int access, String version) {
        ...
        if (this.classVersion >= 54 && module.equals("java.base") && (access & 0x60) != 0) {
            throw new IllegalArgumentException(CheckModuleAdapter.stringConcat$0(access));
        }
        super.visitRequire(module, access, version);
    }

    private static /* synthetic */ String stringConcat$0(int n) {
        return "Invalid access flags: " + n + " java.base can not be declared ACC_TRANSITIVE or ACC_STATIC_PHASE";
    }
    ...
    private static class NameSet {
        ...
        void checkNameNotAlreadyDeclared(String name) {
            if (!this.names.add(name)) {
                throw new IllegalArgumentException(NameSet.stringConcat$0(this.type, name));
            }
        }

        private static /* synthetic */ String stringConcat$0(String string, String string2) {
            return string + " '" + string2 + "' already declared";
        }
    }
}
