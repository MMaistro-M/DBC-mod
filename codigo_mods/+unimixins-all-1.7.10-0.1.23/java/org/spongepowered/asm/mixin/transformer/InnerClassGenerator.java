...
implements IClassGenerator {
    ...
    private static ClassVisitor createRemappingAdapter(ClassVisitor cv, Remapper remapper) throws ReflectiveOperationException {
        if (clRemapper == null) {
            try {
                clRemapper = Class.forName("org.spongepowered.asm.lib.commons.ClassRemapper");
            }
            ...
            if (clRemapper == null) {
                try {
                    clRemapper = Class.forName("org.spongepowered.asm.lib.commons.RemappingClassAdapter");
                }
