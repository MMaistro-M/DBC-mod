                ...
                if (frameNode.type != 3 && frameNode.type != 4) {
                    ...
                    if (frameData != null) {
                        if (frameData.type == 0) {
                            ...
                            frameSize = Locals.getAdjustedFrameSize(frameSize, frameData.type, frameData.rawSize, 0);
                        }
                    } else {
                        frameSize = Locals.getAdjustedFrameSize(frameSize, frameNode, 0);
                    }
                    if (frameNode.type == 2) {
                        for (framePos = frameSize; framePos < frame.length; ++framePos) {
                            frame[framePos] = null;
