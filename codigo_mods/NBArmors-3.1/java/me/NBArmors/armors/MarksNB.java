...
extends ItemVanity {
    ...
    private final int VANITY_COAT = 11;
    private int type = -1;

    public MarksNB(int defcol, ItemArmor.ArmorMaterial par2ArmorMaterial, int armorType, String armornamePrefix, int type) {
        ...
        if (this.wear(e)) {
            ...
            if (!has) {
                if (slt != 5 && this.func_77658_a().contains("Head")) {
                    return NBHJBRA.MarksModel2;
                }
                return NBHJBRA.MarksModel3;
            }
            return NBHJBRA.MarksModel2;
        }
        return null;
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int par3) {
        ...
        if (this.wear(entityLiving)) {
            ...
            modelbiped.field_78112_f.field_78806_j = par3 == 0 || par3 == 1 || par3 == 2;
            modelbiped.field_78113_g.field_78806_j = par3 == 0 || par3 == 1 || par3 == 2;
