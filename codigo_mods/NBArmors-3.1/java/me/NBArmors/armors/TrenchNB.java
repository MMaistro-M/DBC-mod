...
extends ItemArmor {
    ...
    public String na = TrenchNB.armornamePrefix;
    public ItemArmor.ArmorMaterial rl;
    private ResourceLocation icon = null;

    public TrenchNB(ItemArmor.ArmorMaterial par2ArmorMaterial, int slot, int par4, String armornamePrefix) {
    ...
    public ModelBiped nbMdl(int slt, EntityLivingBase e) {
        ...
        switch (slt) {
            case 0: {
                return this.wear(e) ? NBHJBRA.TrenchCoatNBB1 : NBHJBRA.armornn1;
            }
            case 1: {
                return this.wear(e) ? NBHJBRA.TrenchCoatNBB1 : NBHJBRA.armornn1;
            }
        ...
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        return this.wear(e) ? NBHJBRA.TrenchCoatNBB2 : NBHJBRA.armornn2;
    }
