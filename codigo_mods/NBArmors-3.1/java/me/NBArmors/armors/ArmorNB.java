...
public class ArmorNB
extends ItemArmor {
    private static String armornamePrefix;
    public String modid;
    private int defcol = vanitycolorex.cols[15];
    private String Display = "Color1";
    public String na = ArmorNB.armornamePrefix;
    public ItemArmor.ArmorMaterial rl;
    private ResourceLocation icon = null;
    public static final ItemArmor.ArmorMaterial NBmaterial;

    public ArmorNB(ItemArmor.ArmorMaterial par2ArmorMaterial, int slot, int par4, String armornamePrefix) {
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemstack, int par3) {
        ModelBiped armorModel = this.nbMdl(par3, entityLiving);
        if (this.wear(entityLiving)) {
            armorModel = NBHJBRA.showModel(armorModel, entityLiving, itemstack, par3);
        } else {
            ItemStack var11;
            armorModel.field_78116_c.field_78806_j = par3 == 0 || par3 == 1;
            armorModel.field_78115_e.field_78806_j = par3 == 0;
            armorModel.field_78114_d.field_78806_j = false;
            armorModel.field_78115_e.field_78806_j = par3 == 0 || par3 == 1 || par3 == 2;
            armorModel.field_78112_f.field_78806_j = par3 == 0 || par3 == 1 || par3 == 2;
            armorModel.field_78113_g.field_78806_j = par3 == 0 || par3 == 1 || par3 == 2;
            armorModel.field_78123_h.field_78806_j = par3 == 2 || par3 == 3;
            boolean bl = armorModel.field_78124_i.field_78806_j = par3 == 2 || par3 == 3;
