...
public class TrenchNB2
extends ItemArmor {
    private static String armornamePrefix;
    public String modid;
    private int defcol = vanitycolorex.cols[15];
    private String Display = "Color1";
    public String na = TrenchNB2.armornamePrefix;
    public ItemArmor.ArmorMaterial rl;
    private ResourceLocation icon = null;

    public TrenchNB2(ItemArmor.ArmorMaterial par2ArmorMaterial, int slot, int par4, String armornamePrefix) {
    ...
    public ModelBiped nbMdl(int slt, EntityLivingBase e) {
        ...
        switch (slt) {
            case 0: {
                return this.wear(e) ? NBHJBRA.TrenchCNBB1 : NBHJBRA.armornn1;
            }
            case 1: {
                return this.wear(e) ? NBHJBRA.TrenchCNBB1 : NBHJBRA.armornn1;
            }
        ...
        GL11.glColor4f((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
        return this.wear(e) ? NBHJBRA.TrenchCNBB2 : NBHJBRA.armornn2;
    }
