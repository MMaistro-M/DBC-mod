...
extends ItemVanity {
    ...
    public ItemVanityNB(int defcol, ItemArmor.ArmorMaterial par2ArmorMaterial, int armorType, String armornamePrefix, int type) {
    ...
    public void func_94581_a(IIconRegister iconRegister) {
        ...
        this.field_94604_cx1 = iconRegister.func_94245_a(EMPTY_SLOT_NAMES[this.armorType]);
        if (this.rl == ItemArmor.ArmorMaterial.CLOTH) {
            this.overlayIcon = iconRegister.func_94245_a(CLOTH_OVERLAY_NAMES[this.armorType]);
        }
        this.emptySlotIcon = iconRegister.func_94245_a(EMPTY_SLOT_NAMES[this.armorType]);
    }
