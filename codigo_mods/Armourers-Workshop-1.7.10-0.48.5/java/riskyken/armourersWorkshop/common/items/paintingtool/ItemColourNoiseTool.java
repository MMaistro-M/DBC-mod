...
public class ItemColourNoiseTool
extends AbstractModItem
implements IConfigurableTool,
IBlockPainter {
    public ItemColourNoiseTool() {
        super("colourNoiseTool");
        this.setSortPriority(15);
    }

    @SideOnly(value=Side.CLIENT)
    public void func_94581_a(IIconRegister register) {
        this.field_77791_bV = register.func_94245_a(LibItemResources.COLOUR_NOISE_TOOL);
    }

    public boolean func_77648_a(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
        Block block = world.func_147439_a(x, y, z);
        if (!player.func_70093_af() & block instanceof IPantableBlock) {
