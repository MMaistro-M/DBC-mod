...
public class AddonLittleMaidMob
extends ModAddon {
    ...
    public static class SkinnableEntityLittleMaidMobRenderer
    implements ISkinnableEntityRenderer {
        public void render(EntityLivingBase entity, RendererLivingEntity renderer, double x, double y, double z, IEntityEquipment entityEquipment) {
            ...
            GL11.glTranslated((double)0.0, (double)(-24.0f * scale), (double)0.0);
            entity.func_70047_e();
    ...
    public static class SkinnableEntityLittleMaidMob
    implements ISkinnableEntity {
        @Override
        public Class<? extends EntityLivingBase> getEntityClass() {
            try {
                return Class.forName("littleMaidMobX.LMM_EntityLittleMaid");
            }
