...
public class CommandClearSkins
extends ModCommand {
    ...
    public List func_71516_a(ICommandSender commandSender, String[] currentCommand) {
        if (currentCommand.length == 2) {
            return CommandClearSkins.func_71530_a((String[])currentCommand, (String[])this.getPlayers());
        }
        return null;
    }
    ...
    public void func_71515_b(ICommandSender commandSender, String[] currentCommand) {
        ...
        EntityPlayerMP player = CommandClearSkins.func_82359_c((ICommandSender)commandSender, (String)playerName);
        if (player == null) {
            return;
        }
        ExPropsPlayerSkinData.get((EntityPlayer)player).clearAllEquipmentStacks();
    }
}
