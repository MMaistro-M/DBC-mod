...
public class ToolOptionIntensity
extends AbstractToolOption {
    ...
    public GuiButton getGuiControl(int id, int x, int y, NBTTagCompound compound) {
        GuiSlider sliderControl = new GuiSlider(id, x, y, this.getLocalisedLabel() + " ", 1.0, 64.0, (double)((Integer)this.readFromNBT(compound)).intValue(), null);
    ...
    public Object readFromNBT(NBTTagCompound compound) {
        return this.readFromNBT(compound, 16);
    }
