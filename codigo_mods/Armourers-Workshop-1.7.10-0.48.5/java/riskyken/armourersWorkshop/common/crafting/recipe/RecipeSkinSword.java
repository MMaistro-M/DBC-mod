...
extends RecipeItemSkinning {
    ...
    public ItemStack getCraftingResult(IInventory inventory) {
        ...
        for (int slotId = 0; slotId < inventory.func_70302_i_(); ++slotId) {
            ...
            if (EntityEquipmentDataManager.INSTANCE.isRenderItem(ModAddon.ItemOverrideType.SWORD, item) & !SkinNBTHelper.isSkinLockedOnStack(stack)) {
                if (swordStack != null) {
                    return null;
                }
                swordStack = stack;
