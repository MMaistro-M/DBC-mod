...
public class BlockSkinningTable
extends AbstractModBlockContainer {
    ...
    public void func_149651_a(IIconRegister register) {
        this.field_149761_L = register.func_94245_a(LibBlockResources.SKINNING_TABLE_SIDE);
        this.iconTop = register.func_94245_a(LibBlockResources.SKINNING_TABLE_TOP);
        this.iconBottom = register.func_94245_a(LibBlockResources.SKINNING_TABLE_BOTTOM);
    }
    ...
    public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int side, float xHit, float yHit, float zHit) {
        if (!world.field_72995_K) {
            FMLNetworkHandler.openGui((EntityPlayer)player, (Object)ArmourersWorkshop.instance, (int)10, (World)world, (int)x, (int)y, (int)z);
        }
        return true;
    }
