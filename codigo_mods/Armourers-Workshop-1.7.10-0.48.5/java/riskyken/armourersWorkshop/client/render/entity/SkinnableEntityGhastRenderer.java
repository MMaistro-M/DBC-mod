...
public class SkinnableEntityGhastRenderer
implements ISkinnableEntityRenderer<EntityGhast> {
    @Override
    public void render(EntityGhast entity, RendererLivingEntity renderer, double x, double y, double z, IEntityEquipment entityEquipment) {
        GL11.glPushMatrix();
        float scale = 0.0625f;
        ...
        GL11.glTranslated((double)0.0, (double)(6.65f * scale), (double)0.0);
