...
public class SkinnableEntityChickenRenderer
implements ISkinnableEntityRenderer<EntityChicken> {
    @Override
    public void render(EntityChicken entity, RendererLivingEntity renderer, double x, double y, double z, IEntityEquipment entityEquipment) {
        GL11.glPushMatrix();
        float scale = 0.0625f;
        ...
        if (entity.func_70631_g_()) {
            GL11.glTranslated((double)0.0, (double)(scale * 5.0f), (double)(scale * 1.5f));
        }
        GL11.glTranslated((double)0.0, (double)(-9.0f * scale), (double)0.0);
        GL11.glTranslated((double)0.0, (double)0.0, (double)(-4.0f * scale));
        ...
        GL11.glScalef((float)headScale, (float)(headScale * 1.5f), (float)headScale);
