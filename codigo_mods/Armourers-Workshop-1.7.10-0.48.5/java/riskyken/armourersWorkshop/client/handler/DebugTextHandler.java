...
public class DebugTextHandler {
    ...
    public void onDebugText(RenderGameOverlayEvent.Text event) {
        ...
        if (event.left != null && event.left.size() > 0) {
            ...
            List playerList = localPlayer.field_71174_a.field_147303_b;
            event.left.add("");
            event.left.add(EnumChatFormatting.GOLD + "[" + "Armourer's Workshop" + "]");
            ...
            if (GuiScreen.func_146271_m()) {
                ...
                if (!Minecraft.func_71410_x().func_71387_A()) {
                    for (int i = 0; i < playerList.size(); ++i) {
                        ...
                        if (!player.field_78831_a.equals(localPlayer.func_70005_c_())) continue;
                        event.left.add("ping:" + player.field_78829_b + "ms");
                        break;
                    }
                }
            } else {
