...
extends BlockLightable {
    public BlockLantern(boolean lit) {
        super(Blocks.field_150339_S, lit);
    ...
    public void func_149719_a(IBlockAccess world, int x, int y, int z) {
        ...
        if (tile.variant == 2) {
            ...
            this.func_149676_a(0.3f + xOffset, 0.2f, 0.3f + yOffset, 0.7f + xOffset, 0.7f, 0.7f + yOffset);
        } else {
            this.func_149676_a(0.3f, 0.0f, 0.3f, 0.7f, 0.6f, 0.7f);
        }
    }
    ...
    public void func_149714_e(World world, int x, int y, int z, int meta) {
        TileLamp tile = (TileLamp)world.func_147438_o(x, y, z);
        if (meta == 1) {
            tile.variant = 0;
        } else if (meta == 0) {
            tile.variant = 1;
