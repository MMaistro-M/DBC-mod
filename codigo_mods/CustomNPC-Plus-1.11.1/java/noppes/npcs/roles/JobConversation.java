...
extends JobInterface {
    ...
    public void aiUpdateTask() {
        ...
        if (this.nextLine != null) {
            ...
            List inRange = this.npc.field_70170_p.func_72872_a(EntityPlayer.class, this.npc.field_70121_D.func_72314_b((double)this.range, (double)this.range, (double)this.range));
            for (EntityPlayer player : inRange) {
                if (!this.availability.isAvailable(player)) continue;
                PlayerQuestController.addActiveQuest(new QuestData(this.getQuest()), player);
            }
        }
    }
    ...
    public boolean aiShouldExecute() {
        ...
        if (!this.hasStarted && this.mode == 1) {
            ...
            if (this.npc.field_70170_p.func_72872_a(EntityPlayer.class, this.npc.field_70121_D.func_72314_b((double)this.range, (double)this.range, (double)this.range)).isEmpty()) {
                return false;
            }
        }
        for (ConversationLine line : this.lines.values()) {
    ...
    private boolean shouldRun() {
        ...
        this.npcs.clear();
        List list = this.npc.field_70170_p.func_72872_a(EntityNPCInterface.class, this.npc.field_70121_D.func_72314_b(10.0, 10.0, 10.0));
