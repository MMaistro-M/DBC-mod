...
extends JobInterface {
    ...
    public boolean giveItems(EntityPlayer player) {
        ...
        if (this.isAllGiver()) {
            ...
            for (ItemStack itemStack : items) {
                if (this.playerHasItem(player, itemStack.func_77973_b())) continue;
                toGive.add(itemStack);
            }
    ...
    public boolean aiShouldExecute() {
        ...
        this.ticks = 10;
        this.toCheck = this.npc.field_70170_p.func_72872_a(EntityPlayer.class, this.npc.field_70121_D.func_72314_b(3.0, 3.0, 3.0));
        this.toCheck.removeAll(this.recentlyChecked);
        List listMax = this.npc.field_70170_p.func_72872_a(EntityPlayer.class, this.npc.field_70121_D.func_72314_b(10.0, 10.0, 10.0));
