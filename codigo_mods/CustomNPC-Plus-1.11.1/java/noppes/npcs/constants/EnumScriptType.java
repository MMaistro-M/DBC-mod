...
public enum EnumScriptType {
    ...
    private static final Map<String, EnumScriptType> BY_FUNCTION;
    ...
    public static EnumScriptType valueOfIgnoreCase(String channelName) {
        ...
        return EnumScriptType.valueOf(channelName.toUpperCase());
    }
    ...
    static {
        BY_FUNCTION = new HashMap<String, EnumScriptType>();
        for (EnumScriptType type : EnumScriptType.values()) {
