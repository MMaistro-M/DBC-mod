...
extends ContainerNpcInterface {
    ...
    public ItemStack func_82846_b(EntityPlayer player, int index) {
        ...
        if (slot != null && slot.func_75216_d()) {
            ...
            returnedStack = stackInSlot.func_77946_l();
            int bankStart = this.currency != null ? 1 : 0;
            int bankEnd = bankStart + this.getRowNumber() * 9;
            if (index >= bankStart && index < bankEnd ? !this.func_75135_a(stackInSlot, bankEnd, this.field_75151_b.size(), true) : (index >= bankEnd ? !this.func_75135_a(stackInSlot, bankStart, bankEnd, false) : !this.func_75135_a(stackInSlot, bankEnd, this.field_75151_b.size(), true))) {
                return null;
            }
