...
extends ContainerNpcInterface {
    ...
    public ContainerMail(EntityPlayer player, boolean canEdit, boolean canSend) {
        ...
        player.field_71071_by.func_70295_k_();
        for (k = 0; k < 4; ++k) {
    ...
    public ItemStack func_82846_b(EntityPlayer par1EntityPlayer, int par2) {
        ...
        if (slot != null && slot.func_75216_d()) {
            ...
            if (par2 < 4 ? !this.func_75135_a(itemstack1, 4, this.field_75151_b.size(), true) : !this.canEdit || !this.func_75135_a(itemstack1, 0, 4, false)) {
                return null;
            }
