...
extends Container {
    ...
    public ContainerNPCTraderSetup(EntityNPCInterface npc, EntityPlayer player) {
        ...
        for (int i = 0; i < 18; ++i) {
            int x = 7;
            int y = 15;
            this.func_75146_a(new Slot((IInventory)this.role.inventoryCurrency, i, (x += i % 3 * 130) + 51, y += i / 3 * 22));
            this.func_75146_a(new Slot((IInventory)this.role.inventoryCurrency, i + 18, x + 69, y));
            this.func_75146_a(new Slot((IInventory)this.role.inventorySold, i, x + 105, y));
        }
