...
implements ForgeChunkManager.LoadingCallback {
    ...
    public HashMap<Entity, ForgeChunkManager.Ticket> tickets = new HashMap();
    ...
    public ForgeChunkManager.Ticket getTicket(EntityNPCInterface npc) {
        ...
        if (this.size() >= ConfigMain.ChunkLoaders) {
            return null;
        }
    ...
    public void ticketsLoaded(List<ForgeChunkManager.Ticket> tickets, World world) {
        for (ForgeChunkManager.Ticket ticket : tickets) {
            ...
            if (npc.advanced.job != EnumJobType.ChunkLoader || tickets.contains((Object)npc)) continue;
            this.tickets.put((Entity)npc, ticket);
            double x = npc.field_70165_t / 16.0;
            double z = npc.field_70161_v / 16.0;
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkCoordIntPair)new ChunkCoordIntPair(MathHelper.func_76128_c((double)x), MathHelper.func_76128_c((double)z)));
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkCoordIntPair)new ChunkCoordIntPair(MathHelper.func_76143_f((double)x), MathHelper.func_76143_f((double)z)));
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkCoordIntPair)new ChunkCoordIntPair(MathHelper.func_76128_c((double)x), MathHelper.func_76143_f((double)z)));
            ForgeChunkManager.forceChunk((ForgeChunkManager.Ticket)ticket, (ChunkCoordIntPair)new ChunkCoordIntPair(MathHelper.func_76143_f((double)x), MathHelper.func_76128_c((double)z)));
        }
    }
