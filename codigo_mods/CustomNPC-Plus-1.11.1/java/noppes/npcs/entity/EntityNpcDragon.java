    ...
    public void func_70636_d() {
        ...
        if (this.field_70170_p.field_72995_K && this.func_110143_aJ() <= 0.0f) {
            if (!this.exploded) {
                ...
                this.field_70170_p.func_72869_a("largeexplode", this.field_70165_t + (double)f, this.field_70163_u + 2.0 + (double)f2, this.field_70161_v + (double)f4, 0.0, 0.0, 0.0);
            }
        } else {
            this.exploded = false;
        ...
        super.func_70636_d();
        this.isFlying = this.isNpcFlying();
    }
