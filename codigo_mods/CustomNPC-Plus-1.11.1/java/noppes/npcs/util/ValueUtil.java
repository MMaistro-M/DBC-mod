...
public class ValueUtil {
    ...
    public static String format(double value) {
        return value % 1.0 == 0.0 ? String.format("%.0f", value) : String.format("%.2f", value);
    }

    public static String format(String precision, float value) {
        return value % 1.0f == 0.0f ? String.format("%.0f", Float.valueOf(value)) : String.format(precision, Float.valueOf(value));
    }

    public static String format(String precision, double value) {
        return value % 1.0 == 0.0 ? String.format("%.0f", value) : String.format(precision, value);
    }
}
