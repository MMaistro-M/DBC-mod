...
implements IChainEvent {
    ...
    extends ChainEvent
    implements IChainEvent.InterruptEvent {
        private final IDamageSource damageSource;
        private final float damage;

        public InterruptEvent(EntityLivingBase entity, ChainedAbility chain, int entryIndex, EntityLivingBase target, DamageSource source, float damage) {
    ...
    extends ChainEvent
    implements IChainEvent.CompleteEvent {
    ...
    extends ChainEvent
    implements IChainEvent.NextEvent {
    ...
    extends ChainEvent
    implements IChainEvent.StartEvent {
