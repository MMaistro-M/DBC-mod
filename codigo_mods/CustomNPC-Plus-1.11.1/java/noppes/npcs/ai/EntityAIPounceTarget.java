...
extends EntityAIBase {
    ...
    public boolean func_75250_a() {
        ...
        return !this.npc.isInRange((Entity)this.leapTarget, 4.0) && this.npc.isInRange((Entity)this.leapTarget, 8.0) && this.npc.func_70681_au().nextInt(5) == 0;
    }
    ...
    public void func_75249_e() {
        ...
        double varY = this.leapTarget.field_70121_D.field_72338_b - this.npc.field_70121_D.field_72338_b;
