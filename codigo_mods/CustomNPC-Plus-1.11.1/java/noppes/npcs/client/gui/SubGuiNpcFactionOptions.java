...
ICustomScrollListener {
    ...
    public void func_73866_w_() {
        ...
        if (this.data.containsValue(this.options.factionId)) {
            ...
            label = "";
            label = this.options.decreaseFactionPoints ? label + StatCollector.func_74838_a((String)"gui.decrease") : label + StatCollector.func_74838_a((String)"gui.increase");
            label = label + " " + this.options.factionPoints + " " + StatCollector.func_74838_a((String)"faction.points");
        ...
        if (this.data.containsValue(this.options.faction2Id)) {
            ...
            label = "";
            label = this.options.decreaseFaction2Points ? label + StatCollector.func_74838_a((String)"gui.decrease") : label + StatCollector.func_74838_a((String)"gui.increase");
            label = label + " " + this.options.faction2Points + " " + StatCollector.func_74838_a((String)"faction.points");
