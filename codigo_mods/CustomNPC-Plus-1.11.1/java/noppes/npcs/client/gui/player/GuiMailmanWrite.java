...
GuiYesNoCallback {
    ...
    public void func_73878_a(boolean flag, int i) {
        if (flag) {
            MailActionPacket.DeleteMail(GuiMailmanWrite.mail.time, GuiMailmanWrite.mail.sender);
            this.close();
        } else {
    ...
    public void func_73869_a(char par1, int par2) {
        if (!GuiNpcTextField.isFieldActive() && this.canEdit) {
    ...
    public void setError(int i, NBTTagCompound data) {
        if (i == 0) {
            this.error.label = StatCollector.func_74838_a((String)"mailbox.errorUsername");
        }
        if (i == 1) {
            this.error.label = StatCollector.func_74838_a((String)"mailbox.errorSubject");
        }
    }

    @Override
    public void setClose(int i, NBTTagCompound data) {
        this.player.func_145747_a((IChatComponent)new ChatComponentTranslation("mailbox.succes", new Object[]{data.func_74779_i("username")}));
    }
