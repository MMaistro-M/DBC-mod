...
public class MemberKindWeigher
extends CompletionWeigher {
    ...
    public Comparable<?> weigh(AutocompleteItem item, ScoringContext context) {
        switch (item.getKind()) {
            ...
            case PARAMETER: {
                return MemberKind.LOCAL_VARIABLE;
            }
            case VARIABLE: {
                return MemberKind.LOCAL_VARIABLE;
            }
            ...
            case CLASS: {
                return this.resolveTypeTier(item);
            }
            case ENUM: {
                return MemberKind.TYPE_ENUM;
            }
            case KEYWORD: {
                return MemberKind.KEYWORD;
            }
            case SNIPPET: {
                return MemberKind.SNIPPET;
            }
        }
        return MemberKind.INSTANCE_FIELD;
    }
