...
public enum OperatorType {
    ...
    private OperatorType(String symbol, int precedence, Associativity associativity, Category category) {
        this.symbol = symbol;
    ...
    public boolean isBinary() {
        return this.category == Category.ARITHMETIC || this.category == Category.RELATIONAL || this.category == Category.LOGICAL || this.category == Category.BITWISE;
    }

    public boolean isUnary() {
        return this.category == Category.UNARY || this.category == Category.UNARY_POSTFIX;
    }

    public boolean isAssignment() {
        return this.category == Category.ASSIGNMENT;
    }

    public boolean isComparison() {
        return this.category == Category.RELATIONAL;
    }
