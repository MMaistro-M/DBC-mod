...
extends GuiMenuTopButton {
    ...
    public void func_146112_a(Minecraft minecraft, int i, int j) {
        ...
        if (this.hover && !this.active) {
            ...
            GL11.glTranslatef((float)x, (float)(this.field_146129_i + 2), (float)0.0f);
        ...
        itemRender.func_82406_b(mc.field_71466_p, mc.func_110434_K(), this.item, this.field_146128_h + 6, this.field_146129_i + 10);
        itemRender.func_77021_b(mc.field_71466_p, mc.func_110434_K(), this.item, this.field_146128_h + 6, this.field_146129_i + 10);
