...
public class SubGuiTrapPresetSelector
extends SubGuiInterface {
    public String selectedPreset = null;
    private static final String[] PRESET_NAMES = new String[]{"HIDDEN", "VENOM", "EXPLOSIVE", "CURSED", "SHOCK", "SNARE"};
    private static final String[] PRESET_LABELS = new String[]{"ability.preset.hidden", "ability.preset.venom", "ability.preset.explosive", "ability.preset.cursed", "ability.preset.shock", "ability.preset.snare"};
    private static final int[] PRESET_COLORS = new int[]{0x888888, 0x44DD44, 0xFF6611, 0xAA44FF, 0x4488FF, 0x88CCFF};
    ...
    public void func_73863_a(int mouseX, int mouseY, float f) {
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            SubGuiTrapPresetSelector.func_73734_a((int)x, (int)y, (int)(x + 10), (int)(y + 10), (int)(0xFF000000 | PRESET_COLORS[i]));
        }
    }
}
