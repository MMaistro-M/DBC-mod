...
IGuiData {
    ...
    private void updateGuiButtons() {
        ...
        if (this.availabitily.dialogId >= 0) {
            DialogGetPacket.getDialog(this.availabitily.dialogId);
        }
        if (this.availabitily.dialog2Id >= 0) {
            DialogGetPacket.getDialog(this.availabitily.dialog2Id);
        }
        if (this.availabitily.dialog3Id >= 0) {
            DialogGetPacket.getDialog(this.availabitily.dialog3Id);
        }
        if (this.availabitily.dialog4Id >= 0) {
            DialogGetPacket.getDialog(this.availabitily.dialog4Id);
        }
    }
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (button.field_146127_k == 10) {
            this.slot = 1;
            this.setSubGui(new GuiDialogSelection(this.availabitily.questId));
        }
        if (button.field_146127_k == 11) {
            this.slot = 2;
            this.setSubGui(new GuiDialogSelection(this.availabitily.quest2Id));
        }
        if (button.field_146127_k == 12) {
            this.slot = 3;
            this.setSubGui(new GuiDialogSelection(this.availabitily.quest3Id));
        }
        if (button.field_146127_k == 13) {
            this.slot = 4;
            this.setSubGui(new GuiDialogSelection(this.availabitily.quest4Id));
        }
