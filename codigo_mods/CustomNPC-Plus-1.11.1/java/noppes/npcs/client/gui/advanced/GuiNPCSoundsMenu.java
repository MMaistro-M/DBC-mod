...
ISubGuiListener {
    ...
    public void func_73866_w_() {
        ...
        this.addTextField(new GuiNpcTextField(0, this, this.field_146289_q, this.guiLeft + 80, this.guiTop + 15, 200, 20, this.npc.advanced.idleSound));
        ...
        this.addTextField(new GuiNpcTextField(2, this, this.field_146289_q, this.guiLeft + 80, this.guiTop + 40, 200, 20, this.npc.advanced.angrySound));
        ...
        this.addTextField(new GuiNpcTextField(3, this, this.field_146289_q, this.guiLeft + 80, this.guiTop + 65, 200, 20, this.npc.advanced.hurtSound));
        ...
        this.addTextField(new GuiNpcTextField(4, this, this.field_146289_q, this.guiLeft + 80, this.guiTop + 90, 200, 20, this.npc.advanced.deathSound));
        ...
        this.addTextField(new GuiNpcTextField(5, this, this.field_146289_q, this.guiLeft + 80, this.guiTop + 115, 200, 20, this.npc.advanced.stepSound));
    ...
    public void unFocused(GuiNpcTextField textfield) {
        if (textfield.id == 0) {
            this.npc.advanced.idleSound = textfield.func_146179_b();
        }
        if (textfield.id == 2) {
            this.npc.advanced.angrySound = textfield.func_146179_b();
        }
        if (textfield.id == 3) {
            this.npc.advanced.hurtSound = textfield.func_146179_b();
        }
        if (textfield.id == 4) {
            this.npc.advanced.deathSound = textfield.func_146179_b();
        }
        if (textfield.id == 5) {
            this.npc.advanced.stepSound = textfield.func_146179_b();
        }
    }
