...
implements ITextfieldListener {
    ...
    public void func_73866_w_() {
        ...
        this.addButton(new GuiNpcButton(1, this.guiLeft + 122, this.guiTop + 96, 51, 20, new String[]{"gui.no", "gui.yes"}, this.stats.canDespawn ? 1 : 0));
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (button.field_146127_k == 0) {
            ...
            this.stats.respawnTime = this.stats.spawnCycle == 3 ? 0 : 20;
            this.func_73866_w_();
        } else if (button.field_146127_k == 1) {
            this.stats.playerSetCanDespawn = this.stats.canDespawn = button.getValue() == 1;
