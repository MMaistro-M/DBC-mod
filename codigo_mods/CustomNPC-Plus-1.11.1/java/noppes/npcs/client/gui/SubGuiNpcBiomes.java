...
extends SubGuiInterface {
    ...
    public void func_73866_w_() {
        ...
        for (BiomeGenBase biomeGenBase : allBiomes) {
            if (biomeGenBase == null || biomeGenBase.field_76791_y == null || this.data.biomes.contains(biomeGenBase.field_76791_y)) continue;
    ...
    protected void func_146284_a(GuiButton guibutton) {
        ...
        if (button.field_146127_k == 3) {
            ...
            for (BiomeGenBase biomeGenBase : allBiomes) {
                ...
                this.data.biomes.add(biomeGenBase.field_76791_y);
            }
            this.scroll1.selected = -1;
            this.scroll2.selected = -1;
            this.func_73866_w_();
