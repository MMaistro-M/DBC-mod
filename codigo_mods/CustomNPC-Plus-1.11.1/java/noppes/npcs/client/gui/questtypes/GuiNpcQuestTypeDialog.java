...
IGuiData {
    ...
    public GuiNpcQuestTypeDialog(EntityNPCInterface npc, Quest q, GuiScreen parent) {
        ...
        PacketClient.sendClient(new QuestDialogGetTitlePacket(this.quest.dialogs.getOrDefault(0, -1), this.quest.dialogs.getOrDefault(1, -1), this.quest.dialogs.getOrDefault(2, -1)));
    }
    ...
    public void func_73866_w_() {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            this.addButton(new GuiNpcButton(i + 9, this.guiLeft + 10, this.guiTop + 55 + i * 22, 20, 20, "X"));
            this.addButton(new GuiNpcButton(i + 3, this.guiLeft + 34, this.guiTop + 55 + i * 22, 210, 20, title));
        }
