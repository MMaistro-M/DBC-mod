...
GuiSelectionListener {
    ...
    public void func_73866_w_() {
        ...
        for (int i = 0; i < 14; ++i) {
            ...
            this.getTextField((int)(i + 14)).integersOnly = true;
        ...
        this.getTextField((int)50).integersOnly = true;
        this.getTextField(50).setMinMaxDefault(10, Integer.MAX_VALUE, 12000);
        ...
        this.getTextField((int)54).integersOnly = true;
        this.getTextField(54).setMinMaxDefault(4, Integer.MAX_VALUE, 20);
