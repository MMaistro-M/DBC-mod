...
public class CustomOverlayLabel
extends Gui
implements IOverlayComponent {
    ...
    public void drawLabel() {
        ...
        GL11.glTranslatef((float)this.x, (float)this.y, (float)this.id);
        GL11.glRotated((double)this.rotation, (double)0.0, (double)0.0, (double)1.0);
        GL11.glScalef((float)this.scale, (float)this.scale, (float)this.scale);
        this.drawString(this.fullLabel, 0, 0, this.color, this.labelShadowEnabled);
        GL11.glPopMatrix();
    }
    ...
    private ResourceLocation getUnicodePageLocation(int p_111271_1_) {
        if (unicodePageLocations[p_111271_1_] == null) {
            CustomOverlayLabel.unicodePageLocations[p_111271_1_] = new ResourceLocation(String.format("textures/font/unicode_page_%02x.png", p_111271_1_));
        }
