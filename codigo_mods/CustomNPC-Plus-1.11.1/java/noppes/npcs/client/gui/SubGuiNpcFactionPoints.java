...
implements ITextfieldListener {
    ...
    public void func_73866_w_() {
        ...
        String title = StatCollector.func_74838_a((String)"faction.unfriendly") + "<->" + StatCollector.func_74838_a((String)"faction.neutral");
        ...
        title = StatCollector.func_74838_a((String)"faction.neutral") + "<->" + StatCollector.func_74838_a((String)"faction.friendly");
