...
extends ModelNPCMale {
    ...
    public void init(float f, float f1) {
        ...
        this.field_78114_d = new ModelRenderer((ModelBase)this).func_78787_b(short1, short2);
        this.field_78114_d.func_78793_a(0.0f, f2, -2.0f);
        this.field_78114_d.func_78784_a(0, 85).func_78790_a(-4.0f, -12.0f, -5.5f, 8, 10, 8, f + 0.5f);
        ...
        this.field_78112_f = new ModelRenderer((ModelBase)this).func_78787_b(short1, short2);
        this.field_78112_f.func_78793_a(0.0f, f2, 0.0f);
        this.field_78112_f.func_78784_a(60, 21).func_78790_a(-13.0f, -2.5f, -3.0f, 4, 30, 6, f + 0.2f);
        this.field_78112_f.func_78784_a(80, 21).func_78790_a(-13.0f, -2.5f, -3.0f, 4, 20, 6, f);
        this.field_78112_f.func_78784_a(100, 21).func_78790_a(-13.0f, -2.5f, -3.0f, 4, 20, 6, f + 1.0f);
        this.field_78113_g = new ModelRenderer((ModelBase)this).func_78787_b(short1, short2);
        this.field_78113_g.func_78793_a(0.0f, f2, 0.0f);
        this.field_78113_g.func_78784_a(60, 58).func_78790_a(9.0f, -2.5f, -3.0f, 4, 30, 6, f + 0.2f);
        this.field_78113_g.func_78784_a(80, 58).func_78790_a(9.0f, -2.5f, -3.0f, 4, 20, 6, f);
        this.field_78113_g.func_78784_a(100, 58).func_78790_a(9.0f, -2.5f, -3.0f, 4, 20, 6, f + 1.0f);
        this.field_78124_i = new ModelRenderer((ModelBase)this, 0, 22).func_78787_b(short1, short2);
        this.field_78124_i.func_78793_a(-4.0f, 18.0f + f2, 0.0f);
        this.field_78124_i.func_78784_a(37, 0).func_78790_a(-3.5f, -3.0f, -3.0f, 6, 16, 5, f);
        this.field_78123_h = new ModelRenderer((ModelBase)this, 0, 22).func_78787_b(short1, short2);
        this.field_78123_h.field_78809_i = true;
        this.field_78123_h.func_78784_a(60, 0).func_78793_a(5.0f, 18.0f + f2, 0.0f);
        this.field_78123_h.func_78790_a(-3.5f, -3.0f, -3.0f, 6, 16, 5, f);
    }
    ...
    public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
        ...
        this.field_78124_i.field_78795_f = -1.5f * this.func_78172_a(par1, 13.0f) * par2;
        this.field_78123_h.field_78795_f = 1.5f * this.func_78172_a(par1, 13.0f) * par2;
        ...
        if ((double)this.field_78095_p > 0.0) {
            ...
            this.field_78113_g.field_78795_f = (-0.2f - 1.5f * this.func_78172_a(par1, 13.0f)) * par2;
            ...
            this.field_78113_g.field_78796_g = 0.1f - f1 * 0.6f + this.field_78116_c.field_78796_g;
        } else {
            this.field_78112_f.field_78795_f = (-0.2f + 1.5f * this.func_78172_a(par1, 13.0f)) * par2;
            this.field_78113_g.field_78795_f = (-0.2f - 1.5f * this.func_78172_a(par1, 13.0f)) * par2;
