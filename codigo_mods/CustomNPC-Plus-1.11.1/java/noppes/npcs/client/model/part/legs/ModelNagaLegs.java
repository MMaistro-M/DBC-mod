...
extends ModelRenderer {
    ...
    public void func_78785_a(float par7) {
        ...
        GL11.glPushMatrix();
        GL11.glScalef((float)0.74f, (float)0.7f, (float)0.85f);
        GL11.glTranslatef((float)this.nagaPart3.field_78796_g, (float)0.66f, (float)0.06f);
        this.nagaPart4.func_78785_a(par7);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        GL11.glTranslatef((float)(this.nagaPart3.field_78796_g + this.nagaPart4.field_78796_g), (float)0.0f, (float)0.0f);
