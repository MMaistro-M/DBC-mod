...
extends ModelRenderer {
    ...
    public ModelDigitigradeLegs(ModelMPM base, boolean mirror, int textWidth, int textHeight) {
        ...
        this.rightleg.func_78787_b(textWidth, textHeight);
        ...
        this.rightleg2.func_78787_b(textWidth, textHeight);
        ...
        this.rightleglow.func_78787_b(textWidth, textHeight);
        ...
        this.rightfoot.func_78787_b(textWidth, textHeight);
        ...
        this.leftleg.func_78787_b(textWidth, textHeight);
        ...
        this.leftleg2.func_78787_b(textWidth, textHeight);
        ...
        this.leftleglow.func_78787_b(textWidth, textHeight);
        ...
        this.leftfoot.func_78787_b(textWidth, textHeight);
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity) {
        this.rightleg.field_78795_f = this.base.field_78123_h.field_78795_f - 0.3f;
        this.leftleg.field_78795_f = this.base.field_78124_i.field_78795_f - 0.3f;
        this.rightleg.field_78797_d = this.base.field_78123_h.field_78797_d;
        this.leftleg.field_78797_d = this.base.field_78124_i.field_78797_d;
        this.rightleg.field_78798_e = this.base.field_78123_h.field_78798_e;
        this.leftleg.field_78798_e = this.base.field_78124_i.field_78798_e;
