...
public class ModelLegacyCouchMiddle
extends ModelBase {
    ...
    public ModelLegacyCouchMiddle() {
        ...
        this.Leg2.func_78793_a(7.0f, 23.0f, -6.0f);
        this.Leg3 = new ModelRenderer((ModelBase)this, 0, 0);
        this.Leg3.func_78789_a(0.0f, 0.0f, 0.0f, 1, 1, 2);
        ...
        this.Bottom = new ModelRenderer((ModelBase)this, 2, 0);
        this.Bottom.func_78789_a(0.0f, 0.0f, 0.0f, 16, 2, 14);
        this.Bottom.func_78793_a(-8.0f, 21.0f, -6.0f);
        this.Back = new ModelRenderer((ModelBase)this, 14, 15);
        this.Back.func_78789_a(0.0f, 0.0f, 0.0f, 16, 15, 1);
