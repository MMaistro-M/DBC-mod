...
public final class BarrierClientSyncPacket
extends AbstractPacket {
    ...
    public static void sendToTracking(EntityEnergyBarrier barrier, NBTTagCompound syncData) {
        if (barrier == null || syncData == null) {
            return;
        }
        PacketHandler.Instance.sendTracking(new BarrierClientSyncPacket(barrier.func_145782_y(), syncData), barrier);
    }
}
