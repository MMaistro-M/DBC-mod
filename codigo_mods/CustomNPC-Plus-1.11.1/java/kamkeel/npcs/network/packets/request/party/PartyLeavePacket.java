...
public final class PartyLeavePacket
extends AbstractPacket {
    ...
    public void receiveData(ByteBuf in, EntityPlayer player) throws IOException {
        ...
        if (!leavingPlayer.func_110124_au().equals(player.func_110124_au()) && !NoppesUtilServer.isOp(player)) {
            return;
        }
        ...
        if (successful) {
            ...
            PartyInvitePacket.sendInviteData((EntityPlayerMP)leavingPlayer);
