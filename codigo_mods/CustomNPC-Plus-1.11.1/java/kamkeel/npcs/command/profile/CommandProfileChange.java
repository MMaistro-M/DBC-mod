...
public class CommandProfileChange
extends CommandProfileBase {
    ...
    public void func_71515_b(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (result.getResult() == EnumProfileOperation.SUCCESS) {
            ColorUtil.sendResult(sender, "Successfully changed profile slot to %d.", slotId);
            ...
            ColorUtil.sendError(sender, "Error changing your profile slot: %s", result.getMessage());
        } else {
