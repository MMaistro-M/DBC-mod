...
extends ModelBiped {
    ...
    public void func_78087_a(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        int pwr = 0;
        if (JRMCoreH.plyrs != null && JRMCoreH.plyrs.length > 0 && !p.func_82150_aj() && JRMCoreH.dnn(1)) {
        ...
        if ((this.KiAttack == 1 || this.KiAttack == 6 || this.KiAttack == 7 || this.KiAttack == 8) && this.field_78120_m == 0) {
            f6 = 0.0f;
            f7 = 0.0f;
            this.rightarmshoulder.field_78808_h = this.RA.field_78808_h;
            this.leftarmshoulder.field_78808_h = this.LA.field_78808_h;
        ...
        if ((this.KiAttack == 2 || this.KiAttack == 4 || this.KiAttack == 3) && this.field_78120_m == 0) {
            f6 = 0.0f;
            f7 = 0.0f;
            this.rightarmshoulder.field_78808_h = this.RA.field_78808_h;
            this.RA.field_78808_h = 0.0f;
        ...
        if ((this.KiAttack == 3 || this.KiAttack == 3) && this.field_78120_m == 0) {
            f6 = 0.0f;
            f7 = 0.0f;
            this.rightarmshoulder.field_78808_h = this.RA.field_78808_h;
