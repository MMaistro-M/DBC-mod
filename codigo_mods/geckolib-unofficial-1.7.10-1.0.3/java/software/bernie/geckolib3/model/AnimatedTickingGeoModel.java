...
extends AnimatedGeoModel<T> {
    ...
    public void setLivingAnimations(T entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
        ...
        if (manager.startTick == null) {
            manager.startTick = (float)((IAnimationTickable)entity).tickTimer() + Minecraft.func_71410_x().field_71428_T.field_74281_c;
        }
        if (!Minecraft.func_71410_x().func_147113_T() || manager.shouldPlayWhilePaused) {
            double gameTick = manager.tick = (double)((float)((IAnimationTickable)entity).tickTimer() + Minecraft.func_71410_x().field_71428_T.field_74281_c);
        ...
        if (!this.getAnimationProcessor().getModelRendererList().isEmpty()) {
            this.getAnimationProcessor().tickAnimation((IAnimatable)entity, uniqueID, this.seekTime, predicate, MolangRegistrar.getParser(), this.shouldCrashOnMissing);
        }
        if (!Minecraft.func_71410_x().func_147113_T() || manager.shouldPlayWhilePaused) {
