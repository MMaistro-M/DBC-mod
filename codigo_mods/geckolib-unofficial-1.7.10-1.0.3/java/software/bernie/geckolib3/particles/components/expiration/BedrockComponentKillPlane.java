...
implements IComponentParticleUpdate {
    ...
    public JsonElement toJson() {
        ...
        array.add((JsonElement)new JsonPrimitive((Number)Float.valueOf(this.a)));
        array.add((JsonElement)new JsonPrimitive((Number)Float.valueOf(this.b)));
        array.add((JsonElement)new JsonPrimitive((Number)Float.valueOf(this.c)));
        array.add((JsonElement)new JsonPrimitive((Number)Float.valueOf(this.d)));
        return array;
    }
