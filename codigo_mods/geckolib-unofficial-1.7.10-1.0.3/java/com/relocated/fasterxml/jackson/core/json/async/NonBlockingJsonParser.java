 ...
 */
package com.relocated.fasterxml.jackson.core.json.async;

import com.relocated.fasterxml.jackson.core.JsonParser;
import com.relocated.fasterxml.jackson.core.JsonToken;
import com.relocated.fasterxml.jackson.core.async.ByteArrayFeeder;
import com.relocated.fasterxml.jackson.core.io.CharTypes;
import com.relocated.fasterxml.jackson.core.io.IOContext;
import com.relocated.fasterxml.jackson.core.json.async.NonBlockingJsonParserBase;
...
implements ByteArrayFeeder {
    ...
    private final JsonToken _startFieldNameAfterComma(int ch) throws IOException {
        ...
        this._updateTokenLocation();
        if (ch != 34) {
            if (ch == 125 && JsonParser.Feature.ALLOW_TRAILING_COMMA.enabledIn(this._features)) {
                return this._closeObjectScope();
            }
            return this._handleOddName(ch);
        }
