...
import com.relocated.fasterxml.jackson.databind.deser.BasicDeserializerFactory;
import com.relocated.fasterxml.jackson.databind.deser.BeanDeserializer;
...
import com.relocated.fasterxml.jackson.databind.deser.impl.ErrorThrowingDeserializer;
import com.relocated.fasterxml.jackson.databind.deser.impl.FieldProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.MethodProperty;
...
import com.relocated.fasterxml.jackson.databind.deser.std.ThrowableDeserializer;
...
implements Serializable {
    ...
    public JsonDeserializer<Object> buildThrowableDeserializer(DeserializationContext ctxt, JavaType type, BeanDescription beanDesc) throws JsonMappingException {
        ...
        if (am != null && (prop = this.constructSettableProperty(ctxt, beanDesc, propDef = SimpleBeanPropertyDefinition.construct(ctxt.getConfig(), am, new PropertyName("cause")), am.getParameterType(0))) != null) {
