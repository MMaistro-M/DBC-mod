...
import com.relocated.fasterxml.jackson.databind.ser.std.StdKeySerializer;
...
import com.relocated.fasterxml.jackson.databind.util.EnumValues;
            ...
            switch (this._typeId) {
                ...
                case 4: {
                    ...
                    if (provider.isEnabled(SerializationFeature.WRITE_ENUMS_USING_TO_STRING)) {
                        ...
                        Enum e = (Enum)value;
                        key = provider.isEnabled(SerializationFeature.WRITE_ENUMS_USING_INDEX) ? String.valueOf(e.ordinal()) : e.name();
                    }
