...
import com.relocated.fasterxml.jackson.databind.deser.ContextualKeyDeserializer;
import com.relocated.fasterxml.jackson.databind.deser.DeserializationProblemHandler;
import com.relocated.fasterxml.jackson.databind.deser.DeserializerCache;
...
import com.relocated.fasterxml.jackson.databind.exc.InvalidFormatException;
import com.relocated.fasterxml.jackson.databind.exc.InvalidTypeIdException;
import com.relocated.fasterxml.jackson.databind.exc.MismatchedInputException;
import com.relocated.fasterxml.jackson.databind.exc.UnrecognizedPropertyException;
...
import com.relocated.fasterxml.jackson.databind.util.LinkedNode;
import com.relocated.fasterxml.jackson.databind.util.ObjectBuffer;
...
implements Serializable {
    ...
    public Object handleUnexpectedToken(Class<?> instClass, JsonToken t, JsonParser p, String msg, Object ... msgArgs) throws IOException {
        ...
        if (msg == null) {
            msg = t == null ? String.format("Unexpected end-of-input when binding data into %s", this._calcName(instClass)) : String.format("Cannot deserialize instance of %s out of %s token", new Object[]{this._calcName(instClass), t});
        }
