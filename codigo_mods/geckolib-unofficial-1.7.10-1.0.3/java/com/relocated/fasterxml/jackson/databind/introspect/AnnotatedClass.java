...
import com.relocated.fasterxml.jackson.databind.introspect.AnnotatedCreatorCollector;
import com.relocated.fasterxml.jackson.databind.introspect.AnnotatedField;
import com.relocated.fasterxml.jackson.databind.introspect.AnnotatedFieldCollector;
import com.relocated.fasterxml.jackson.databind.introspect.AnnotatedMethod;
import com.relocated.fasterxml.jackson.databind.introspect.AnnotatedMethodCollector;
...
implements TypeResolutionContext {
    ...
    private final List<AnnotatedField> _fields() {
        ...
        if (f == null) {
            f = this._type == null ? Collections.emptyList() : AnnotatedFieldCollector.collectFields(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type);
            this._fields = f;
        }
        return f;
    }
    ...
    private final AnnotatedMethodMap _methods() {
        ...
        if (m == null) {
            m = this._type == null ? new AnnotatedMethodMap() : AnnotatedMethodCollector.collectMethods(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type, this._superTypes, this._primaryMixIn);
    ...
    private final Creators _creators() {
        ...
        if (c == null) {
            c = this._type == null ? NO_CREATORS : AnnotatedCreatorCollector.collectCreators(this._annotationIntrospector, this, this._type, this._primaryMixIn);
            this._creators = c;
        }
        return c;
    }
