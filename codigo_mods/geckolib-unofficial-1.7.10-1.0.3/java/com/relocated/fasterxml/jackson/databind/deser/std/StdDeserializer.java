...
import com.relocated.fasterxml.jackson.annotation.Nulls;
...
import com.relocated.fasterxml.jackson.core.io.NumberInput;
...
import com.relocated.fasterxml.jackson.databind.deser.BeanDeserializerBase;
...
import com.relocated.fasterxml.jackson.databind.deser.impl.NullsAsEmptyProvider;
import com.relocated.fasterxml.jackson.databind.deser.impl.NullsConstantProvider;
import com.relocated.fasterxml.jackson.databind.deser.impl.NullsFailProvider;
...
implements Serializable {
    ...
    protected T _deserializeFromArray(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        Object result = ctxt.handleUnexpectedToken(this._valueClass, t, p, null, new Object[0]);
        return (T)result;
    }
    ...
    protected T _deserializeWrappedValue(JsonParser p, DeserializationContext ctxt) throws IOException {
        if (p.hasToken(JsonToken.START_ARRAY)) {
            ...
            Object result = ctxt.handleUnexpectedToken(this._valueClass, p.getCurrentToken(), p, msg, new Object[0]);
            return (T)result;
        }
