...
implements Serializable {
    ...
    extends StdKeyDeserializer {
        ...
        public Object _parse(String key, DeserializationContext ctxt) throws IOException {
            ...
            if ((e = (res = ctxt.isEnabled(DeserializationFeature.READ_ENUMS_USING_TO_STRING) ? this._getToStringResolver(ctxt) : this._byNameResolver).findEnum(key)) == null && !ctxt.getConfig().isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
