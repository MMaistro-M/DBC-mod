...
import com.relocated.fasterxml.jackson.databind.jsonschema.JsonSerializableSchema;
import com.relocated.fasterxml.jackson.databind.jsonschema.SchemaAware;
...
import com.relocated.fasterxml.jackson.databind.ser.AnyGetterWriter;
import com.relocated.fasterxml.jackson.databind.ser.BeanPropertyWriter;
import com.relocated.fasterxml.jackson.databind.ser.BeanSerializerBuilder;
import com.relocated.fasterxml.jackson.databind.ser.ContainerSerializer;
import com.relocated.fasterxml.jackson.databind.ser.ContextualSerializer;
import com.relocated.fasterxml.jackson.databind.ser.PropertyFilter;
import com.relocated.fasterxml.jackson.databind.ser.PropertyWriter;
import com.relocated.fasterxml.jackson.databind.ser.ResolvableSerializer;
...
import com.relocated.fasterxml.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator;
import com.relocated.fasterxml.jackson.databind.ser.impl.WritableObjectId;
            ...
            if ((objectIdInfo = intr.findObjectIdInfo(accessor)) == null) {
                ...
                if (implClass == ObjectIdGenerators.PropertyGenerator.class) {
                    ...
                    while (true) {
                        ...
                        if (propName.equals((prop = this._props[i]).getName())) {
                            idProp = prop;
                            if (i <= 0) break;
