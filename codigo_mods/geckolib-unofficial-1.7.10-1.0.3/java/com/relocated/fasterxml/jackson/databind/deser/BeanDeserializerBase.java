...
import com.relocated.fasterxml.jackson.databind.deser.BeanDeserializerBuilder;
...
import com.relocated.fasterxml.jackson.databind.deser.ResolvableDeserializer;
import com.relocated.fasterxml.jackson.databind.deser.SettableAnyProperty;
import com.relocated.fasterxml.jackson.databind.deser.SettableBeanProperty;
import com.relocated.fasterxml.jackson.databind.deser.UnresolvedForwardReference;
...
import com.relocated.fasterxml.jackson.databind.deser.impl.ExternalTypeHandler;
import com.relocated.fasterxml.jackson.databind.deser.impl.InnerClassProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.ManagedReferenceProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.MergingSettableBeanProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.ObjectIdReader;
import com.relocated.fasterxml.jackson.databind.deser.impl.ObjectIdReferenceProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.ObjectIdValueProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.PropertyBasedCreator;
import com.relocated.fasterxml.jackson.databind.deser.impl.PropertyBasedObjectIdGenerator;
import com.relocated.fasterxml.jackson.databind.deser.impl.ReadableObjectId;
import com.relocated.fasterxml.jackson.databind.deser.impl.SetterlessProperty;
import com.relocated.fasterxml.jackson.databind.deser.impl.TypeWrappedDeserializer;
import com.relocated.fasterxml.jackson.databind.deser.impl.UnwrappedPropertyHandler;
import com.relocated.fasterxml.jackson.databind.deser.impl.ValueInjector;
import com.relocated.fasterxml.jackson.databind.deser.std.StdDelegatingDeserializer;
import com.relocated.fasterxml.jackson.databind.deser.std.StdDeserializer;
import com.relocated.fasterxml.jackson.databind.exc.IgnoredPropertyException;
