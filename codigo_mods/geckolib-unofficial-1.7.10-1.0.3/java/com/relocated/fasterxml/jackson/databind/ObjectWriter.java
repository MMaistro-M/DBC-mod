...
import com.relocated.fasterxml.jackson.core.util.Instantiatable;
import com.relocated.fasterxml.jackson.core.util.MinimalPrettyPrinter;
...
import com.relocated.fasterxml.jackson.databind.ObjectMapper;
import com.relocated.fasterxml.jackson.databind.PropertyName;
import com.relocated.fasterxml.jackson.databind.SequenceWriter;
...
import com.relocated.fasterxml.jackson.databind.ser.impl.TypeWrappedSerializer;
...
Serializable {
    ...
    implements Serializable {
        ...
        public Prefetch forRootType(ObjectWriter parent, JavaType newType) {
            boolean noType;
            boolean bl = noType = newType == null || newType.isJavaLangObject();
            if (noType) {
