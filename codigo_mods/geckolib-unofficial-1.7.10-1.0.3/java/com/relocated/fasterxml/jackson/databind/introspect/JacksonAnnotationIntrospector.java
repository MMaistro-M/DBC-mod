...
import com.relocated.fasterxml.jackson.annotation.JacksonAnnotationsInside;
import com.relocated.fasterxml.jackson.annotation.JacksonInject;
import com.relocated.fasterxml.jackson.annotation.JsonAlias;
import com.relocated.fasterxml.jackson.annotation.JsonAnyGetter;
import com.relocated.fasterxml.jackson.annotation.JsonAnySetter;
import com.relocated.fasterxml.jackson.annotation.JsonAutoDetect;
import com.relocated.fasterxml.jackson.annotation.JsonBackReference;
import com.relocated.fasterxml.jackson.annotation.JsonClassDescription;
import com.relocated.fasterxml.jackson.annotation.JsonCreator;
import com.relocated.fasterxml.jackson.annotation.JsonEnumDefaultValue;
import com.relocated.fasterxml.jackson.annotation.JsonFilter;
import com.relocated.fasterxml.jackson.annotation.JsonFormat;
import com.relocated.fasterxml.jackson.annotation.JsonGetter;
import com.relocated.fasterxml.jackson.annotation.JsonIdentityInfo;
import com.relocated.fasterxml.jackson.annotation.JsonIdentityReference;
import com.relocated.fasterxml.jackson.annotation.JsonIgnore;
import com.relocated.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.relocated.fasterxml.jackson.annotation.JsonIgnoreType;
import com.relocated.fasterxml.jackson.annotation.JsonInclude;
import com.relocated.fasterxml.jackson.annotation.JsonManagedReference;
import com.relocated.fasterxml.jackson.annotation.JsonMerge;
import com.relocated.fasterxml.jackson.annotation.JsonProperty;
import com.relocated.fasterxml.jackson.annotation.JsonPropertyDescription;
import com.relocated.fasterxml.jackson.annotation.JsonPropertyOrder;
import com.relocated.fasterxml.jackson.annotation.JsonRawValue;
import com.relocated.fasterxml.jackson.annotation.JsonRootName;
import com.relocated.fasterxml.jackson.annotation.JsonSetter;
import com.relocated.fasterxml.jackson.annotation.JsonSubTypes;
import com.relocated.fasterxml.jackson.annotation.JsonTypeId;
import com.relocated.fasterxml.jackson.annotation.JsonTypeInfo;
import com.relocated.fasterxml.jackson.annotation.JsonTypeName;
import com.relocated.fasterxml.jackson.annotation.JsonUnwrapped;
import com.relocated.fasterxml.jackson.annotation.JsonValue;
import com.relocated.fasterxml.jackson.annotation.JsonView;
import com.relocated.fasterxml.jackson.annotation.ObjectIdGenerators;
...
import com.relocated.fasterxml.jackson.databind.annotation.JsonAppend;
import com.relocated.fasterxml.jackson.databind.annotation.JsonDeserialize;
import com.relocated.fasterxml.jackson.databind.annotation.JsonNaming;
...
import com.relocated.fasterxml.jackson.databind.annotation.JsonTypeIdResolver;
import com.relocated.fasterxml.jackson.databind.annotation.JsonTypeResolver;
import com.relocated.fasterxml.jackson.databind.annotation.JsonValueInstantiator;
...
import com.relocated.fasterxml.jackson.databind.ext.Java7Support;
...
import com.relocated.fasterxml.jackson.databind.introspect.ObjectIdInfo;
import com.relocated.fasterxml.jackson.databind.introspect.VirtualAnnotatedMember;
...
import com.relocated.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import com.relocated.fasterxml.jackson.databind.ser.BeanPropertyWriter;
import com.relocated.fasterxml.jackson.databind.ser.VirtualBeanPropertyWriter;
import com.relocated.fasterxml.jackson.databind.ser.impl.AttributePropertyWriter;
import com.relocated.fasterxml.jackson.databind.ser.std.RawSerializer;
...
implements Serializable {
    ...
    public PropertyName findNameForSerialization(Annotated a) {
        ...
        if (this._hasOneOf(a, ANNOTATIONS_TO_INFER_SER)) {
    ...
    public PropertyName findNameForDeserialization(Annotated a) {
        ...
        if (this._hasOneOf(a, ANNOTATIONS_TO_INFER_DESER)) {
            return PropertyName.USE_DEFAULT;
        }
        return null;
    }
