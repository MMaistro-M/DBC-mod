...
public class GlStateManager {
    ...
    public static void tryBlendFuncSeparate(int srcFactor, int dstFactor, int srcFactorAlpha, int dstFactorAlpha) {
        if (srcFactor != GlStateManager.blendState.srcFactor || dstFactor != GlStateManager.blendState.dstFactor || srcFactorAlpha != GlStateManager.blendState.srcFactorAlpha || dstFactorAlpha != GlStateManager.blendState.dstFactorAlpha) {
            ...
            OpenGlHelper.func_148821_a((int)srcFactor, (int)dstFactor, (int)srcFactorAlpha, (int)dstFactorAlpha);
        }
    }
    ...
    public static enum Profile {
        DEFAULT{
            ...
            public void apply() {
                ...
                GL11.glLightModel((int)2899, (FloatBuffer)RenderHelper.func_74521_a((float)0.2f, (float)0.2f, (float)0.2f, (float)1.0f));
                for (int i = 0; i < 8; ++i) {
                    GlStateManager.disableLight(i);
                    GL11.glLight((int)(16384 + i), (int)4608, (FloatBuffer)RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)1.0f));
                    GL11.glLight((int)(16384 + i), (int)4611, (FloatBuffer)RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)1.0f, (float)0.0f));
                    if (i == 0) {
                        GL11.glLight((int)(16384 + i), (int)4609, (FloatBuffer)RenderHelper.func_74521_a((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f));
                        GL11.glLight((int)(16384 + i), (int)4610, (FloatBuffer)RenderHelper.func_74521_a((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f));
                        continue;
                    }
                    GL11.glLight((int)(16384 + i), (int)4609, (FloatBuffer)RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)1.0f));
                    GL11.glLight((int)(16384 + i), (int)4610, (FloatBuffer)RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)1.0f));
                }
                ...
                GL11.glFog((int)2918, (FloatBuffer)RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                ...
                GlStateManager.texGen(TexGen.S, 9474, RenderHelper.func_74521_a((float)1.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                GlStateManager.texGen(TexGen.S, 9217, RenderHelper.func_74521_a((float)1.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                GlStateManager.disableTexGenCoord(TexGen.T);
                GlStateManager.texGen(TexGen.T, 9216);
                GlStateManager.texGen(TexGen.T, 9474, RenderHelper.func_74521_a((float)0.0f, (float)1.0f, (float)0.0f, (float)0.0f));
                GlStateManager.texGen(TexGen.T, 9217, RenderHelper.func_74521_a((float)0.0f, (float)1.0f, (float)0.0f, (float)0.0f));
                GlStateManager.disableTexGenCoord(TexGen.R);
                GlStateManager.texGen(TexGen.R, 9216);
                GlStateManager.texGen(TexGen.R, 9474, RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                GlStateManager.texGen(TexGen.R, 9217, RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                GlStateManager.disableTexGenCoord(TexGen.Q);
                GlStateManager.texGen(TexGen.Q, 9216);
                GlStateManager.texGen(TexGen.Q, 9474, RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                GlStateManager.texGen(TexGen.Q, 9217, RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)0.0f));
                ...
                GL11.glTexEnv((int)8960, (int)8705, (FloatBuffer)RenderHelper.func_74521_a((float)0.0f, (float)0.0f, (float)0.0f, (float)0.0f));
